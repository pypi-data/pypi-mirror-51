...
Report bugs at https://github.com/tomtom-international/ebr-board/issues.
...
ebr-board could always use more documentation,
whether as part of the official ebr-board docs,
in docstrings, or even on the web in blog posts, articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at
https://github.com/tomtom-international/ebr-board/issues.
...
Ready to contribute? Here's how to set up **ebr-board** for local development.

1. Fork the **ebr-board** repo on Github.

2. Clone your fork locally:

        $ git clone git@github.com:your_name_here/ebr-board.git
...
To run a subset of tests:
    ...
    $ py.test tests/test_ebr_board.py

## Deploying

Deployment can only be done by the project maintainers and is done on-demand via the Azure CI.

Select the [ebr-board build pipeline](https://dev.azure.com/tomtomweb/GitHub-TomTom-International/_build) and click
