...
class AutoRegMetadata(SirenComponent):
    ...
    @property
    def _root(self):
        return self._get_root().auto_reg_metadatas_root()
    ...
    def set_auto_registration_metadata(
        ...
        return siren_to_entity(
            self._root.create_auto_reg_metadata(__json=payload)
        )
    ...
    def _get_auto_reg_metadata(self, **kwargs):
        ...
        auto_reg_metadata = self._root.get_auto_reg_metadata(**kwargs)
