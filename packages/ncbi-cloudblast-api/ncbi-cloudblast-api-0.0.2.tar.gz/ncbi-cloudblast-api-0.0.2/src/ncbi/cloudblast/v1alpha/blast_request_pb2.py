...
_BLASTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fasta', full_name='ncbi.cloudblast.v1alpha.BlastRequest.fasta', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='coords', full_name='ncbi.cloudblast.v1alpha.BlastRequest.coords', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='result_bucket_name', full_name='ncbi.cloudblast.v1alpha.BlastRequest.result_bucket_name', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='program', full_name='ncbi.cloudblast.v1alpha.BlastRequest.program', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='blast_params', full_name='ncbi.cloudblast.v1alpha.BlastRequest.blast_params', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='user_tags', full_name='ncbi.cloudblast.v1alpha.BlastRequest.user_tags', index=8,
...
_BLASTREQUEST.oneofs_by_name['query'].fields.append(
  _BLASTREQUEST.fields_by_name['fasta'])
_BLASTREQUEST.fields_by_name['fasta'].containing_oneof = _BLASTREQUEST.oneofs_by_name['query']
