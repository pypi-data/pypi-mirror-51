...
$(document).ready(function() {
    ...
    /**
     * ------------------------------------------------------------------------
     * Taken from themes/maeguias/js/base.js
     * ------------------------------------------------------------------------
     */
    var search_term = getSearchTerm(),
    $search_modal = $('#maedocs_search_modal'),
    $keyboard_modal = $('#maedocs_keyboard_modal');
    ...
    $search_modal.on('shown.bs.modal', function () {
        $search_modal.find('#maedocs-search-query').focus();
    });

    // Close search modal when result is selected
    // The links get added later so listen to parent
    $('#maedocs-search-results').click(function(e) {
      if ($(e.target).is('a')) {
