...
#
# from adverse_event_app.action_items import AeFollowupAction, AeInitialAction
...
#
#         with mock.patch("adverse_event_app.action_items.get_offschedule_models") as mocked:
