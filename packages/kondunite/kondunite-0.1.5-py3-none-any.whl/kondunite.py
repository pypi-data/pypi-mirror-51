...
if __name__ == '__main__':
    cli('--target repl -i "gcr.io/apiiro/lim/api:$LIM_API_SHA" -i "gcr.io/apiiro/lim/feature-extractor-java:$LIM_FEATURE_EXTRACTOR_JAVA_SHA" -i "gcr.io/apiiro/lim/git-listener:$LIM_GIT_LISTENER_SHA" --repl --repl-registry "gcr.io/apiiro" --repl-base "/Users/liris/apiiro/lim/k8s/replicated_base.yaml" -o replicated.yaml /Users/liris/apiiro/lim/k8s'.replace('"', '').split(" "))
