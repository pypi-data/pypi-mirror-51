...
def main():
    parser = argparse.ArgumentParser(description="Generate machine learning files in either python or jupyter notebook formats")
    parser.add_argument('--info',help='information and additional resources of cli',default = '.')
...
def genfiles(args):
    ...
    """
        ...
        print("Contribute: https://github.com/mlgen")
        print("Learn more about Nebutech: https://nebutech.com\n")
