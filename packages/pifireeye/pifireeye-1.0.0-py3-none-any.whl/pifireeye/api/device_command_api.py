...
from pyfireeye.models import DeviceCommand
...
class DeviceCommandApi(object):
    ...
    def add_device_command(self, command, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.add_device_command_with_http_info(command,
                                                          **kwargs)  # noqa: E501
        else:
            (data) = self.add_device_command_with_http_info(command,
                                                            **kwargs)  # noqa: E501
            return data

    def add_device_command_with_http_info(self, command,
                                          **kwargs):  # noqa: E501
        """添加设备命令  # noqa: E501
        ...
        if ('command' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `command` when calling `add_device_command`")  # noqa: E501
    ...
    def get_device_command(self, **kwargs):  # noqa: E501
        """返回设备命令  # noqa: E501

        返回设备命令  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_device_command(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_device_command_with_http_info(
                **kwargs)  # noqa: E501
        else:
            (data) = self.get_device_command_with_http_info(
                **kwargs)  # noqa: E501
            return data

    def get_device_command_with_http_info(self, **kwargs):  # noqa: E501
        """返回设备命令  # noqa: E501

        返回设备命令  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_device_command_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['start_time', 'end_time', 'status']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'start_time' in params and params[
            ...
            raise ValueError(
                "Invalid value for parameter `start_time` when calling `get_device_command`, must be a value less than or equal to `10000000000`")  # noqa: E501
        if 'start_time' in params and params[
            'start_time'] < 1000000000:  # noqa: E501
            raise ValueError(
                "Invalid value for parameter `start_time` when calling `get_device_command`, must be a value greater than or equal to `1000000000`")  # noqa: E501
        if 'end_time' in params and params[
            'end_time'] > 10000000000:  # noqa: E501
            raise ValueError(
                "Invalid value for parameter `end_time` when calling `get_device_command`, must be a value less than or equal to `10000000000`")  # noqa: E501
        if 'end_time' in params and params[
            'end_time'] < 1000000000:  # noqa: E501
            raise ValueError(
                "Invalid value for parameter `end_time` when calling `get_device_command`, must be a value greater than or equal to `1000000000`")  # noqa: E501
        collection_formats = {}
    ...
    def get_device_command_status(self, command_ids, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_device_command_status_with_http_info(command_ids,
                                                                 **kwargs)  # noqa: E501
        else:
            (data) = self.get_device_command_status_with_http_info(command_ids,
                                                                   **kwargs)  # noqa: E501
            return data

    def get_device_command_status_with_http_info(self, command_ids,
                                                 **kwargs):  # noqa: E501
        """返回指定的设备命令是否被处理  # noqa: E501
        ...
        if ('command_ids' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `command_ids` when calling `get_device_command_status`")  # noqa: E501
        ...
        if 'command_ids' in params:
            query_params.append(
                ('command_ids', params['command_ids']))  # noqa: E501
    ...
    def set_device_command_status(self, id_status_mapping,
                                  **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.set_device_command_status_with_http_info(
                id_status_mapping, **kwargs)  # noqa: E501
        else:
            (data) = self.set_device_command_status_with_http_info(
                id_status_mapping, **kwargs)  # noqa: E501
            return data

    def set_device_command_status_with_http_info(self, id_status_mapping,
                                                 **kwargs):  # noqa: E501
        """设置指定的设备命令的处理状态  # noqa: E501
        ...
        if ('id_status_mapping' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `id_status_mapping` when calling `set_device_command_status`")  # noqa: E501
