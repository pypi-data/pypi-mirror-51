...
class Table():
    ...
    def __QueryAdd(self, columns_inside=False):
        result = ""
    ...
    def QueryAddSeparate(self):
        return self.__QueryAdd(False)

    def QueryAddInside(self):
        return self.__QueryAdd(True)
    ...
    def QueryDDL(self):
        ...
        #for k, tse in sorted(self.Settings):
        #    result += tse.QueryAdd()
        #    result += SEP
        #    result += SEP
