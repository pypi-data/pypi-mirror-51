...
# from swimlane_platform.lib.functions import apply_for_all_dict_values
...
class DockerComposeFileManager:
    ...
    # def replace_in_file(self, old_value, new_value):
    #     # type: (str, str) -> None
    #     """Replaces tags to values
    #     :param old_value: Tag
    #     :param new_value: New value
    #     """
    #     apply_for_all_dict_values(self._dict, lambda o: o is str, lambda o: o.replace(old_value, new_value))
