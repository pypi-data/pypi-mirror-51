...
from symmetry.clusterd.policies.balancing import WeightedRandom
...
class BalancingPoliciesResourceTest(WebAppTestCase):
    def test_policies_balancing_get(self):
        ...
        self.assertIn('WeightedRandom', [item['policy'] for item in items])
    ...
    def test_policies_balancing_get_active(self):
        ...
        item = result.json
        self.assertEqual('WeightedRandom', item['policy'])
