...
def timeoftime(df, drop_original=False, measures=["hour", "dayofweek", "weekofyear", "month"], infer_datetime_format=True, utc=True):
...
def onehot_categories(df, drop_original=False, min_ones=1, max_categories=100):
