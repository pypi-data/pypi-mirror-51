...
if __name__ == "__main__":
    GitLab().get_all_commit_between_push(code_branch='Develop',package_branch='zuche-test',workspace='/Users/v-sunweiwei/Desktop/saic/ios-shell-passenger',mail='yuying@saicmobility.com')
    # test = None
    # print(test == False)
