...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v0.18.6-dev.1566349687+g51930f2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v0.18.6-dev.1566349687+g51930f2`
                """)
            else:
                raise
