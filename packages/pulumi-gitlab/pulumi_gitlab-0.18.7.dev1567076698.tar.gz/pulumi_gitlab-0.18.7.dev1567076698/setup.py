...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v0.18.7-dev.1567076698+g4ccaaa5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v0.18.7-dev.1567076698+g4ccaaa5`
                """)
            else:
                raise
