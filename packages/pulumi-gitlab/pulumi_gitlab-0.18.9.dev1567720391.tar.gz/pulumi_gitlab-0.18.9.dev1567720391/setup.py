...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v0.18.9-dev.1567720391+g9459ee4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v0.18.9-dev.1567720391+g9459ee4`
                """)
            else:
                raise
