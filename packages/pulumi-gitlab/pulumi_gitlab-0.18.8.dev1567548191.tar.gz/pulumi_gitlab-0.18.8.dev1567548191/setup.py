...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v0.18.8-dev.1567548191+gb09eb2b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v0.18.8-dev.1567548191+gb09eb2b`
                """)
            else:
                raise
