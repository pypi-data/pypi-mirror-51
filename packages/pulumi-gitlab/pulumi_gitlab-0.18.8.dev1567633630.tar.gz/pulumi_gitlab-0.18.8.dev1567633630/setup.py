...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v0.18.8-dev.1567633630+gd45efce'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v0.18.8-dev.1567633630+gd45efce`
                """)
            else:
                raise
