...
from .sql_input_tests import test_in_collection, test_input_init, \
test_input_runtest, test_input_ids, test_input_summ, comp_tables_input
...
class SQLTest:
    ...
    def __init__(self, table_names: Sequence[str], table_alias: Sequence[str],
        ...
        test_input_init(comparison_fields=comparison_fields, groupby_fields=groupby_fields,
                        table_names=table_names, table_alias=table_alias,
                        db_server=db_server, test_type=test_type, save_location=save_location)
