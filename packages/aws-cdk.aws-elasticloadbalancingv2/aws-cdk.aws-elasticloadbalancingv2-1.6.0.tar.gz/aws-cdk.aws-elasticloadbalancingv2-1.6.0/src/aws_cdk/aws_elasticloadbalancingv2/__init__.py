...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-elasticloadbalancingv2", "1.6.0", __name__, "aws-elasticloadbalancingv2@1.6.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.ApplicationListenerAttributes", jsii_struct_bases=[], name_mapping={'listener_arn': 'listenerArn', 'security_group_id': 'securityGroupId', 'default_port': 'defaultPort', 'security_group_allows_all_outbound': 'securityGroupAllowsAllOutbound'})
class ApplicationListenerAttributes():
    def __init__(self, *, listener_arn: str, security_group_id: str, default_port: typing.Optional[jsii.Number]=None, security_group_allows_all_outbound: typing.Optional[bool]=None):
...
class ApplicationListener(BaseListener, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancingv2.ApplicationListener"):
    ...
    @classmethod
    def from_application_listener_attributes(cls, scope: aws_cdk.core.Construct, id: str, *, listener_arn: str, security_group_id: str, default_port: typing.Optional[jsii.Number]=None, security_group_allows_all_outbound: typing.Optional[bool]=None) -> "IApplicationListener":
        ...
        :param security_group_allows_all_outbound: Whether the security group allows all outbound traffic or not. Unless set to ``false``, no egress rules will be added to the security group. Default: true
        """
        attrs = ApplicationListenerAttributes(listener_arn=listener_arn, security_group_id=security_group_id, default_port=default_port, security_group_allows_all_outbound=security_group_allows_all_outbound)
