...
class MetadataClientTest(ModuleBase, unittest.TestCase):
    ...
    def test_get_proposal_runs(self):
        ...
        #               'num_files': 0,
        #               'repositories': {
        #                   'XFEL_GPFS_ONLINE_SASE_1': {
        #                       'name": 'XFEL GPFS online for SASE 1',
        #                       'mount_point': '/gpfs/exfel/exp',
        #                       'data_groups': 1
        #                       }
        #                   }
        #               }
        ...
        first_repo = first_run['repositories']['XFEL_GPFS_ONLINE_SASE_1_V2']
        self.assert_eq_val(first_repo['name'],
                           'XFEL GPFS online for SASE 1 (V2)')
        self.assert_eq_val(first_repo['mount_point'], '/gpfs/exfel/exp')
