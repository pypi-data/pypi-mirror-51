...
Indirect method of optimization based on differential geometry.

Controls are handled in one of two ways. ICRM [1]_ or PMP.

Path constraints aren't handled... for now...
