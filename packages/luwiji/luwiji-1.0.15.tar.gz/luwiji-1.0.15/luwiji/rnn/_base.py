...
class BaseIllustrationRNN:
    def __init__(self):
        ...
        self.predict_comparison = Image(f"{here}/assets/predict_comparison.png", width=700)
        self.forecast_comparison = Image(f"{here}/assets/forecast_comparison.png", width=700)
