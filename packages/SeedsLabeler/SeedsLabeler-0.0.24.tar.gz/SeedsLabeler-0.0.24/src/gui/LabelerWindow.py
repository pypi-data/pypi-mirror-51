...
class LabelerWindow(QMainWindow, Ui_MainWindow):
    ...
    def updateSoftware(self):
        ...
        # subprocess.run(["pip3", "install", "--upgrade", "SeedsLabeler"])
        # else:
        CompletedProcess = subprocess.run(["pip3", "install", "--upgrade", "SeedsLabeler"])
        ...
        if NewVersionAvailable:
            ...
            # 'Update Available', 
            # "Do you want to update SeedsLabeler?\n Please make sure you saved your project.", 
            # QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
            # if buttonReply == QMessageBox.Yes:
            #     # print('Yes clicked.')
            #     print("   updating through pip")
            #     res = subprocess.run(["pip", "install", "--upgrade", "SeedsLabeler"])
            #     print(res)
            #     print("   restarting")
            #     import atexit
