...
_LINERANGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='from', full_name='com.cognite.seismic.LineRange.from', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='to', full_name='com.cognite.seismic.LineRange.to', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LINERANGE.fields_by_name['from'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT32VALUE
_LINERANGE.fields_by_name['to'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT32VALUE
