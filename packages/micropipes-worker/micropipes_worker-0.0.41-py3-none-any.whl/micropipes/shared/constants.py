...
MQ_COORDINATOR_BINDINGS = [MQ_WORKER_REGISTER, MQ_WORKER_UNREGISTER , MQ_JOB_FINISH_REQUEST , MQ_JOB_START_REQUEST ,
                           MQ_JOB_CANCEL_REQUEST, MQ_WORKER_READY_FOR_JOB_START, MQ_JOB_SUBMIT_REQUEST, MQ_JOB_EDIT_REQUEST,
                           MQ_JOB_DELETE_REQUEST, MQ_WORKER_HEARTBEAT, MQ_JOB_STOP_REQUEST]
