...
function GetOciCommandsToLongParams_monitoring() {
    $ociCommandsToLongParams = @{
        ...
        'monitoring alarm update' = 'alarm-id body compartment-id defined-tags destinations display-name force freeform-tags from-json help if-match is-enabled max-wait-seconds metric-compartment-id metric-compartment-id-in-subtree namespace pending-duration query-text repeat-notification-duration resolution severity suppression wait-for-state wait-interval-seconds'
