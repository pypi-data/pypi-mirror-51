...
class Project(object):
    ...
    def __init__(self, name, folder):
        ...
        self.name = name
        self.folder = folder
        self.deps_file = path.join(folder, 'packages.yml')
    ...
    def create(self, production, create_dir):
    ...
    def load(self):
        ...
        try:
            ...
            User.objects.create_superuser(
                self.get_config()['admin_name'],
                self.get_config()['admin_email'],
                self.get_config()['admin_pass']
            )

        except django.db.utils.IntegrityError:
            logger.info('Admin {} already exists'.format(self.get_config()['admin_name']))
            pass
