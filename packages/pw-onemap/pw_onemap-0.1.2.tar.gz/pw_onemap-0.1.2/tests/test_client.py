...
from pw_onemap import exceptions, response, status
from pw_onemap.client import OneMap


@patch('pw_onemap.client.make_request')
...
@patch('pw_onemap.client.OneMap._connect')
@patch('pw_onemap.client.make_request')
