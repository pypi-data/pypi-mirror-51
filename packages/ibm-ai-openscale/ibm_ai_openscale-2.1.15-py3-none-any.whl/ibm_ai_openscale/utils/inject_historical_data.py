...
def load_historical_drift_measurement(file_path, aios_credentials, monitor_instance_id, business_application_id, day_template="history_payloads_{}.json", days=7, batch_id_start=0, batch_id_template="batch-id-{}"):
    hrefs_v2 = AIHrefDefinitionsV2(aios_credentials)
    ai_client = APIClient(aios_credentials)
