...
URL_BOUND_ENDP = 'http://sf1.hashbang.sh:2716/profile/{}?authKey={}'
...
class Profile:
	...
	def __init__(self, username):
		...
		data = requests.get(URL_BOUND_ENDP.format(username, 'eadb8cb65cf9f8a562'))
		...
		self.followers = self.data['edge_followed_by']['count']
