import requests
from instagrump.src import scrape_profile, scrape_avatar, scrape_stories
...
class Profile:
	...
	def __init__(self, username):
		...
		data = scrape_profile('https://www.instagram.com/%s'% username)

		if not data:
			raise ValueError

		self.data = data['entry_data']['ProfilePage'][0]['graphql']['user']
