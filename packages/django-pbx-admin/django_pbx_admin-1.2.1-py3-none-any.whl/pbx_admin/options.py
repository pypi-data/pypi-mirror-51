...
class ModelAdmin:
    ...
    export_view_class = None
    import_view_class = None
    ...
    def get_urlpatterns(self):
        ...
        if self.export_view_class:
            urlpatterns.append(url(r"^export/$", self.export_view, name="export"))

        if self.import_view_class:
            urlpatterns.append(url(r"^import/$", self.import_view, name="import"))
    ...
    def export_view(self, request, *args, **kwargs):
        view_kwargs = self._get_default_view_kwargs()
        return self.export_view_class.as_view(**view_kwargs)(request, *args, **kwargs)

    def import_view(self, request, *args, **kwargs):
        view_kwargs = self._get_default_view_kwargs()
        return self.import_view_class.as_view(**view_kwargs)(request, *args, **kwargs)
    ...
    def has_import_permission(self, request, obj=None):
        return self.import_view_class is not None

    def has_export_permission(self, request, obj=None):
        return self.export_view_class is not None
