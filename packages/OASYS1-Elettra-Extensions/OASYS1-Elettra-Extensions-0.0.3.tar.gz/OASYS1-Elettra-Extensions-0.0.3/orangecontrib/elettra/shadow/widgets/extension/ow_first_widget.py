...
class OWbm(ELETTRAWidget):
    ...
    file_path = os.path.join(resources.package_dirname("orangecontrib.elettra.shadow.widgets.extension"), "miscellanea", "test_first_widget.txt")
