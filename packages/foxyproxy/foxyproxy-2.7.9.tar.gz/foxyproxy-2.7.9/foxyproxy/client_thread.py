...
class ClientThread(Process):
    ...
    def __init__(self, signer, queue_in, queue_out, queue_ack, queue_rest, _id, mylock=None):
        """
    ...
    @classmethod
    def create_new_worker(cls, signer, name, work_q, result_q, ack_q, ack_rest, index, mylock=None):
        """
        ...
        new_client = ClientThread(signer, work_q, result_q, ack_q, ack_rest, index, mylock)
