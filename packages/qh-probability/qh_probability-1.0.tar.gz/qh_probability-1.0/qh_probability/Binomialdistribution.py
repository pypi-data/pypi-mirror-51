...
class Binomial(Distribution):
    ...
    def pdf(self, k):
        ...
        multiple = math.factorial(self.n) / (math.factorial(k) * math.factorial(self.n - k))
        pdf = multiple * (self.p ** k) * ((1 - self.p) ** (self.n - k))
    ...
    def __add__(self, other):
        ...
        n = self.n + other.n
        p = self.p
        sum_binomial = Binomial(p, n)
        sum_binomial.calculate_mean()
        sum_binomial.calculate_stdev()
