...
def set_session_parameters(aws_access_key_id=None,
    ...
    _session = boto3.session.Session(**larrydata.copy_non_null_keys(locals()))
    _client = None
...
def accept_qualification_request(request_id, value=None):
    return client().accept_qualification_request(QualificationRequestID=request_id, IntegerValue=value)


def approve_assignment(AssignmentId, RequesterFeedback=None, OverrideRejection=None):
    return client().approve_assignment(**larrydata.copy_non_null_keys(locals()))


def associate_qualification_with_worker(QualificationTypeId, WorkerId, IntegerValue=None, SendNotification=None):
    return client().associate_qualification_with_worker(**larrydata.copy_non_null_keys(locals()))


def create_additional_assignments_for_hit(HITId, NumberOfAdditionalAssignments, UniqueRequestToken):
    return client().create_additional_assignments_for_hit(**larrydata.copy_non_null_keys(locals()))
...
def create_hit(Title,
               ...
               MaxAssignments=None,
               AutoApprovalDelayInSeconds=None,
               Keywords=None,
               Question=None,
               RequesterAnnotation=None,
               QualificationRequirements=None,
               UniqueRequestToken=None,
               AssignmentReviewPolicy=None,
               HITReviewPolicy=None,
               HITLayoutId=None,
               HITLayoutParameters=None):
    return client().create_hit(**larrydata.copy_non_null_keys(locals()))
...
def create_hit_type(Title,
                    ...
                    Keywords=None,
                    QualificationRequirements=None):
    return client().create_hit_type(**larrydata.copy_non_null_keys(locals()))
