...
def accept_qualification_request(request_id, value=None):
    ...
    return client().accept_qualification_request(**params)


def approve_assignment(assignment_id, feedback=None, override_rejection=None):
    params = _map_parameters(locals(), {
        'assignment_id': 'AssignmentId',
        'feedback': 'RequesterFeedback',
        'override_rejection': 'OverrideRejection'
    })
    return client().approve_assignment(**params)
...
def create_additional_assignments_for_hit(hit_id, additional_assignments, request_token):
    params = _map_parameters(locals(), {
        'hit_id': 'HITId',
        'additional_assignments': 'NumberOfAdditionalAssignments',
        'request_token': 'UniqueRequestToken'
    })
    return client().create_additional_assignments_for_hit(**params)
...
def create_hit(title,
    ...
    return client().create_hit(**params)
...
def create_hit_type(title,
    ...
    return client().create_hit_type(**params)
