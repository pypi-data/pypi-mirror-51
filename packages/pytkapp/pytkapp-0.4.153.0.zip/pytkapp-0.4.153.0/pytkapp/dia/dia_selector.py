...
def run_demo():
    ...
    ll_variants.append(('<label>', 'Group', pta_icons.get_icon('gv_icon_eye'),))
    ll_variants.append(('Dummy12', None, None, '<dummy12>',))
    ll_variants.append(('Dummy22', None, None, '<dummy22>',))
