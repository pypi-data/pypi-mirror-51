...
class User:
    ...
    def from_yaml(
        ...
        if is_prototype is False:
            ...
            existing_inline_jmpr_roles = result["PolicyDocument"]["Statement"][0]["Resource"]
        else:
    ...
    @staticmethod
    def construct_user_prototype(username: str, identity_account_id: str, desired_path: str):
    ...
    def print_switchroles(self):
        print("Extend SwitchRoles plugin config:\n---------------------------------")
...
class CloudAssets:
    ...
    #  Class and static Methods
    @classmethod
    def from_org(cls, identity_account_id: str, org_unit_id: str, shared_role: str) -> 'CloudAssets':
    ...
    def parse_role_arn(arn: str):
        reg_arn = re.compile("^(?P<r_arn>[^.]*)\:\:(?P<r_acct>[^.]*)\:(?P<r_type>[^.]*?)\/"  # noqa: W605
                            "(?P<r_full_path>[^.]*)\/(?P<r_name>[^.*]*)$")  # noqa: W605
    ...
    def commit(self):
        ...
        self.update_targets(self.principals)
    ...
    def update_targets(self, principals):
            ...
            for role_arn in principal.target_roles:
                ...
                principal.extend_switch_roles.append(
                    "[{}{}{}]\nrole_arn = {}\nregion = {}\n".format(
                        ...
                        parsed_role_arn["full_path"],
                        parsed_role_arn["name"],
                        role_arn,
                        self.default_region
                    )
                )
