...
from .widgets import VtkCone as VtkConeOrig
...
class Accordion:
    ...
    def _serialize(self):
        return dict(
            project_name='reactopya_examples',
            type='Accordion',
            children=[
                ch._serialize()
...
class VtkCone:
    """Jupyter widget for VtkCone"""

    def __init__(self, *args, **kwargs):
        super().__init__()
        self._props = dict(**kwargs)
        self._children = list(args)
        self._component = VtkConeOrig()
        self._component.on_python_state_changed(lambda state: self._handle_python_state_changed(state, []))
        self._connect_children(self._children, [])
        self._reactopya_widget = None
        self._component.init_jupyter()
