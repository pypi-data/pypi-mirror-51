...
def init_jupyter(*, store_bundle_in_notebook=False):
    ...
    if store_bundle_in_notebook:
        print('Initialized reactopya_examples for Jupyter notebooks and stored bundle in notebook.')
    else:
        clear_output()
...
def init_colab(*, store_bundle_in_notebook=False):
    if store_bundle_in_notebook:
        print('Initialized reactopya_examples for Colab notebooks and storing bundle in notebook.')
    else:
        print('Initialized reactopya_examples for Colab notebooks.')
