...
class CipLog(object):
    ...
    def info(self, class_name, method, data, job_id, process_status, initial_time, finishing_time, user, path, host_ip, host_name, browser=None, user_ip=None, service_name=None, message=None, user_name=None):
        ...
        self._logger.info(
            message, extra={'level': 'INFO', 'class_name': class_name,
                            ...
                            'service_ip': self.service_ip, 'environment': self.environment, 'job_id': job_id,
                            'process_status': process_status, 'initial_time': initial_time, 'finishing_time': finishing_time,
                            'user': user, 'path': path, 'host_ip': host_ip, 'host_name': host_name, 'user_name': user_name})

    def warning(self, code, class_name, method, data, job_id, process_status, initial_time, finishing_time, user, path, host_ip, host_name, browser=None, user_ip=None, service_name=None, message=None, user_name=None):
        """This module write in a log file.
    ...
    def error(self, code, class_name, method, data, job_id, process_status, initial_time, finishing_time, user, path, host_ip, host_name, browser=None, user_ip=None, service_name=None, message=None, user_name=None):
        """This module write in a log file.
