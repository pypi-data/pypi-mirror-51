...
class VAEPlotter:
    ...
    def plot_label_correlations(self):
        ...
        try:
            recos, z1, z2 = self.latent_model.predict(images, batch_size=self.batch_size)
        except ValueError:
            recos, z1, z2 = self.latent_model.predict(images.reshape(self.batch_size, 28*28), batch_size=self.batch_size)
