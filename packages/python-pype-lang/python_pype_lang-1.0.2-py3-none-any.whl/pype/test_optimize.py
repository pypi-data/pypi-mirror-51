...
if __name__=='__main__':
    ...
    #print(f'{test_xedni_2_args(lsls)} is test_xedni_2_args')
    #print(f'{test_xedni_arg_opt(lsls)} is test_xedni_arg_opt')
    #print(f'{test_xedni_arg(ls)} is test_index_arg')
    #print(f'{test_xedni_arg_with_index_arg(ls)} is test_xedni_arg_with_index_arg')

    #print(f'{test_2d_numpy(a)} is test_2d_numpy(a)')
    #print(f'{test_2d_numpy_opt(a)} is test_2d_numpy_opt(a)')
