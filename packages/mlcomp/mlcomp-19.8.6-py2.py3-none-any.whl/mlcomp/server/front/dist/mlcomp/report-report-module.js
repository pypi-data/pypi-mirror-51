...
var ImgClassifyComponent = /** @class */ (function (_super) {
    ...
    function ImgClassifyComponent(service, location, layout_service, resource_service) {
        ...
        _this.metric_diff_min = 0;
        _this.metric_diff_max = 1;
        return _this;
    }
    ImgClassifyComponent.prototype.subscribe_data_changed = function () {
        ...
        this.layout_service.data_updated.subscribe(function (event) {
            ...
            var data = event.data[_this.item.index];
            for (var i = _this.data.epochs.length; i < data.epochs.length; i++) {
                _this.data.epochs.push(data.epochs[i]);
            }
        });
    };
    ...
    ImgClassifyComponent.prototype.plot_confusion = function (confusion, part, class_names) {
        ...
        var id = 'img_classify_' + part;
        window['Plotly'].newPlot(id, data, layout, { displayModeBar: false });
        var plot = document.getElementById(id);
        // @ts-ignore
        plot.on('plotly_click', function (data) {
            var pt = data.points[0];
            var y = class_names.indexOf(pt.y);
            var y_pred = class_names.indexOf(pt.x);
    ...
    ImgClassifyComponent.prototype.epoch_changed = function ($event) {
...
module.exports = ".mat-form-field {\n  font-size: 14px;\n  width: 100%;\n}\n\nmat-icon{\n  cursor: pointer;\n}\n\n::ng-deep .mat-sort-header-container{\n  display:flex;\n  justify-content:center;\n  text-align: center;\n  margin-left: 12px !important;\n}\n\n.mat-header-cell{\n  text-align: center !important;\n}\n\ntd{\n  text-align: center;\n}\n\n\n/*# sourceMappingURL=data:application/json;base64, */"
