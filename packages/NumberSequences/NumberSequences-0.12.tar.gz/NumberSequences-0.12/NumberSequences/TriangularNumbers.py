class TriangularNumbers:	
	...
	"""Calculate the Nth triangular number"""
		if isinstance(argument, int):
			...
			return int(res)
	def about(self, argument):
		"""Display information about triangular numbers"""
		print("A triangular number or triangle number counts objects arranged in an equilateral triangle. The nth triangular number is the number of dots in the triangular arrangement with n dots on a side, and is equal to the sum of the n natural numbers from 1 to n.")
