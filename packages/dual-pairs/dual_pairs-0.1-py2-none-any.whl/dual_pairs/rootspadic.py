...
def rootspadic(f, K):
    ...
    TESTS::
        ...
        sage: from dual_pairs.rootspadic import rootspadic
        sage: R.<x> = PolynomialRing(QQ)
        sage: K.<a> = Qp(23, 20).extension(x^2 + 23)
        sage: rootspadic(x, K)
        [0]
        sage: rootspadic(x^3 - x - 1, K)
        ...
        sage: rootspadic(x^6 - 6*x^4 + 9*x^2 + 23, K)
...
def padic_aut(K, r):
    ...
    TESTS::
        ...
        sage: from dual_pairs.rootspadic import padic_aut
        sage: R.<x> = QQ[]
