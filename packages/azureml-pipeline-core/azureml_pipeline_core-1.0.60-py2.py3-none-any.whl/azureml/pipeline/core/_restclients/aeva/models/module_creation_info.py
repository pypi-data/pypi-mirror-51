...
class ModuleCreationInfo(Model):
    ...
    def __init__(self, name=None, hash=None, description=None, is_deterministic=None, module_execution_type=None, identifier_hash=None, structured_interface=None, storage_id=None, is_interface_only=None, properties=None, module_type=None):
