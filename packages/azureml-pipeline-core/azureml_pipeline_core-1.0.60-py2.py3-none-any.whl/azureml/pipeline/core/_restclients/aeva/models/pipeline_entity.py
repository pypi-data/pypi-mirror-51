...
class PipelineEntity(Model):
    ...
    def __init__(self, name=None, description=None, version=None, graph_id=None, total_run_steps=None, parameter_assignments=None, url=None, id=None, etag=None, created_date=None, last_modified_date=None, entity_status=None, continue_run_on_step_failure=None, properties=None):
