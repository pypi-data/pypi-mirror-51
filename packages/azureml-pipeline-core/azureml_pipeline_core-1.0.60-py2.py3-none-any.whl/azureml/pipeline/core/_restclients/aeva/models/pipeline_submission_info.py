...
class PipelineSubmissionInfo(Model):
    ...
    def __init__(self, experiment_name=None, description=None, run_source=None, run_type=None, parameter_assignments=None, data_path_assignments=None, data_set_definition_value_assignments=None, schedule_id=None, continue_run_on_step_failure=None, tags=None, properties=None):
