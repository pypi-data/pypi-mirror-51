...
class PipelineRunCreationInfo(Model):
    ...
    def __init__(self, description=None, continue_experiment_on_node_failure=None, continue_run_on_step_failure=None, parameter_assignments=None, data_path_assignments=None, data_set_definition_value_assignments=None, run_source=None, run_type=None, run_history_experiment_name=None, tags=None, properties=None):
