...
class PipelineStep(object):
    ...
    def create_module_def(self, execution_type, input_bindings, output_bindings, param_defs=None,
        ...
        :type version: str
        :param module_type: The module type. It is different from execution_type, execution_type will
            specify which kind of backend service to run this module. Module type is for module creation
            service to identify what kind of module to be created. It currently only supports two types,
            None and BatchInferencing
