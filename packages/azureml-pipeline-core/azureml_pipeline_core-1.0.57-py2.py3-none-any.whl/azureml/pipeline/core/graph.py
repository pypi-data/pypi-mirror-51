...
class ModuleDef(object):
    ...
    :type version: str
    :param module_type: The module type. Currenly it supports two values, None and BatchInferencing.
    ...
    def module_type(self):
        """
        Get module type. Currenly it supports two values, None and BatchInferencing.
