...
class DataReference(Model):
    ...
    :param type: Possible values include: 'None', 'AzureBlob',
     ...
     'AzurePostgresDatabase', 'AzureDataLakeGen2'
    ...
    def __init__(self, type=None, azure_blob_reference=None, azure_data_lake_reference=None, azure_files_reference=None, azure_sql_database_reference=None, azure_postgres_database_reference=None, azure_data_lake_gen2_reference=None):
