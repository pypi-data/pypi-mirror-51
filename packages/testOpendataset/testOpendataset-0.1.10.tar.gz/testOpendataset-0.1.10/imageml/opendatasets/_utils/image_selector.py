...
class ImageSelector:
    ...
    def __init__(self, env: RuntimeEnv):
        ...
        self.model = OpenImage._OpenImage__model_spacy
        self.categoryList = self.GetCategories(OpenImage._OpenImage.__table_category)
        self.env = env
        ...
        for edaName, conditList in edaFilterList.items():
            ...
            if numericSelection and edaName in numericSelectionLower:
                ...
                if edaName == 'Category':
                    ...
                    newConditList = self.__GetSynonyms(self.model, categoryList, conditList)
