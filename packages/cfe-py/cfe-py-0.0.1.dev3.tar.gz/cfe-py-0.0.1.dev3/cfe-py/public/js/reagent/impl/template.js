...
var G__941 = o;
(G__941[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__942__delegate = function (args){
...
while (G__943__i < G__943__a.length) {G__943__a[G__943__i] = arguments[G__943__i + 0]; ++G__943__i;}
  args = new cljs.core.IndexedSeq(G__943__a,0,null);
} 
return G__942__delegate.call(this,args);};
G__942.cljs$lang$maxFixedArity = 0;
G__942.cljs$lang$applyTo = (function (arglist__944){
var args = cljs.core.seq(arglist__944);
return G__942__delegate(args);
});
...
var G__945 = o;
(G__945[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__950 = props;
var G__950__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__950,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__950);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__950__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__951){
var map__952 = p__951;
...
var props = map__952__$1;
var class$ = cljs.core.get.call(null,map__952__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__952,map__952__$1,props,class$){
return (function (c){
...
});})(map__952,map__952__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__954){
var map__955 = p__954;
var map__955__$1 = (((((!((map__955 == null))))?(((((map__955.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__955.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__955):map__955);
var on_write = cljs.core.get.call(null,map__955__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__955,map__955__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__955,map__955__$1,on_write))
);
} else {
...
var G__958 = jsprops;
(G__958["defaultValue"] = value);

(G__958["onChange"] = ((function (G__958,v,value,on_change){
return (function (p1__957_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__957_SHARP_);
});})(G__958,v,value,on_change))
);
...
var vec__961 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__961,(0),null);
var id = cljs.core.nth.call(null,vec__961,(1),null);
var class$ = cljs.core.nth.call(null,vec__961,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___965 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___965 == null)){
} else {
var key_966 = temp__5739__auto___965;
(jsprops["key"] = key_966);
}
...
var temp__5739__auto___967 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___967 == null)){
} else {
var key_968 = temp__5739__auto___967;
reagent.impl.template.oset.call(null,jsprops,"key",key_968);
}
...
var G__969 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__969["name"] = c);
...
var len__4641__auto___974 = arguments.length;
var i__4642__auto___975 = (0);
while(true){
if((i__4642__auto___975 < len__4641__auto___974)){
args__4647__auto__.push((arguments[i__4642__auto___975]));

var G__976 = (i__4642__auto___975 + (1));
i__4642__auto___975 = G__976;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq972){
var G__973 = cljs.core.first.call(null,seq972);
var seq972__$1 = cljs.core.next.call(null,seq972);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__973,seq972__$1);
});
...
break;
default:
var G__979 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__979;
continue;
...
var n__4518__auto___981 = a.length;
var i_982 = (0);
while(true){
if((i_982 < n__4518__auto___981)){
(a[i_982] = reagent.impl.template.as_element.call(null,(a[i_982])));
...
var a = cljs.core.into_array.call(null,s);
var n__4518__auto___984 = a.length;
var i_985 = (0);
while(true){
if((i_985 < n__4518__auto___984)){
var val_986 = (a[i_985]);
if(((cljs.core.vector_QMARK_.call(null,val_986)) && ((reagent.impl.template.key_from_vec.call(null,val_986) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_985] = reagent.impl.template.as_element.call(null,val_986));
...
var ctx = ({});
var vec__988 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__988,(0),null);
var derefed = cljs.core.nth.call(null,vec__988,(1),null);
...
var G__991 = (cljs.core.count.call(null,argv) - first_child);
switch (G__991) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__991){
