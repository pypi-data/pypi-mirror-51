...
from netizensapi.websocket import NetizensWebsocket
...
class Notify(Events, BlockchainInstance):
    """ Notifications on Blockchain events.
        ...
        :param list markets: Instances of :class:`netizens.market.Market` that identify markets to be monitored
        ...
        **Example**
        ...
        .. code-block:: python
            ...
            from netizens.notify import Notify
            from netizens.market import Market
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Open the websocket
        self.websocket = NetizensWebsocket(
    ...
    def process_market(self, data):
        """ This method is used for post processing of market
            ...
            * :class:`netizens.price.Order` or
            * :class:`netizens.price.FilledOrder` or
            * :class:`netizens.price.UpdateCallOrder`
    ...
    def process_account(self, message):
        """ This is used for processing of account Updates. It will
            return instances of :class:netizens.account.AccountUpdate`
        """
