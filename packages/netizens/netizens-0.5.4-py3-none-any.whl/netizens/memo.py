...
from netizensbase.account import PrivateKey, PublicKey
...
class Memo(GrapheneMemo):
    """ Deals with Memos that are attached to a transfer
        ...
        :param netizens.account.Account from_account: Account that has sent
            the memo
        :param netizens.account.Account to_account: Account that has received
            the memo
        ...
        .. code-block:: python
            ...
            from netizens.memo import Memo
            m = Memo("netizenseu", "wallet.donbc")
