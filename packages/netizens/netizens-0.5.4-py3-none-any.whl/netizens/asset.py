...
from netizensbase.asset_permissions import (
    asset_permissions,
    force_flag,
    test_permissions,
    todict,
...
class Asset(GrapheneAsset):
    """ Deals with Assets of the network.
        ...
        :param netizens.netizens.Netizens blockchain_instance: Netizens
            instance
    ...
    def seize(self, from_account, to_account, amount):
        """ Seize amount from an account and send to another
            ...
            :param netizens.account.Account from_account: From this account
            :param netizens.account.Account to_account: To this account
            :param netizens.amount.Amount amount: Amount to seize
        """
    ...
    def set_market_fee(self, percentage_fee, max_market_fee):
        """ Set trading percentage fee
            ...
            :param netizens.amount.Amount max_market_fee: Max Fee
