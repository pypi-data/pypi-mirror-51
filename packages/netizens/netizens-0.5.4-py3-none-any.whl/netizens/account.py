...
class Account(GrapheneAccount):
    """ This class allows to easily access Account data
        ...
        :rtype: dictionary
        :raises netizens.exceptions.AccountDoesNotExistsException: if account
                does not exist
        ...
        .. code-block:: python
            ...
            from netizens.account import Account
    ...
    def call_positions(self):
        """ Alias for :func:netizens.account.Account.callpositions
        """
...
class AccountUpdate(GrapheneAccountUpdate):
    """ This purpose of this class is to keep track of account updates
        as they are pushed through by :class:`netizens.notify.Notify`.
