...
class XGB:
    ...
    def __init__(self, training_embeddings, test_embeddings, output_path = "", UNDERSAMPLING_RATIO=0, OVERSAMPLING_ALGORITHM="", OVERSAMPLING_RATIO=0, SCALING="", WORKERS=3, scale_pos_weight=1, val_percentage=0.1):

        st = time.time()
        
        X_train, y_train = preprocessing(training_embeddings, UNDERSAMPLING_RATIO=UNDERSAMPLING_RATIO, SCALING=SCALING, OVERSAMPLING_RATIO=OVERSAMPLING_RATIO, OVERSAMPLING_ALGORITHM=OVERSAMPLING_ALGORITHM)
