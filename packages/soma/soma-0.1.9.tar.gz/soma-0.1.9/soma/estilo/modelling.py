...
def make_model(
    ...
    """
        ...
        Args:
            ...
            kernel_regularizers (list(:module:`keras.regularizers`)): A list with the regularizer for each layer.
            opt (:module:`keras.optimizers`): The optimizer parameter for the :func:`keras.Sequential.compile`.
