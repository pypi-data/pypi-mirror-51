...
from .accessories.seattle_safety_accessory import SeattleSafetyAccessory
from azureml.core import Dataset
from typing import List, Optional


class SeattleSafety(AbstractOpenDataset):
    """Seattle city safety class."""

    def __init__(
            self,
            start_date: datetime = SeattleSafetyAccessory.default_start_date,
            end_date: datetime = SeattleSafetyAccessory.default_end_date,
            cols: Optional[List[str]] = None,
            dataset: Dataset = None,
            enable_telemetry: bool = True):
        """
        Initializes an instance of the SeattleSafety class.
        ...
        """
        worker = SeattleSafetyAccessory(
            start_date=start_date,
            end_date=end_date,
            cols=cols,
            enable_telemetry=enable_telemetry)
        if dataset is not None:
            if start_date != SeattleSafetyAccessory.default_start_date and \
                end_date != SeattleSafetyAccessory.default_end_date and \
                    cols is not None:
...
at the same time! Please use either of them.')
    ...
    def get(dataset: Dataset, enable_telemetry: bool = True):
        """Get an instance of SeattleSafety.

        :param dataset: input an instance of Dataset.
        :type end_date: Dataset.
        :param enable_telemetry: whether to enable telemetry, disabled for UT only.
        :type enable_telemetry: bool
        :return: an instance of SeattleSafety.
        """
        sea = SeattleSafety(dataset=dataset, enable_telemetry=enable_telemetry)
