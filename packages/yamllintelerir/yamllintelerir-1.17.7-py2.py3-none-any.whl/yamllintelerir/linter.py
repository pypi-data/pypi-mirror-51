...
from yamllintelerir import parser
...
class LintProblem(object):
    """Represents a linting problem found by yamllintelerir"""
...
def get_cosmetic_problems(buffer, conf, filepath):
    ...
    class DisableDirective:
        ...
        def process_comment(self, comment):
            try:
                ...
                return  # this certainly wasn't a yamllintelerirdirective comment

            if re.match(r'^# yamllintelerirdisable( rule:\S+)*\s*$', comment):
            ...
            elif re.match(r'^# yamllintelerirenable( rule:\S+)*\s*$', comment):
    ...
    class DisableLineDirective(DisableDirective):
        def process_comment(self, comment):
            ...
            if re.match(r'^# yamllintelerirdisable-line( rule:\S+)*\s*$', comment):
    ...
    # found. This allows the use of yamllintelerirdirective to disable some rules on
    # some lines.
    cache = []
...
def _run(buffer, conf, filepath):
    ...
    for problem in get_cosmetic_problems(buffer, conf, filepath):
        ...
        if (syntax_error and syntax_error.line <= problem.line and
            ...
            # If there is already a yamllintelerirerror at the same place, discard
...
def run(input, conf, filepath=None):
    ...
    :param conf: yamllintelerirconfiguration object
    """
