...
class Notify(Events, BlockchainInstance):
    """ Notifications on Blockchain events.
        ...
        :param list markets: Instances of :class:`meta1-testnet.market.Market` that identify markets to be monitored
        ...
        **Example**
        ...
        .. code-block:: python
            ...
            from meta1-testnet.notify import Notify
            from meta1-testnet.market import Market
    ...
    def process_market(self, data):
        """ This method is used for post processing of market
            ...
            * :class:`meta1-testnet.price.Order` or
            * :class:`meta1-testnet.price.FilledOrder` or
            * :class:`meta1-testnet.price.UpdateCallOrder`
    ...
    def process_account(self, message):
        """ This is used for processing of account Updates. It will
            return instances of :class:meta1-testnet.account.AccountUpdate`
        """
