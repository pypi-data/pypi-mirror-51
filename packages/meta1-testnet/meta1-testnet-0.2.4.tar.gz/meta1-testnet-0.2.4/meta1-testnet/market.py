...
class Market(dict):
    """ This class allows to easily access Markets on the blockchain for trading, etc.
        ...
        :param meta1-testnet.meta1-testnet.Meta1 blockchain_instance: Meta1 instance
        :param meta1-testnet.asset.Asset base: Base asset
        :param meta1-testnet.asset.Asset quote: Quote asset
        ...
        * ``base`` and ``quote`` are valid assets (according to :class:`meta1-testnet.asset.Asset`)
        * ``base:quote`` separated with ``:``
        * ``base/quote`` separated with ``/``
        * ``base-quote`` separated with ``-``

        .. note:: Throughout this library, the ``quote`` symbol will be
                  presented first (e.g. ``USD:TEST1`` with ``USD`` being the
                  quote), while the ``base`` only refers to a secondary asset
                  for a trade. This means, if you call
                  :func:`meta1-testnet.market.Market.sell` or
                  :func:`meta1-testnet.market.Market.buy`, you will sell/buy **only
    ...
    def get_string(self, separator=":"):
        """ Return a formated string that identifies the market, e.g. ``USD:TEST1``
    ...
    def ticker(self):
        """ Returns the ticker for all markets.
            ...
            * ``core_exchange_rate``: Core exchange rate for payment of fee in non-TEST1 asset
    ...
    def orderbook(self, limit=25):
        """ Returns the order book for a given market. You may also
            ...
            .. code-block:: js
                ...
                {'bids': [0.003679 USD/TEST1 (1.9103 USD|519.29602 TEST1),
                0.003676 USD/TEST1 (299.9997 USD|81606.16394 TEST1),
                0.003665 USD/TEST1 (288.4618 USD|78706.21881 TEST1),
                0.003665 USD/TEST1 (3.5285 USD|962.74409 TEST1),
                0.003665 USD/TEST1 (72.5474 USD|19794.41299 TEST1)],
                'asks': [0.003738 USD/TEST1 (36.4715 USD|9756.17339 TEST1),
                0.003738 USD/TEST1 (18.6915 USD|5000.00000 TEST1),
                0.003742 USD/TEST1 (182.6881 USD|48820.22081 TEST1),
                0.003772 USD/TEST1 (4.5200 USD|1198.14798 TEST1),
                0.003799 USD/TEST1 (148.4975 USD|39086.59741 TEST1)]}


            .. note:: Each bid is an instance of
                class:`meta1-testnet.price.Order` and thus carries the keys
    ...
    def accountopenorders(self, account=None):
        """ Returns open Orders
            ...
            :param meta1-testnet.account.Account account: Account name or instance of Account to show orders for in this market
        """
        if not account:
            if "default_account" in self.blockchain.config:
                account = self.blockchain.config["default_account"]
            ...
            **Example:** in the USD_META1 market, a price of 300 means
            ...
            .. warning::
                ...
                for. Example:
                    ...
                    * You place and order to buy 10 USD for 100 TEST1/USD
                    * This means that you actually place a sell order for 1000 TEST1 in order to obtain **at least** 10 USD
