...
class Asset(GrapheneAsset):
    """ Deals with Assets of the network.
        ...
        :param meta1-testnet.meta1-testnet.Meta1 blockchain_instance: Meta1
            instance
    ...
    def seize(self, from_account, to_account, amount):
        """ Seize amount from an account and send to another
            ...
            :param meta1-testnet.account.Account from_account: From this account
            :param meta1-testnet.account.Account to_account: To this account
            :param meta1-testnet.amount.Amount amount: Amount to seize
        """
    ...
    def set_market_fee(self, percentage_fee, max_market_fee):
        """ Set trading percentage fee
            ...
            :param meta1-testnet.amount.Amount max_market_fee: Max Fee
