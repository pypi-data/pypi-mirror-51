...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v0.2.10-dev.1567076675+gb35b264'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v0.2.10-dev.1567076675+gb35b264`
                """)
            else:
                raise
