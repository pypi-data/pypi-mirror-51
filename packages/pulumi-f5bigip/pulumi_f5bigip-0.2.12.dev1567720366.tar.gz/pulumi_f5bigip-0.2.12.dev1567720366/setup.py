...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v0.2.12-dev.1567720366+g95e777c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v0.2.12-dev.1567720366+g95e777c`
                """)
            else:
                raise
