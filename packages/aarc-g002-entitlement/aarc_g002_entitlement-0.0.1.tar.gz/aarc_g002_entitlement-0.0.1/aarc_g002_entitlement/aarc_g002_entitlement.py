...
class Aarc_g002_entitlement :
    ...
    def __repr__(self):
        ...
        This is the inverse to `__init__` and thus `ent_str == repr(Aarc_g002_ePE(ent_str))`
...
if __name__ == '__main__':
    ...
    required_entitlement = Aarc_g002_ePE(required_group)
    actual_entitlement   = Aarc_g002_ePE(actual_group)
    ...
    print ('\n\n{}\n{}'.format(actual_entitlement.__repr__, actual_entitlement.__repr2__))
    print ('\n\n{}\n{}'.format(actual_entitlement.__repr__(), actual_entitlement.__repr2__()))
