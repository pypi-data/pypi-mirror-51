...
class StreamingDataset(DatasetBase):
    ...
    def get_subsampled_dataset(self, training_percent, random_state=None):
        ...
        # rows are consistent across sampled X, y, and sample_weight Dataflow
        ...
        X = self.X.take_sample(subsample_frac, random_state)
        y = self.y.take_sample(subsample_frac, random_state)
        sample_weight = None
        if self.sample_weight is not None:
            sample_weight = self.sample_weight.take_sample(subsample_frac, random_state)
