...
class LegacyModelNames:
    ...
    class ClassificationLegacyModelNames:
        ...
        NimbusMLFastLinearClassifier = 'nimbusml fast linear classifier'
...
class SupportedModelNames:
    ...
    SupportedClassificationModelList = [
        ...
        ModelName(
            SupportedModels.Classification.NimbusMLFastLinearClassifier,
            LegacyModelNames.ClassificationLegacyModelNames.NimbusMLFastLinearClassifier,
            ModelClassNames.ClassificationModelClassNames.NimbusMLFastLinearClassifier),
        ModelName(
