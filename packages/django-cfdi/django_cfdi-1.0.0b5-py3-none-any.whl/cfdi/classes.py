...
class CFDI:
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            self.DFACTURE_USUARIO_PRUEBA = DFACTURE_AUTH["dev"]["usuario"]
            self.DFACTURE_PASSWORD_PRUEBA = DFACTURE_AUTH["dev"]["password"]
        except:
            self.DFACTURE_USUARIO_PRUEBA = ""
            self.DFACTURE_PASSWORD_PRUEBA = ""
        try:
            self.DFACTURE_USUARIO = DFACTURE_AUTH["prod"]["usuario"]
            self.DFACTURE_PASSWORD = DFACTURE_AUTH["prod"]["password"]
        except:
