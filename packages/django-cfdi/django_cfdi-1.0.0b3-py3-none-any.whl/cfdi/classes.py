...
from .settings import (
    TMP_DIR, DFACTURE_AUTH, PRODIGIA_AUTH, NTLINK_AUTH, ERROR_CALLBACK, 
    POST_TIMBRADO_CALLBACK
)
...
class CFDI:
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            self.prodigia_contrato = settings.PRODIGIA_AUTH["prod"]["contrato"]
            self.prodigia_usuario = settings.PRODIGIA_AUTH["prod"]["usuario"]
            self.prodigia_password = settings.PRODIGIA_AUTH["prod"]["password"]
        ...
        try:
            self.DFACTURE_USUARIO_PRUEBA = settings.DFACTURE_AUTH["dev"]["usuario"]
            self.DFACTURE_PASSWORD_PRUEBA = settings.DFACTURE_AUTH["dev"]["password"]
        except:
            self.DFACTURE_USUARIO_PRUEBA = ""
            self.DFACTURE_PASSWORD_PRUEBA = ""
        try:
            self.DFACTURE_USUARIO = settings.DFACTURE_AUTH["prod"]["usuario"]
            self.DFACTURE_PASSWORD = settings.DFACTURE_AUTH["prod"]["password"]
        except:
        ...
        self.ntlink_usuario = settings.NTLINK_AUTH["prod"]["usuario"]
        self.ntlink_password = settings.NTLINK_AUTH["prod"]["password"]

        self.ntlink_pruebas_url = "http://pruebas.ntlink.com.mx/Certificador/ServicioTimbrado.svc?wsdl"
        self.ntlink_pruebas_usuario = settings.NTLINK_AUTH["dev"]["usuario"]
        self.ntlink_pruebas_password = settings.NTLINK_AUTH["prod"]["password"]
        ...
        # callback funcs
        self._error_cb = kwargs["error_cb"]
  ...
  <retenciones:Complemento>
    ...
    def _post_timbrar_callback(self):
        ...
        if POST_TIMBRADO_CALLBACK:
            POST_TIMBRADO_CALLBACK(self, error)
