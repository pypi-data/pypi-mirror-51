...
def create_norgatedata_equities_bundle(bundlename,stock_price_adjustment_setting,watchlists,start_session,end_session):
    #print('Registering Norgate Data equities bundle ' + bundlename + )
    def ingest(environ,
               asset_db_writer,
               minute_bar_writer,
               daily_bar_writer,
               ...
               show_progress,
               output_dir):
        print('Ingesting equities bundle' + bundlename + ' with start date ' + start_session.strftime('%Y-%m-%d'))
...
def create_norgatedata_futures_bundle(bundlename,watchlists,start_session,end_session):
    def ingest(environ,
               ...
               show_progress,
               output_dir):
        print('Ingesting futures bundle ' + bundlename + ' with start date ' + start_session.strftime('%Y-%m-%d'))
