...
from zipline.algorithm import sid, symbol
...
class NorgateDataIndexConstituent(Filter):
    ...
    def _compute(self, arrays, dates, assets, mask):
        logger.info('Pipeline ' + self.__class__.__name__ + ' populating for ' + self.indexname + ' on ' + str(assets.size) + ' securities' )
        ...
        logger.info('Pipeline ' + self.__class__.__name__ + ' for ' + self.indexname + ': Done')
        return result
