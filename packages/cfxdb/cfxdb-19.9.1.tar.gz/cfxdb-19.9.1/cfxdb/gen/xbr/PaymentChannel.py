...
# /// Last off-chain, closing transaction: public key of buyer.
    # PaymentChannel
    def ClosePubkey(self, j):
    ...
    # PaymentChannel
    def ClosePubkeyLength(self):
        o = flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(32))
        if o != 0:
            return self._tab.VectorLen(o)
        return 0

# /// Last off-chain, closing transaction: data encryption key ID.
    # PaymentChannel
    def CloseKeyId(self, j):
...
# /// Last off-chain, closing transaction: transaction amount (XBR).
    # PaymentChannel
    def CloseAmount(self, j):
...
def PaymentChannelStart(builder): builder.StartObject(20)
...
def PaymentChannelAddClosePubkey(builder, closePubkey): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(closePubkey), 0)
def PaymentChannelStartClosePubkeyVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def PaymentChannelAddCloseKeyId(builder, closeKeyId): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(closeKeyId), 0)
def PaymentChannelStartCloseKeyIdVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def PaymentChannelAddCloseChannelSeq(builder, closeChannelSeq): builder.PrependUint32Slot(16, closeChannelSeq, 0)
def PaymentChannelAddCloseAmount(builder, closeAmount): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(closeAmount), 0)
def PaymentChannelStartCloseAmountVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def PaymentChannelAddCloseBalance(builder, closeBalance): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(closeBalance), 0)
def PaymentChannelStartCloseBalanceVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def PaymentChannelAddClosedTx(builder, closedTx): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(closedTx), 0)
