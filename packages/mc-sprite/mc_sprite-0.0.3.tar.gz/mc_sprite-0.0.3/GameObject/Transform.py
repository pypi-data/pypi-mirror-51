from GameObject.Vector2 import Vector2
import pygame
...
class Transform(object):
    def __init__(self, image: str):
        ...
        self.__agl=0.0
        self.__scl=Vector2(100.0,100.0)
    ...
    @property
    def localScale(self):
        return Vector2(self.__scl.x,self.__scl.y)
    def Translate(self,x: float,y: float):
        self.__scl.x=x
        self.__scl.y=y
        self.__UpdateLocalScale()
    def __UpdateLocalScale(self):
        pygame.transform.scale(self.image,(self.__wid*(self.__scl.x/100),self.__hgt*(self.__scl.y/100)))
        pass
