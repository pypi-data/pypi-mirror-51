...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', 'v0.18.14-dev.1567720242+g32c025f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean v0.18.14-dev.1567720242+g32c025f`
                """)
            else:
                raise
