...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', 'v0.18.11-dev.1566339297+g4202fa7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean v0.18.11-dev.1566339297+g4202fa7`
                """)
            else:
                raise
