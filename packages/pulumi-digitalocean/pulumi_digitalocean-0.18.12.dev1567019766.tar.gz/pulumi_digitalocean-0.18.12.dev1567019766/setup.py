...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', 'v0.18.12-dev.1567019766+g2a02746'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean v0.18.12-dev.1567019766+g2a02746`
                """)
            else:
                raise
