...
def f3(driver, url):
    driver.get(url)
    locator = (By.XPATH, "//div[@class='WordSection1'][string-length()>60]|//div[@class='s_main'][string-length()>30]")
...
if __name__ == "__main__":
    ...
    # driver.get('http://www.kfsggzyjyw.cn/jzbgg/index_1.jhtml')
    # print(f1(driver, 50))
    print(f3(driver, 'http://www.kfsggzyjyw.cn/zzbggtxx/18703.jhtml'))