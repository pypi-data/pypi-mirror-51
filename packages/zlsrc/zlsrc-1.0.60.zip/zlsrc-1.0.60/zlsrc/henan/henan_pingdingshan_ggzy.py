...
data=[
        ["gcjs_zhaobiao_gg","http://www.pdsggzy.com/gzbgg/index_1.jhtml",["name","ggstart_time","href","info"],f1,f2],

        ["gcjs_gqita_bu_gg","http://www.pdsggzy.com/gbcgg/index_1.jhtml",["name","ggstart_time","href","info"],f1,f2],
        ...
        ["zfcg_biangeng_gg","http://www.pdsggzy.com/zbcgg/index_1.jhtml",["name","ggstart_time","href","info"],f1,f2],
...
# 修改日期：2019/7/8
# 第二次修改 2019年8月22日15:17:10
if __name__=="__main__":
    work(conp=["postgres","since2015","192.168.4.199","henan","henan_pingdingshan_ggzy"])
