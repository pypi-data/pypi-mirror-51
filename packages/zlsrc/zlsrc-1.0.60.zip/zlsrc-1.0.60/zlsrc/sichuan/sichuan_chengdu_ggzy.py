...
data = [
    ...
    ["zfcg_biangeng_gg", "https://www.cdggzy.com/site/Notice/ZFCG/NoticeVersionOneList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(f1, '更正(澄清)公告'), switch_to(f2, '更正(澄清)公告')],
    #
    ["zfcg_zhongbiao_lx1_gg", "https://www.cdggzy.com/site/Notice/ZFCG/NoticeVersionOneList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(f1, '中标结果公告'), switch_to(f2, '中标结果公告')],
    #
    ["zfcg_zhongbiao_lx2_gg", "https://www.cdggzy.com/site/Notice/ZFCG/NoticeVersionOneList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'gglx':'成交结果公告'}), '成交结果公告'), switch_to(f2, '成交结果公告')],

    ["zfcg_liubiao_gg", "https://www.cdggzy.com/site/Notice/ZFCG/NoticeVersionOneList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(f1, '采购失败公告'), switch_to(f2, '采购失败公告')],

    ["zfcg_gqita_zgxsc_shiji_gg", "https://www.cdggzy.com/site/Notice/CprtsCGXX/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'gglx':'资格性审查情况公告'}), '资格性审查情况公告'), switch_to(f2,'资格性审查情况公告')],

    ["zfcg_gqita_fhxsc_shiji_gg", "https://www.cdggzy.com/site/Notice/CprtsCGXX/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'gglx':'符合性审查情况公告'}), '符合性审查情况公告'), switch_to(f2,'符合性审查情况公告')],
    #
    ["zfcg_gqita_gysdf_shiji_gg", "https://www.cdggzy.com/site/Notice/CprtsCGXX/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'gglx':'供应商得分公告'}), '供应商得分公告'), switch_to(f2, '供应商得分公告')],
    # #
    ["zfcg_zhaobiao_pljz_gg", "https://www.cdggzy.com/site/Notice/PLJZ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs':'批量集中采购'}), '采购公告'), switch_to(f2, '采购公告')],

    ["zfcg_gqita_baojia_pljz_gg", "https://www.cdggzy.com/site/Notice/PLJZ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs':'批量集中采购','gglx':'报价情况公告'}), '报价情况公告'), switch_to(f2, '报价情况公告')],

    ["zfcg_gqita_zhong_liu_pljz_gg", "https://www.cdggzy.com/site/Notice/PLJZ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs':'批量集中采购'}), '结果公告'), switch_to(f2, '结果公告')],
    #
    ["zfcg_hetong_pljz_gg", "https://www.cdggzy.com/site/Notice/PLJZ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs': '批量集中采购'}), '合同履约情况'), switch_to(f2, '合同履约情况')],
    #
    ...
    ["zfcg_gqita_baojia_wsjj_gg", "https://www.cdggzy.com/site/Notice/CprtsWSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs':'网上竞价','gglx':'报价情况公告'}), '报价情况公告'), switch_to(f2, '报价情况公告')],
    ...
    ["zfcg_hetong_wsjj_gg", "https://www.cdggzy.com/site/Notice/CprtsWSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs': '网上竞价'}), '合同履约情况'), switch_to(f2, '合同履约情况')],

    ["zfcg_zhongbiao_wsjj_gg", "https://www.cdggzy.com/site/Notice/CprtsWSJJ/NoticeListNew.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs':'网上竞价','gglx':'成交记录公告'}), '成交记录公告'), switch_to(f2, '成交记录公告')],

    ["zfcg_biangeng_wsjj_gg", "https://www.cdggzy.com/site/Notice/CprtsWSJJ/NoticeListNew.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs':'网上竞价'}), '变更公告'), switch_to(f2, '变更公告')],
    ...
    ["zfcg_zhongbiao_ddcg_gg", "https://www.cdggzy.com/site/Notice/CprtsDDCGNewAdd/FurnitureDD/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to_1(add_info(f1, {'zbfs':'网上竞价'}), '全部'), switch_to_1(f2, '全部')],

    ["zfcg_zhaobiao_qcqcg_gg", "https://www.cdggzy.com/site/Notice/QCQCGXX/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'diqu':'七城区'}), '招标公告'), switch_to(f2, '招标公告')],

    ["zfcg_biangeng_qcqcg_gg", "https://www.cdggzy.com/site/Notice/QCQCGXX/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'diqu':'七城区'}), '变更公告'), switch_to(f2, '变更公告')],

    ["zfcg_gqita_zhong_liu_qcqcg_gg", "https://www.cdggzy.com/site/Notice/QCQCGXX/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'diqu':'七城区'}), '结果公告'), switch_to(f2, '结果公告')],
    #
    ["zfcg_zhaobiao_qxwsjj_gg", "https://www.cdggzy.com/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs':'网上竞价','diqu':'区县'}), '采购公告'), switch_to(f2, '采购公告')],

    ["zfcg_zhongbiao_qxwsjj_gg", "https://www.cdggzy.com/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs':'网上竞价','diqu':'区县'}), '结果公告'), switch_to(f2, '结果公告')],

    ["zfcg_liubiao_qxwsjj_gg", "https://www.cdggzy.com/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs':'网上竞价','diqu':'区县'}), '失败公告'), switch_to(f2, '失败公告')],

    ["zfcg_gqita_jieguobiangeng_qxwsjj_gg", "https://www.cdggzy.com/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs':'网上竞价','diqu':'区县','gglx':'结果变更公告'}), '结果变更公告'), switch_to(f2, '结果变更公告')],
    #
    ["zfcg_zhaobiao_qxddcg_gg", "https://www.cdggzy.com/site/Notice/DDCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs':'定点采购','diqu':'区县'}), '采购公告'), switch_to(f2, '采购公告')],

    ["zfcg_zhongbiao_qxddcg_gg", "https://www.cdggzy.com/site/Notice/DDCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs':'定点采购','diqu':'区县'}), '结果公告'), switch_to(f2, '结果公告')],

    ["zfcg_liubiao_qxddcg_gg", "https://www.cdggzy.com/site/Notice/DDCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs':'定点采购','diqu':'区县'}), '失败公告'), switch_to(f2, '失败公告')],

    ["zfcg_gqita_jieguobiangeng_qxddcg_gg", "https://www.cdggzy.com/site/Notice/DDCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'zbfs':'定点采购','diqu':'区县','gglx':'结果变更公告'}), '结果变更公告'), switch_to(f2, '结果变更公告')],
    #
    ["zfcg_gqita_zgxsc_quxian_gg", "https://www.cdggzy.com/site/Notice/Suppermsg/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'diqu':'区县','gglx':'资格性审查公告'}),'资格性审查公告'), switch_to(f2,'资格性审查公告')],

    ["zfcg_gqita_fhxsc_quxian_gg", "https://www.cdggzy.com/site/Notice/Suppermsg/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'diqu':'区县','gglx':'符合性审查公告'}),'符合性审查公告'), switch_to(f2,'符合性审查公告')],

    ["zfcg_gqita_defen_quxian_gg", "https://www.cdggzy.com/site/Notice/Suppermsg/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], switch_to(add_info(f1, {'diqu':'区县','gglx':'得分公示'}),'得分公示'), switch_to(f2,'得分公示')],
]
...
if __name__=='__main__':
    work(conp=["postgres","since2015","192.168.3.171","sichuan","chengdu"],ipNum=0,headless=False)
