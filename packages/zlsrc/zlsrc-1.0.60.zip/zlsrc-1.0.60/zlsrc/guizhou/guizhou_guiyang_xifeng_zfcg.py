...
_name_ = 'guizhou_guiyang_xifeng_zfcg'
...
def f2(driver):
    total_page = WebDriverWait(driver,10).until(EC.presence_of_element_located((By.XPATH,'//div[@class="page"]/a[last()-1]'))).text
    driver.quit()
...
def f3(driver, url):
    driver.get(url)
    locator = (By.XPATH, '//div[@class="body_contenter"]')
...
data = [
    ["zfcg_zhaobiao_gg",
     "http://www.xifeng.gov.cn/zwgk/xxgkml/zdlyxx/zfcg/zbgg/index_1.html",
     ["name", "ggstart_time", "href", "info"], f1, f2],

    ["zfcg_gqita_zhong_liu_gg",
     "http://www.xifeng.gov.cn/zwgk/xxgkml/zdlyxx/zfcg/jggs/index_2.html",
     ["name", "ggstart_time", "href", "info"], f1, f2],
...
#贵州贵阳息烽县人民政府
def work(conp, **args):
    est_meta(conp, data=data, diqu="贵州省贵阳市息烽县", **args)
    est_html(conp, f=f3, **args)


if __name__ == "__main__":
    conp = ["postgres", "since2015", "192.168.3.171", "zlest", "guizhou_guiyang_xifeng_zfcg"]
