...
data = [
    ...
    ["gcjs_gqita_pingbiao_gg", "http://www.hljggzyjyw.gov.cn/trade/tradezfcg?cid=16&pageNo=1&type=8&notice_name=",
     ["name", "ggstart_time", "href", "info"], add_info(f1,{"gclx":"评标结果"}), f2],

    ["gcjs_gqita_da_bian_gg", "http://www.hljggzyjyw.gov.cn/trade/tradezfcg?cid=16&pageNo=1&type=7&notice_name=",
     ["name", "ggstart_time", "href", "info"], f1, f2],
