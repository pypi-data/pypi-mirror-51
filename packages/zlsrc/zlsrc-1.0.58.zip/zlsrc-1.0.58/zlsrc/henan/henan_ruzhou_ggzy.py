...
def f2(driver):
    try:
        ...
        href = WebDriverWait(driver, 10).until(EC.presence_of_element_located( (By.XPATH, "//div[contains(@class,'TxtCenter')]/div"))).text
...
def f3(driver, url):
    ...
    locator = (By.XPATH, "//div[@class='Padding10 BorderCCCDot F14 Contnet'][string-length()>60]|//div[@class='Padding10 BorderCCCDot F14 Contnet']")
...
if __name__ == "__main__":
    work(conp=["postgres", "since2015", "192.168.4.199", "henan", "henan_ruzhou_ggzy"],num=15)