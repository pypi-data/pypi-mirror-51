...
def f1(driver, num):
    ...
    for content in content_list:
        ...
        url = 'http://bgpc.beijing.gov.cn' + content.xpath("./a/@href")[0].strip()
...
data = [
    ["qsy_yucai_gg",
     "http://bgpc.beijing.gov.cn/news/tid/1?page=1",
     ["name", "ggstart_time", "href", "info"], f1, f2],

    ["qsy_zhaobiao_gg",
     "http://bgpc.beijing.gov.cn/news/tid/2?page=1",
     ["name", "ggstart_time", "href", "info"], f1, f2],

    ["qsy_zhaobiao_fzb_gg",
     "http://bgpc.beijing.gov.cn/news/tid/3?page=1",
     ["name", "ggstart_time", "href", "info"], add_info(f1,{"tag":"非招标"}), f2],
    ["qsy_biangeng_gg",
     "http://bgpc.beijing.gov.cn/news/tid/4?page=1",
     ["name", "ggstart_time", "href", "info"], f1, f2],

    ["qsy_zhongbiao_gg",
     "http://bgpc.beijing.gov.cn/news/tid/5?page=1",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["qsy_liubiao_gg",
     "http://bgpc.beijing.gov.cn/news/tid/6?page=1",
     ["name", "ggstart_time", "href", "info"], f1, f2],
...
if __name__ == "__main__":
    ...
    work(conp,num=1,headless=False,ipNum=0,image_show_gg=2)
