...
def get_quyu_dict_diqu():
    ...
    dir_delete_list = ['zlshenpi', 'zljianzhu', 'zlcommon','zlsys', 'lib', 'util','_tesuwenjian']
...
def get_quyu_dict_zljianzhu():
    ...
    flag1_list=[0, 4, 8, 12, 16, 20, 24, 28]
    flag2_list=[4, 8, 12, 16, 20, 24, 28,31]
    for k1,k2 in zip(flag1_list,flag2_list):
        quyu="zljianzhu_gg_%s_%s"%(k1,k2)
        fileList.append(quyu)
