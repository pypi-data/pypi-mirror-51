...
data = [
    ...
    ["gcjs_zhongbiao_gg",
     ...
     ["name", "ggstart_time", "href", "info"], before(f1, "建设工程", "结果公示"), before(f2, "建设工程", "结果公示")],

    ["gcjs_liubiao_gg",
     "http://ggzy.tongliao.gov.cn/tlsggzy/jsgc/subpage.html",
     ["name", "ggstart_time", "href", "info"], before(f1, "建设工程", "招标异常公告"), before(f2, "建设工程", "招标异常公告")],

    ["zfcg_liubiao_gg",
     "http://ggzy.tongliao.gov.cn/tlsggzy/jsgc/subpage.html",
     ["name", "ggstart_time", "href", "info"], before(f1, "政府采购", "废标（终止）公告"), before(f2, "政府采购", "废标（终止）公告")],
...
if __name__ == "__main__":
    work(conp=["postgres", "since2015", "192.168.3.171", "neimenggu", "tongliao"], ipNum=0, headless=False)
