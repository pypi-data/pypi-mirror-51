...
def f2(driver):
    if "本栏目暂时没有内容" in str(driver.page_source):
        return 0
...
data = [
    ###增加公告
    ["gcjs_gqita_bian_bu_jtgc_gg",
     "http://ggzy.xam.gov.cn/xamggzy/jyxx/004001/004001002/004001002005/",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {"tag": "交通工程"}), f2],

    ["gcjs_gqita_bian_bu_slgc_gg",
     "http://ggzy.xam.gov.cn/xamggzy/jyxx/004001/004001003/004001003005/",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {"tag": "水利工程"}), f2],

    ["gcjs_gqita_bian_bu_qtgc_gg",
     "http://ggzy.xam.gov.cn/xamggzy/jyxx/004001/004001004/004001004005/",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {"tag": "其他工程"}), f2],

    ["gcjs_gqita_bian_bu_dlgc_gg",
     "http://ggzy.xam.gov.cn/xamggzy/jyxx/004001/004001005/004001005005/",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {"tag": "电力工程"}), f2],

    ["gcjs_gqita_bian_da_dlgc_gg",
     "http://ggzy.xam.gov.cn/xamggzy/jyxx/004001/004001005/004001005003/",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {"tag": "电力工程"}), f2],

    ["gcjs_zhaobiao_dlgc_gg",
     "http://ggzy.xam.gov.cn/xamggzy/jyxx/004001/004001005/004001005001/",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {"tag": "电力工程"}), f2],

    ["gcjs_zhongbiao_dlgc_gg",
     "http://ggzy.xam.gov.cn/xamggzy/jyxx/004001/004001005/004001005007/",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {"tag": "电力工程"}), f2],

    ["gcjs_biangeng_dlgc_gg",
     "http://ggzy.xam.gov.cn/xamggzy/jyxx/004001/004001005/004001005002/",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {"tag": "电力工程"}), f2],

    ["gcjs_zhongbiaohx_dlgc_gg",
     "http://ggzy.xam.gov.cn/xamggzy/jyxx/004001/004001005/004001005004/",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {"tag": "电力工程"}), f2],

    ["gcjs_liubiao_dlgc_gg",
     "http://ggzy.xam.gov.cn/xamggzy/jyxx/004001/004001005/004001005006/",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {"tag": "电力工程"}), f2],

    ["zfcg_gqita_bian_bu_gg",
     "http://ggzy.xam.gov.cn/xamggzy/jyxx/004002/004002005/",
