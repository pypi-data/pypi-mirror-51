...
data = [
    ###gcjs_liubiao_gg修改表名为gcjs_gqita_bian_da_gg
    ["gcjs_gqita_bian_da_gg", "http://www.jnggzyjy.gov.cn/QuFu/Bulletins?CategoryCode=517001",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ####增加公告
    ["jqita_zhaobiao_ddcg_gg", "http://www.jnggzyjy.gov.cn/QuFu/Bulletins?CategoryCode=55100105",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {'cgfs':'定点采购'}), f2],

    ["jqita_zhaobiao_ddcg_old_gg", "http://www.jnggzyjy.gov.cn/QuFu/Bulletins?CategoryCode=00200102",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {'cgfs': '定点采购'}), f2],

    ["jqita_zhongbiao_ddcg_gg", "http://www.jnggzyjy.gov.cn/QuFu/Bulletins?CategoryCode=55300105",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {'cgfs': '定点采购'}), f2],

    ["jqita_zhongbiao_ddcg_old_gg", "http://www.jnggzyjy.gov.cn/QuFu/Bulletins?CategoryCode=002002",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {'cgfs': '定点采购'}), f2],
