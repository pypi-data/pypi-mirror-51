...
def f2(driver):
    if '本栏目暂时没有内容' in str(driver.page_source) or '本栏目信息正在更新中' in str(driver.page_source):
        return 0
...
data = [
    ...
    ["zfcg_liubiao_gc_gg",
     "http://ggzy.chifeng.gov.cn/EpointWeb_CF/jyxx_cf/003002/003002005/003002005001/?Paging=1",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {"type": "工程"}), f2],
    ["zfcg_liubiao_hw_gg",
     "http://ggzy.chifeng.gov.cn/EpointWeb_CF/jyxx_cf/003002/003002005/003002005002/?Paging=1",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {"type": "货物"}), f2],
    ["zfcg_liubiao_fw_gg",
     "http://ggzy.chifeng.gov.cn/EpointWeb_CF/jyxx_cf/003002/003002005/003002005003/?Paging=1",
