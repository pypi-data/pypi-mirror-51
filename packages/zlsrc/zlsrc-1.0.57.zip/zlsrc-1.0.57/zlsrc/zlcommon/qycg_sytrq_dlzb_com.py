...
data = [
    ...
    ["qycg_gqita_zhao_zhong_gongcheng_gg", "https://sytrq.dlzb.com/gongcheng/page-2.shtml",["name", "ggstart_time", "href", "info"], add_info(f1,{"gclx":"工程"}), f2],
    ["qycg_gqita_zhao_zhong_huowu_gg", "https://sytrq.dlzb.com/huowu/page-2.shtml",["name", "ggstart_time", "href", "info"], add_info(f1,{"gclx":"货物"}), f2],
    ["qycg_gqita_zhao_zhong_fuwu_gg", "https://sytrq.dlzb.com/fuwu/page-2.shtml",["name", "ggstart_time", "href", "info"],add_info(f1,{"gclx":"服务"}), f2],
