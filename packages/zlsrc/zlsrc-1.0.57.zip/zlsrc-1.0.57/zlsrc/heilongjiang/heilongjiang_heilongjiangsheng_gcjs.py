...
def f3(driver, url):
    driver.get(url)
    locator = (By.XPATH, "//div[@class='cArea'][string-length()>100]")
...
data = [
    ...
    ["gcjs_gqita_gg",
     "http://ztb.hljjs.gov.cn/list_bidyw2.aspx?CategoryID=7&page=1",
     ["name", "ggstart_time", "href",  "info"], add_info(f1,{"type":"中标通知书"}), f2],
