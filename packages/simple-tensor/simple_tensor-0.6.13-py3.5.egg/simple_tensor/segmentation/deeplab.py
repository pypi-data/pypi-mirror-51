        ...
        while True:
            ...
            for i in range(batch_size):
                ...
                try:
                    ...
                    print (self.dataset_folder_path + self.dataset_file_list[idx])
                    ...
                    print (self.label_folder_path + self.dataset_file_list[idx])
                    ...
                    print ('fail ' +  self.dataset_file_list[idx], e, "--")
