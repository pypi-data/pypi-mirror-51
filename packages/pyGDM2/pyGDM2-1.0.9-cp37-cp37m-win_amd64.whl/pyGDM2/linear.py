...
# =============================================================================
    ...
    H0 = -1*sim.efield.field_generator(dummy_s, returnField='H', **field_params)
...
# =============================================================================
    ...
    HDXcj = -1*np.conjugate(sim.efield.field_generator(DX, returnField='H', **field_params))
    HDYcj = -1*np.conjugate(sim.efield.field_generator(DY, returnField='H', **field_params))
    HDZcj = -1*np.conjugate(sim.efield.field_generator(DZ, returnField='H', **field_params))
