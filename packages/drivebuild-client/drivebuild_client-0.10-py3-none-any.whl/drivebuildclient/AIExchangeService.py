...
from drivebuildclient.aiExchangeMessages_pb2 import VehicleID, SimulationID, SimulationIDs, TestResult, SubmissionResult, User
...
class AIExchangeService:
    from drivebuildclient.aiExchangeMessages_pb2 import SimStateResponse, DataRequest, DataResponse, Control, Void
