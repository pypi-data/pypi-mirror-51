...
class BTDocumentInfoAllOf(object):
    ...
    def __init__(self, document_thumbnail_element_id=None, beta_capability_ids=None, duplicate_name_violation_error=None, is_upgraded_to_latest_version=None):  # noqa: E501
