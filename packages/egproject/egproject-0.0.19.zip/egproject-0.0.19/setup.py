...
modules_req=['xlsxwriter', 'numpy','openpyxl','PIL','delny']
for mm in modules_req:
	try: import mm
	except:
		print("Please install the moudle named :" ,mm)

install_requires = [ 'xlsxwriter', 'numpy','openpyxl','PIL','delny']
