...
class SessionInfo:
    ...
    def getOpenTime(self, bOffset = False):
    ...
    def getCloseTime(self, bOffset = False):
        if len(self.sections) == 0:
            return 0
    ...
    def isLastOfSection(self, rawTime):
    ...
    def isFirstOfSection(self, rawTime):
        offTime = self.offsetTime(rawTime)
    ...
    def timeToMinutes(self, rawTime):
        if len(self.sections) == 0:
            return -1
    ...
    def minutesToTime(self, minutes, bHeadFirst = False):
        if len(self.sections) == 0:
            return -1
