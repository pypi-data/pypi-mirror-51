...
from PyQt5.QtWidgets import QApplication, QGridLayout, QWidget, QPushButton, QVBoxLayout, QStyle, QStyleFactory
import time
import datetime
...
#        window_geometry = self.win.geometry()
        ...
        grid.addWidget(QPushButton('Top'),0,0)
        grid.addWidget(QPushButton('Bottom'),1,1)
        ...
        self.setWindowTitle("Oscilloscope ('s': save new file, 'space': autosave, 'p': pause, 'a': always top)")
