...
class SchoolManager(models.Manager):
    ...
    def new_school_account(self, school_name, authority, school_type, subscription_length):

        new_school_account = self.model(
            school_name=school_name,
            authority=authority,
            school_type=school_type,
            account_expiry=expiry_plus_n_days(subscription_length),
        )
...
class School(models.Model):
    ...
    account_expiry = models.DateField(default=expiry_plus_one_year, blank=True)
