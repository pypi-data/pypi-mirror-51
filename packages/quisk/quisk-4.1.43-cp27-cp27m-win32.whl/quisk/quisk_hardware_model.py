...
class Hardware:
  ...
  def StartSamples(self):	# Quisk calls this from the sound thread to start sending samples
    ...
    pass
  def GetRxSamples(self):	# Quisk calls this from the sound thread to return the Rx samples. 
    # "samples" must be a byte array or string; use s = bytearray(2), or s = "\x55\x44" or similar.
    # "samples" is rx_bytes of integer I data followed by rx_bytes of integer Q data, repeated.
    # You can return None to indicate that no samples are available.
    return None
