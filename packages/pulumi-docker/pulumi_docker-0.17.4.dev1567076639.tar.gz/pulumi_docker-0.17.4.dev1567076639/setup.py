...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v0.17.4-dev.1567076639+g60beabd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v0.17.4-dev.1567076639+g60beabd`
                """)
            else:
                raise
