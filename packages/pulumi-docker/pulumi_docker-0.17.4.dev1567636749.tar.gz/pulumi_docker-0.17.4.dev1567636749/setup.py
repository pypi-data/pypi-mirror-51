...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v0.17.4-dev.1567636749+g772ea8b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v0.17.4-dev.1567636749+g772ea8b`
                """)
            else:
                raise
