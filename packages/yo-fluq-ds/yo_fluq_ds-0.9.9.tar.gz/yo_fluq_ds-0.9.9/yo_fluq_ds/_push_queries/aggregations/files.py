...
class ToTextFile(yo_fluq.agg.CommonPQE):
...
class ToZipTextFile(yo_fluq.agg.CommonPQE):
...
class ToPickleFile(yo_fluq.agg.CommonPQE):
...
class ToZipFolder(yo_fluq.agg.CommonPQE):
