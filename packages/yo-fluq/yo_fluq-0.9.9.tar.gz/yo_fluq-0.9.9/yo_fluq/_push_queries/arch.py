...
class PushQueryElementInstance:
...
class _ArithmeticPQEI(PushQueryElementInstance):
    def __init__(self,
                 enter_lambda,
                 process_lambda,
                 report_lambda,
...
class ArithmeticPQE(PushQueryElement):
    def __init__(self,
                 enter_lambda,
                 process_lambda,
                 report_lambda,
...
class _CommonPQEI(PushQueryElementInstance):
...
class CommonPQE(PushQueryElement):
    def instance(self):
        return _CommonPQEI(
            self.on_enter,
            self.on_process,
