...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.0.1-alpha.1567594240+gf08c61de'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.0.1-alpha.1567594240+gf08c61de`
                """)
            else:
                raise
