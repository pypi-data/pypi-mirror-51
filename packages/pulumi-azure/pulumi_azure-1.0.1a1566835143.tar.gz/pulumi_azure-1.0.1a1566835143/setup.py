...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.0.1-alpha.1566835143+g552cbe68'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.0.1-alpha.1566835143+g552cbe68`
                """)
            else:
                raise
