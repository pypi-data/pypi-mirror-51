...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.0.1-alpha.1566484767+g6c4cb569'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.0.1-alpha.1566484767+g6c4cb569`
                """)
            else:
                raise
