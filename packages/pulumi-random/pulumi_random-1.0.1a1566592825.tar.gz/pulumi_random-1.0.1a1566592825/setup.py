...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', 'v1.0.1-alpha.1566592825+g0ced240'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random v1.0.1-alpha.1566592825+g0ced240`
                """)
            else:
                raise
