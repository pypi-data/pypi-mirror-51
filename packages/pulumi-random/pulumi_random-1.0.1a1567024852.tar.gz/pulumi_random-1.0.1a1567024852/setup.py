...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', 'v1.0.1-alpha.1567024852+g5f4f0cb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random v1.0.1-alpha.1567024852+g5f4f0cb`
                """)
            else:
                raise
