...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', 'v1.0.1-alpha.1566600005+geb53e8d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random v1.0.1-alpha.1566600005+geb53e8d`
                """)
            else:
                raise
