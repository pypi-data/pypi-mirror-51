...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', 'v1.0.1-alpha.1566847128+g6d48dba'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random v1.0.1-alpha.1566847128+g6d48dba`
                """)
            else:
                raise
