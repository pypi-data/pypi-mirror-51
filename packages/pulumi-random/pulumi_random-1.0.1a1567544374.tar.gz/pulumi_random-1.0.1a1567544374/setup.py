...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', 'v1.0.1-alpha.1567544374+g1d253fa'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random v1.0.1-alpha.1567544374+g1d253fa`
                """)
            else:
                raise
