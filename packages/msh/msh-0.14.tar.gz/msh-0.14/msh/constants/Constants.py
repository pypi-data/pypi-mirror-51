...
SSHList_db_create_sql = ''' CREATE TABLE SSHList (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL,passwd TEXT,host CHAR(50) NOT NULL,timestamp INTEGER NOT NULL);'''
