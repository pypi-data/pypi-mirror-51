...
class Topic_Server():
    ...
    def callback(self,ch, method, properties, body):
        ...
        if method.routing_key in self.integration_service:
            integration_service_instance = self.integration_service[method.routing_key]

        response = integration_service_instance.do(data)
