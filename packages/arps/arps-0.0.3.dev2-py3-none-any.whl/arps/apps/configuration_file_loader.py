...
from arps.core.environment import register_policy
...
def _load_agent_environment(identifier,
    ...
    for policy in policies:
        ...
        register_policy(identifier, policy_cls.__name__, policy_cls)

    for sensor in sensors:
        monitor_sensor_policy_cls = build_monitor_policy_class('{}MonitorPolicy'.format(sensor), sensor=sensor)
        register_policy(identifier, monitor_sensor_policy_cls.__name__, monitor_sensor_policy_cls)

    for actuator in actuators:
        monitor_actuator_policy_cls = build_monitor_policy_class('{}MonitorPolicy'.format(actuator), actuator=actuator)
        register_policy(identifier, monitor_actuator_policy_cls.__name__, monitor_actuator_policy_cls)
    ...
    return Environment(sensors=sensors, actuators=actuators)
