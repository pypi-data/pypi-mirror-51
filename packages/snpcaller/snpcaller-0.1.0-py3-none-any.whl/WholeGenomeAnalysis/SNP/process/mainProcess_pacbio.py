...
sampleID = experimentData['ClientSampleID']
                            ...
                            if (matchStart < chromStart < matchEnd and matchStart < chromEnd < matchEnd):
                                ...
                                if (snip['name'] in snip_dic):
                                    ...
                                    if (rawbases in dicSnipDetail):
                                        ...
                                        getSnip.rawReads = getSnip.rawReads + snps.rawReads
                                        getSnip.minBaseOcurrances = getSnip.minBaseOcurrances + snps.minBaseOcurrances
                                ...
                                if (snip['name'] in snip_totalReads):
                                    snip_totalReads[snip['name']] = snip_totalReads[snip['name']] + int(rawReads)
                                else:
...
final_snp_list = callsnip.filterSnipObject(snip_dic, snip_totalReads)
