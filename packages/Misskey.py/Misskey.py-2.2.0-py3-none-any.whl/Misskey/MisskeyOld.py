...
class MisskeyOld:
    """
    MISSKEY API MAIN LIBRARY
    """
    def __init__(self, instanceAddress='https://misskey.xyz', appSecret=None, accessToken=None, apiToken=None):
        """
        Initialize the library.

        :param instanceAddress: Instance address of Misskey. If leave a blank, library will used 'misskey.xyz'.
        :type instanceAddress: str, optional
        :param appSecret: Secret application for using instance. If you use this parameter, will must insert 'accessToken'.
        :type appSecret: str, optional
        :param accessToken: Access token for using instance. If you use this parameter, will must insert 'appSecret'.
        :type accessToken: str, optional
        :param apiToken: Assign hashed 'appSecret' and 'accessToken'. Or enter the key displayed on the web application.
        :type apiToken: str, optional
        """
        ...
        if self.apiToken != None:
            ...
            elif 'isModerator' in self.credentials:
                self.i_isAdmin = self.credentials['isModerator']
