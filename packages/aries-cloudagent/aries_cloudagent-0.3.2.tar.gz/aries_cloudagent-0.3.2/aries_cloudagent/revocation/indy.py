...
class IndyRevocation:
    ...
    async def get_issuer_revocation_record(
        ...
        """
        # filter issuing registries by cred def, state (active or full), and pick one
...
class IssuerRevocationRecord(BaseRecord):
    ...
    async def get_registry(self) -> RevocationRegistry:
        ...
        return RevocationRegistry(
            ...
            max_creds=self.max_creds,
            reg_def_type=self.reg_def_type,
            tag=self.tag,
    ...
    async def retrieve_by_cred_def_id(
        ...
        """Retrieve a revocation record by issuer DID.
