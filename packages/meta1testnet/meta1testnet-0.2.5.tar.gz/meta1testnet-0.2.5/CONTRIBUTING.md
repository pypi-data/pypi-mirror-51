...
You are here to help Meta1 and the python-meta1testnet library?
...
tracker][https://github.com/meta1testnet/python-meta1testnet/issues] to see if
someone else in the community has already created a ticket. If not, go
ahead and [make one][https://github.com/meta1testnet/python-meta1testnet/issues/new]!
...
* **Ensure the bug was not already reported** by [searching all issues][https://github.com/meta1testnet/python-meta1testnet/issues].

* If you're unable to find an open issue addressing the problem,
  [open a new one][https://github.com/meta1testnet/python-meta1testnet/issues/new]. Be sure
...
[Codeclimate](https://codeclimate.com/github/meta1testnet/python-meta1testnet)
will give you feedback in this regard. You can check & fix codeclimate's
feedback by running it locally using [Codeclimate's CLI](https://codeclimate.com/github/meta1testnet/python-meta1testnet), via
`codeclimate analyze`.
...
sure it's up to date with python-meta1testnet's `develop` branch:

    git remote add upstream git@github.com:meta1testnet/python-meta1testnet.git
