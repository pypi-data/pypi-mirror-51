...
* `meta1testnet.storage` now comes with the prebuilt inRam and SQLite stores from pygraphene
...
* Instead of using
  ...
  ```
  from meta1testnet.storage import configStorage as config
  ```
  ...
  ```
  from meta1testnet.storage import get_default_config_store
...
* bd69b2c Fix meta1testnet->blockchain attrribute #132
* a19b9ed Fix #136
