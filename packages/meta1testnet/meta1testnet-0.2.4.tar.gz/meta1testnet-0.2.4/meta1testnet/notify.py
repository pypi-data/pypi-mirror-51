...
class Notify(Events, BlockchainInstance):
    """ Notifications on Blockchain events.
        ...
        :param list markets: Instances of :class:`meta1testnet.market.Market` that identify markets to be monitored
        ...
        **Example**
        ...
        .. code-block:: python
            ...
            from meta1testnet.notify import Notify
            from meta1testnet.market import Market
    ...
    def process_market(self, data):
        """ This method is used for post processing of market
            ...
            * :class:`meta1testnet.price.Order` or
            * :class:`meta1testnet.price.FilledOrder` or
            * :class:`meta1testnet.price.UpdateCallOrder`
    ...
    def process_account(self, message):
        """ This is used for processing of account Updates. It will
            return instances of :class:meta1testnet.account.AccountUpdate`
        """
