...
class Price(GraphenePrice):
    """ This class deals with all sorts of prices of any pair of assets to
        ...
        each being an instance of :class:`meta1testnet.amount.Amount`. The
        ...
        Way to obtain a proper instance:
            ...
            * ``args`` can be a floating number and ``base`` and ``quote`` being instances of :class:`meta1testnet.asset.Asset`
            ...
            * ``args`` being a list of ``[quote, base]`` both being instances of :class:`meta1testnet.amount.Amount`
            * ``args`` being a list of ``[quote, base]`` both being instances of ``str`` (``amount symbol``)
            * ``base`` and ``quote`` being instances of :class:`meta1testnet.asset.Amount`
        ...
        * ``Price(1.0, "USD/GOLD")``
        ...
        .. code-block:: python
            ...
            >>> from meta1testnet.price import Price
    ...
    def market(self):
        """ Open the corresponding market
            ...
            :returns: Instance of :class:`meta1testnet.market.Market` for the
...
class Order(Price):
    """ This class inherits :class:`meta1testnet.price.Price` but has the ``base``
