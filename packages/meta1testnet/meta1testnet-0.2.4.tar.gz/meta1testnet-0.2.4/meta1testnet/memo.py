...
class Memo(GrapheneMemo):
    """ Deals with Memos that are attached to a transfer
        ...
        :param meta1testnet.account.Account from_account: Account that has sent
            the memo
        :param meta1testnet.account.Account to_account: Account that has received
            the memo
        ...
        .. code-block:: python
            ...
            from meta1testnet.memo import Memo
