...
class Market(dict):
    """ This class allows to easily access Markets on the blockchain for trading, etc.
        ...
        :param meta1testnet.meta1testnet.Meta1 blockchain_instance: Meta1 instance
        :param meta1testnet.asset.Asset base: Base asset
        :param meta1testnet.asset.Asset quote: Quote asset
        ...
        * ``base`` and ``quote`` are valid assets (according to :class:`meta1testnet.asset.Asset`)
        ...
        * ``base-quote`` separated with ``-``
        ...
        .. note:: Throughout this library, the ``quote`` symbol will be
                  ...
                  :func:`meta1testnet.market.Market.sell` or
                  :func:`meta1testnet.market.Market.buy`, you will sell/buy **only
    ...
    def orderbook(self, limit=25):
        """ Returns the order book for a given market. You may also
            ...
            .. note:: Each bid is an instance of
                class:`meta1testnet.price.Order` and thus carries the keys
    ...
    def accountopenorders(self, account=None):
        """ Returns open Orders
            ...
            :param meta1testnet.account.Account account: Account name or instance of Account to show orders for in this market
        """
        if not account:
            if "default_account" in self.blockchain.config:
                account = self.blockchain.config["default_account"]
