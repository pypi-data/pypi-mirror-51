import numpy as np
from deepcinac.utils import horizontal_flip, vertical_flip, v_h_flip, shift_movie, rotate_movie
from deepcinac.utils import get_source_profile_param
import time
        ...
        for index_batch, movie_data in enumerate(movie_data_list):
            ...
            if src_profile_key in source_profiles_dict:
                ...
                mask_source_profile, coords = \
                    get_source_profile_param(cell=cell, movie_dimensions=movie_dimensions,
                                             coord_obj=coord_obj,
            ...
            source_profile_frames = cinac_recording.get_source_profile_frames(frames=frames, coords=coords)
            # if i == 0:
...
class MoviePatchGeneratorMaskedVersions(MoviePatchGenerator):
    ...
    def generate_movies_from_metadata(self, movie_data_list, memory_dict=None, with_labels=True):
        ...
        for index_batch, movie_data in enumerate(movie_data_list):
            ...
            # TODO: see to improve the efficiency
