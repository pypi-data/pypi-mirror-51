...
setup(
    ...
    install_requires=["mo-collections>=2.31.19025","mo-dots>=2.53.19239","mo-files>=2.31.19025","mo-future>=2.48.19205","mo-json>=2.53.19239","mo-json-config>=2.34.19026","mo-kwargs>=2.53.19239","mo-logs>=2.53.19239","mo-math>=2.40.19027","mo-threads>=2.53.19239","mo-times>=2.53.19239"],
