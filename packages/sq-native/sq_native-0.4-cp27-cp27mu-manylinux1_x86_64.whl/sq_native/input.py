...
def get_input_lib():
    ...
    if _input_lib is None:
        ...
        lib.powerwaf_addToPWInputArray.argtypes = [
                POINTER(C_PWInput), C_PWInput]
...
def append_to_array(array, value):
    return get_input_lib().powerwaf_addToPWInputArray(byref(array), value)
...
def append_to_map(array, key, value):
    ...
    return get_input_lib().powerwaf_addToPWInputMap(byref(array), key, value)
