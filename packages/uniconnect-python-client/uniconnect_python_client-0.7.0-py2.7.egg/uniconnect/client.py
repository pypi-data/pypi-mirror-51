...
__all__ = ["uniconnectQuery", "uniconnectRequest"]
...
class uniconnectRequest(object):
    ...
    def process(self, http_response):
        # type: (requests.Response) -> uniconnectStatus
...
class uniconnectQuery(object):
    ...
    def __init__(
        self,
        request,  # type: uniconnectRequest
        sql,  # type: Text
    ):
        # type: (...) -> None
