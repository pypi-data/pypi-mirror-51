...
with open("uniconnect/__init__.py", "rb") as f:
    version = str(
...
setup(
    name="uniconnect-python-client",
    author="uniconnect Team",
    author_email="uniconnect-users@googlegroups.com",
    version=version,
    packages=["uniconnect"],
    package_data={"": ["LICENSE", "README.md"]},
    description="Client for the uniconnect distributed SQL Engine",
    long_description=textwrap.dedent(
        """
    Client for uniconnect (https://uniconnect.io), a distributed SQL engine for
