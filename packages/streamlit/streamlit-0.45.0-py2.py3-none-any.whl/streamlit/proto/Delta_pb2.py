...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1bstreamlit/proto/Delta.proto\x1a\x1fstreamlit/proto/BlockPath.proto\x1a\x1dstreamlit/proto/Element.proto\x1a\"streamlit/proto/NamedDataSet.proto\"\x96\x01\n\x05\x44\x65lta\x12\n\n\x02id\x18\x01 \x01(\r\x12 \n\x0cparent_block\x18\x02 \x01(\x0b\x32\n.BlockPath\x12\x1f\n\x0bnew_element\x18\x03 \x01(\x0b\x32\x08.ElementH\x00\x12\x13\n\tnew_block\x18\x04 \x01(\x08H\x00\x12!\n\x08\x61\x64\x64_rows\x18\x05 \x01(\x0b\x32\r.NamedDataSetH\x00\x42\x06\n\x04typeb\x06proto3')
  ,
  dependencies=[streamlit_dot_proto_dot_BlockPath__pb2.DESCRIPTOR,streamlit_dot_proto_dot_Element__pb2.DESCRIPTOR,streamlit_dot_proto_dot_NamedDataSet__pb2.DESCRIPTOR,])
...
_DELTA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='parent_block', full_name='Delta.parent_block', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='new_element', full_name='Delta.new_element', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='new_block', full_name='Delta.new_block', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='add_rows', full_name='Delta.add_rows', index=4,
...
_DELTA.fields_by_name['parent_block'].message_type = streamlit_dot_proto_dot_BlockPath__pb2._BLOCKPATH
