...
def update_rando_group_permissions():
    ...
    add_permissions_to_group_by_model(group, "edc_randomization.randomizationlist")
    make_view_only_model(group, "edc_randomization.randomizationlist")

    add_permissions_to_group_by_codenames(
        group, codenames=["edc_randomization.display_randomization"]
    )
