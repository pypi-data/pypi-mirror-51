...
class Contract(object):
    ...
    def check_receipts(self, txid):
        ...
        try:
            ...
            # receipt = self._w3.eth.waitForTransactionReceipt(txid, timeout=3)
        except Exception as e:
            print("getTransactionReceipt error:",e)
            receipt = None
        return receipt
    ...
    def send_eth(self, sender_private_key, receiver_address, eth):
        ...
        web3 = self._w3
        # 测试
        # addr = keys.privatekey_to_address(sender_private_key)
        # print("11111111111111 ", web3.eth.getBalance(addr))
        # eth = 200*10**18
