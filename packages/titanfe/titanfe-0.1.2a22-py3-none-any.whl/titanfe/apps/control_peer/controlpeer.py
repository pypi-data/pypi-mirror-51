...
from titanfe.apps.control_peer.flow import parse_flows
from titanfe.apps.control_peer.runner import BrickRunner
...
class ControlPeer:
    ...
    async def trigger_inlet(runner):
        ...
        await connection.send(Packet("TRIGGER INLET").to_dict())
