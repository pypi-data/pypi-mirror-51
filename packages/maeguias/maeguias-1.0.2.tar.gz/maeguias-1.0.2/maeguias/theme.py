...
from maeguias.utils import filters
from maeguias.config.base import ValidationError
...
class Theme(object):
    ...
    def __init__(self, name=None, **user_config):
        ...
        # MaeGuias provided static templates are always included
        package_dir = os.path.abspath(os.path.dirname(__file__))
        maeguias_templates = os.path.join(package_dir, 'templates')
        self.static_templates = set(os.listdir(maeguias_templates))
        ...
        # Include templates provided directly by MaeGuias (outside any theme)
        self.dirs.append(maeguias_templates)
    ...
    def _load_theme_config(self, name):
        ...
        try:
            file_path = os.path.join(theme_dir, 'maeguias_theme.yml')
