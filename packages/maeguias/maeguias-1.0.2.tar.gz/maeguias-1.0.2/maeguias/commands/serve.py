...
from maeguias.commands.build import build
from maeguias.config import load_config
...
def serve(config_file=None, dev_addr=None, strict=None, theme=None,
    ...
    """
    Start the MaeGuias development server
    ...
    # string is returned. And it makes MaeGuias temp dirs easier to identify.
    site_dir = tempfile.mkdtemp(prefix='maeguias_')
