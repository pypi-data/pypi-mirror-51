...
from maeguias import utils, exceptions
from maeguias.structure.files import File
from maeguias.structure.pages import Page
from maeguias.tests.base import dedent, load_config
...
class UtilsTests(unittest.TestCase):
    ...
    def test_get_theme_dir(self, mock_iter):
        ...
        theme = mock.Mock()
        theme.name = 'maeguias2'
        theme.dist.key = 'maeguias2'
    ...
    def test_get_themes_warning(self, mock_iter):
        ...
        theme1 = mock.Mock()
        theme1.name = 'maeguias2'
        theme1.dist.key = 'maeguias2'
        theme1.load().__file__ = "some/path1"

        theme2 = mock.Mock()
        theme2.name = 'maeguias2'
        theme2.dist.key = 'maeguias3'
    ...
    def test_get_themes_error(self, mock_get, mock_iter):
        ...
        theme1 = mock.Mock()
        theme1.name = 'maeguias'
        theme1.dist.key = 'maeguias'
        theme1.load().__file__ = "some/path1"

        theme2 = mock.Mock()
        theme2.name = 'maeguias'
        theme2.dist.key = 'maeguias2'
        theme2.load().__file__ = "some/path2"

        mock_iter.return_value = iter([theme1, theme2])
        mock_get.return_value = {'maeguias': theme1, }
