...
DEFAULT_SCHEMA = (
    ...
    # Reserved for internal use, stores the maeguias.yml config file.
    ...
    # The MaeGuias theme for the documentation.
    ('theme', config_options.Theme(default='maeguias')),
    ...
    # this should look like, ['UA-27795084-5', 'maeguias.org']
    ...
    # enabling strict mode causes MaeGuias to stop the build when a problem is
    ...
    # MaeGuias itself. A good example here would be including the current
    # project version.
