...
def send_to_elasticsearch(metrics_str):
  ...
  for row in reader:
    ...
    json_data['index'] = int(json_data['index'])
    json_data['fanspeed'] = int(json_data['fanspeed'])
    json_data['temperaturegpu'] = int(json_data['temperaturegpu'])
    json_data['memoryused'] = int(json_data['memoryused'])
