...
class search():
    def anime(searchnumber):
        return f'http://neko-bot.net/anime/anime{int(searchnumber)}.png'
    def neko(searchnumber):
        return f'http://neko-bot.net/nekos/neko{int(searchnumber)}.png'
