...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.0.1-alpha.1567558087+g9241c1c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.0.1-alpha.1567558087+g9241c1c`
                """)
            else:
                raise
