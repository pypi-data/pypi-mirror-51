...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.0.1-alpha.1567540962+g9ef8d33'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.0.1-alpha.1567540962+g9ef8d33`
                """)
            else:
                raise
