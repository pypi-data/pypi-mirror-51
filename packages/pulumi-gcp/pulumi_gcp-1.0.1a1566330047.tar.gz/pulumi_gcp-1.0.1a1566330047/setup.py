...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.0.1-alpha.1566330047+gf0ee4d1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.0.1-alpha.1566330047+gf0ee4d1`
                """)
            else:
                raise
