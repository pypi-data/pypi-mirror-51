...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.0.1-alpha.1566854264+gfce32eb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.0.1-alpha.1566854264+gfce32eb`
                """)
            else:
                raise
