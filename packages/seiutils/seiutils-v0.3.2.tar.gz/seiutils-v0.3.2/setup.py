...
setup(
  ...
  version = 'v0.3.2',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/ahuei123456/Seiyuu-Utils/archive/v0.3.2.tar.gz',    # I explain this later on
