...
setup(
  ...
  version = 'v0.3.1',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/ahuei123456/Seiyuu-Utils/archive/v0.3.1.tar.gz',    # I explain this later on
