...
- line_points (list; optional): The coordinates of the last edited polyline
- polygon_points (list; optional): The coordinates of the last edited closed polygon
- marker_point (list; optional): The coordinates of the last edited marker
...
- hillShading (boolean; default True)"""
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, center=Component.UNDEFINED, map_bounds=Component.UNDEFINED, line_points=Component.UNDEFINED, polygon_points=Component.UNDEFINED, marker_point=Component.UNDEFINED, layers=Component.UNDEFINED, hillShading=Component.UNDEFINED, height=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'center', 'map_bounds', 'line_points', 'polygon_points', 'marker_point', 'layers', 'hillShading']
        self._type = 'LayeredMap'
        self._namespace = 'webviz_subsurface_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'center', 'map_bounds', 'line_points', 'polygon_points', 'marker_point', 'layers', 'hillShading']
