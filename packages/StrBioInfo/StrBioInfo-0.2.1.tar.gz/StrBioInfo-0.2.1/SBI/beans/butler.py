...
The {Singleton} object ensures that only one instance of a given object
is created. This is required as only one {Buttler} can go on around the
library consistently.

The {Buttler} class will create an instance that will move around the
