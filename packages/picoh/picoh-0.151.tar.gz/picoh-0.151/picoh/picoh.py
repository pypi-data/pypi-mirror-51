...
def _sayLinux(text, untilDone=True, lipSync=True, hdmiAudio=False, soundDelay=0):
    ...
    if "festival" in synthesizer.lower():
        ...
        bashcommand = "festival -b '(set! mytext (Utterance Text " + '"' + safetext + '"))' + "' '(utt.synth mytext)' '(utt.save.wave mytext " + fileString + ")' '(utt.save.segs mytext " + '"phonemes"' + ")'"
        ...
        phonemeFile = os.path.join(dir, 'phonemes')
