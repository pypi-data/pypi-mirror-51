...
#    print(_dump_ltline_index(ltline_index))
    ...
    for key, ltchar_index in reversed(sorted(ltline_index.items())):
        ...
        if latest is not None:
            ...
            # else:
            #     print('no regroup', 'allowed', allowed_diff, 'diff', diff, 'allowed y diff', allowed_y_diff, 'y diff', latest_y - y, diff < allowed_diff, (latest_y - y) < diff)
            #     print('   ', _dump_ltchar_index(ltchar_index))
            #     print('   ', _dump_ltchar_index(latest_ltchar_index))
