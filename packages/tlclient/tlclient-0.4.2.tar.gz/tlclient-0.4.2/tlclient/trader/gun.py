...
'''.format(FIST_TYPES)
    ...
    def _run_process(self, fist_type, args):
        ...
        if fist_type in ['tg', 'mg']:
            ...
            try:
                GunRecorder(args.fist_name, router_names, args.dir).run()
            except:
                print(traceback.format_exc())
                print(FIST_FAIL_MARK)
    ...
    def db(self):
        ...
        parser.add_argument('action', choices=['create', 'init', 'drop'], help='actions to take')
        parser.add_argument('--db', default='db_exchange', help='db to operate on')
        args = parser.parse_args(sys.argv[2:])
    ...
    def encrypt(self):
        ...
        parser.add_argument('-k', '--key_name', required=True, help='specify the key to use in encryption')
    ...
    def decrypt(self):
        ...
        parser = argparse.ArgumentParser()
        parser.add_argument('-k', '--key_name', required=True, help='specify the key to use in decryption')
