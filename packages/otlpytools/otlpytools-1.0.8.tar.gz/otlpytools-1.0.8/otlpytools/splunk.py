...
class Splunk:
    ...
    def create_json_for_uploading(self, index, sourcetype, event_json):
        ...
        with open("../samples/sample.json", "w+") as jd:
            json.dump(payload, jd)
...
class http_event_collector:
    ...
    def __init__(self, http_event_server="", token="", input_type='json', host="", http_event_port='8088', http_event_server_ssl=True):
        self.token = token
        self.debug = False
