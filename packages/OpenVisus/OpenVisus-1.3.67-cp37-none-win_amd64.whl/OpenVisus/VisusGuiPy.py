...
class GLMesh(object):
    ...
    def vertex(self, x, y, z=0):
        return _VisusGuiPy.GLMesh_vertex(self, x, y, z)

    def normal(self, x, y, z):
        return _VisusGuiPy.GLMesh_normal(self, x, y, z)

    def color(self, *args):
        return _VisusGuiPy.GLMesh_color(self, *args)

    def texcoord2(self, x, y):
        return _VisusGuiPy.GLMesh_texcoord2(self, x, y)

    def texcoord3(self, x, y, z):
        return _VisusGuiPy.GLMesh_texcoord3(self, x, y, z)
