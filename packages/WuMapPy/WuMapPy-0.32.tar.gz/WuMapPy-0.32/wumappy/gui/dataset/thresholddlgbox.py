# -*- coding: utf-8 -*-
'''
    wumappy.gui.dataset.thresholddlgbox
    -----------------------------------

    Thresholding dialog box management.
...
#---------------------------------------------------------------------------#
# Thresholding Dialog Box Object                                            #
#---------------------------------------------------------------------------#
class ThresholdDlgBox:
...
#        self.histofig = self.dataset.histo_plot(fig=self.histofig, zmin=self.zmin, zmax=self.zmax)
    ...
    def CartoImageUpdate(self):
        ...
        if any([self.minmaxreplacedflag, self.medianreplacedflag, self.nanreplacedflag]):
            self.dataset.threshold(self.zmin, self.zmax, self.medianreplacedflag, self.nanreplacedflag)
        # No replacement
        else:
            self.dataset.threshold(None, None, self.medianreplacedflag, self.nanreplacedflag)
