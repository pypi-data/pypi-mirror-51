...
class GridDlgBox(QDialog):
    ''' Base class to create a grid layout type dialogbox from an item list. '''
    ...
    def __init__(self, title, parent, it_list):
        ...
        #self.layout.setSizeConstraint(QLayout.SetFixedSize)    # to not authorize size modification
