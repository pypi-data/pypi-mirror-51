...
<table>
  ...
  <tr text-align="left">
    <td text-align="left">sql</td>
    <td text-align="left">%%sql --database dbName --container containerName<br/>SELECT top 1 r.id, r._ts from r order by r._ts desc</td>
    <td text-align="left">Queries cosmos using the given cosmos database and container.
    Parameters:
      <ul>
  ...
  <tr text-align="left">
    <td text-align="left">database</td>
    <td text-align="left">%database dbName</td>
    <td text-align="left">sets the default cosmos database to be used in queries.</td>
  </tr>
  <tr text-align="left">
    <td text-align="left">container</td>
    <td text-align="left">%container containerName</td>
    <td text-align="left">sets the default cosmos container to be used in queries.</td>
  </tr>
</table>
"""
