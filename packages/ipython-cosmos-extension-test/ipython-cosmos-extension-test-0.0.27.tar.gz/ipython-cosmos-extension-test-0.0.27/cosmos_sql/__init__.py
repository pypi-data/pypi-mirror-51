...
<table>
  ...
  <tr>
    ...
    <td align="left">%database dbName</td>
    <td align="left">sets the default cosmos database to be used in queries.</td>
  </tr>
  <tr>
    <td align="left">container</td>
    <td align="left">%container containerName</td>
    <td align="left">sets the default cosmos container to be used in queries.</td>
  </tr>
  <tr>
    <td align="left">sql</td>
    <td align="left">%%sql --database dbName --container containerName<br/>SELECT top 1 r.id, r._ts from r order by r._ts desc</td>
    <td align="left">Queries cosmos using the given cosmos database and container.
    Parameters:
      <ul>
        <li align="left">--database if provided this cosmos database will be used otherwise the default cosmos database will be used.</li>
        <li align="left">--container if provided this cosmos container will be used otherwise the default cosmos container will be used.</li>
        <li align="left">--output VAR_NAME: the result data-frame will be stored in the given variable name.</li>
      </ul>
    </td>
  </tr>
</table>
