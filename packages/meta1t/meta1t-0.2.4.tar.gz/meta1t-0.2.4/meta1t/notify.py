...
class Notify(Events, BlockchainInstance):
    """ Notifications on Blockchain events.
        ...
        :param list markets: Instances of :class:`meta1t.market.Market` that identify markets to be monitored
        ...
        **Example**
        ...
        .. code-block:: python
            ...
            from meta1t.notify import Notify
            from meta1t.market import Market
    ...
    def process_market(self, data):
        """ This method is used for post processing of market
            ...
            * :class:`meta1t.price.Order` or
            * :class:`meta1t.price.FilledOrder` or
            * :class:`meta1t.price.UpdateCallOrder`
    ...
    def process_account(self, message):
        """ This is used for processing of account Updates. It will
            return instances of :class:meta1t.account.AccountUpdate`
        """
