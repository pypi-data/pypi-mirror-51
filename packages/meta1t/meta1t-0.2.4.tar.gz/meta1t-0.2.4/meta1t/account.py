...
class Account(GrapheneAccount):
    """ This class allows to easily access Account data
        ...
        :rtype: dictionary
        :raises meta1t.exceptions.AccountDoesNotExistsException: if account
                does not exist
        ...
        .. code-block:: python
            ...
            from meta1t.account import Account
    ...
    def call_positions(self):
        """ Alias for :func:meta1t.account.Account.callpositions
        """
...
class AccountUpdate(GrapheneAccountUpdate):
    """ This purpose of this class is to keep track of account updates
        as they are pushed through by :class:`meta1t.notify.Notify`.
