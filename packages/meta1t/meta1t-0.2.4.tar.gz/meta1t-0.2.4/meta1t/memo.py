...
class Memo(GrapheneMemo):
    """ Deals with Memos that are attached to a transfer
        ...
        :param meta1t.account.Account from_account: Account that has sent
            the memo
        :param meta1t.account.Account to_account: Account that has received
            the memo
