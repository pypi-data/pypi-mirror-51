...
class Price(GraphenePrice):
    """ This class deals with all sorts of prices of any pair of assets to
        ...
        each being an instance of :class:`meta1t.amount.Amount`. The
        ...
        :param meta1t.asset.Asset base: Base asset
        :param meta1t.asset.Asset quote: Quote asset
        :param meta1t.meta1t.Meta1 blockchain_instance: Meta1 instance
        ...
        Way to obtain a proper instance:
            ...
            * ``args`` can be a floating number and ``base`` and ``quote`` being instances of :class:`meta1t.asset.Asset`
            ...
            * ``args`` being a list of ``[quote, base]`` both being instances of :class:`meta1t.amount.Amount`
            * ``args`` being a list of ``[quote, base]`` both being instances of ``str`` (``amount symbol``)
            * ``base`` and ``quote`` being instances of :class:`meta1t.asset.Amount`
        ...
        * ``Price(1.0, "USD/GOLD")``
        ...
        .. code-block:: python
            ...
            >>> from meta1t.price import Price
    ...
    def market(self):
        """ Open the corresponding market
            ...
            :returns: Instance of :class:`meta1t.market.Market` for the
...
class Order(Price):
    """ This class inherits :class:`meta1t.price.Price` but has the ``base``
