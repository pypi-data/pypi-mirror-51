...
class Asset(GrapheneAsset):
    ...
    def seize(self, from_account, to_account, amount):
        """ Seize amount from an account and send to another
            ...
            :param meta1t.account.Account from_account: From this account
            :param meta1t.account.Account to_account: To this account
            :param meta1t.amount.Amount amount: Amount to seize
        """
    ...
    def set_market_fee(self, percentage_fee, max_market_fee):
        """ Set trading percentage fee
            ...
            :param meta1t.amount.Amount max_market_fee: Max Fee
