...
class Bankcard3Eles(BoolDataBase):
    ...
    def set_biz_data(self, name: str, ident_number: str, bankcard: str) -> 'Bankcard3Eles':
        """
        ...
        :return:
        """
        self.biz_data = self.generate_biz_data(name, ident_number, bankcard)
