...
egg2maya2011_bin = lambda: _exec_tool('egg2maya2011_bin')
egg2maya2012 = lambda: _exec_tool('egg2maya2012')
egg2maya2012_bin = lambda: _exec_tool('egg2maya2012_bin')
egg2maya2013 = lambda: _exec_tool('egg2maya2013')
egg2maya2013_bin = lambda: _exec_tool('egg2maya2013_bin')
egg2maya2014 = lambda: _exec_tool('egg2maya2014')
egg2maya2014_bin = lambda: _exec_tool('egg2maya2014_bin')
egg2maya2015 = lambda: _exec_tool('egg2maya2015')
egg2maya2015_bin = lambda: _exec_tool('egg2maya2015_bin')
egg2maya2016 = lambda: _exec_tool('egg2maya2016')
egg2maya20165 = lambda: _exec_tool('egg2maya20165')
egg2maya20165_bin = lambda: _exec_tool('egg2maya20165_bin')
egg2maya2016_bin = lambda: _exec_tool('egg2maya2016_bin')
egg2maya2017 = lambda: _exec_tool('egg2maya2017')
egg2maya2017_bin = lambda: _exec_tool('egg2maya2017_bin')
egg2maya2018 = lambda: _exec_tool('egg2maya2018')
egg2maya2018_bin = lambda: _exec_tool('egg2maya2018_bin')
...
maya2egg2011_bin = lambda: _exec_tool('maya2egg2011_bin')
maya2egg2012 = lambda: _exec_tool('maya2egg2012')
maya2egg2012_bin = lambda: _exec_tool('maya2egg2012_bin')
maya2egg2013 = lambda: _exec_tool('maya2egg2013')
maya2egg2013_bin = lambda: _exec_tool('maya2egg2013_bin')
maya2egg2014 = lambda: _exec_tool('maya2egg2014')
maya2egg2014_bin = lambda: _exec_tool('maya2egg2014_bin')
maya2egg2015 = lambda: _exec_tool('maya2egg2015')
maya2egg2015_bin = lambda: _exec_tool('maya2egg2015_bin')
maya2egg2016 = lambda: _exec_tool('maya2egg2016')
maya2egg20165 = lambda: _exec_tool('maya2egg20165')
maya2egg20165_bin = lambda: _exec_tool('maya2egg20165_bin')
maya2egg2016_bin = lambda: _exec_tool('maya2egg2016_bin')
maya2egg2017 = lambda: _exec_tool('maya2egg2017')
maya2egg2017_bin = lambda: _exec_tool('maya2egg2017_bin')
maya2egg2018 = lambda: _exec_tool('maya2egg2018')
maya2egg2018_bin = lambda: _exec_tool('maya2egg2018_bin')
mayacopy2011 = lambda: _exec_tool('mayacopy2011')
mayacopy2011_bin = lambda: _exec_tool('mayacopy2011_bin')
mayacopy2012 = lambda: _exec_tool('mayacopy2012')
mayacopy2012_bin = lambda: _exec_tool('mayacopy2012_bin')
mayacopy2013 = lambda: _exec_tool('mayacopy2013')
mayacopy2013_bin = lambda: _exec_tool('mayacopy2013_bin')
mayacopy2014 = lambda: _exec_tool('mayacopy2014')
mayacopy2014_bin = lambda: _exec_tool('mayacopy2014_bin')
mayacopy2015 = lambda: _exec_tool('mayacopy2015')
mayacopy2015_bin = lambda: _exec_tool('mayacopy2015_bin')
mayacopy2016 = lambda: _exec_tool('mayacopy2016')
mayacopy20165 = lambda: _exec_tool('mayacopy20165')
mayacopy20165_bin = lambda: _exec_tool('mayacopy20165_bin')
mayacopy2016_bin = lambda: _exec_tool('mayacopy2016_bin')
mayacopy2017 = lambda: _exec_tool('mayacopy2017')
mayacopy2017_bin = lambda: _exec_tool('mayacopy2017_bin')
mayacopy2018 = lambda: _exec_tool('mayacopy2018')
mayacopy2018_bin = lambda: _exec_tool('mayacopy2018_bin')
