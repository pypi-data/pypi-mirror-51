...
def check_thread_tasks_and_restart(need_to_be_monitored_thread_tasks_info_list: list,
    ...
    print_ip_thread_tasks_info_list = []
    class_thread_tasks_info_list = []
    ...
    for num in range(0, 3):
        ...
        tasks.append(t)
        print_ip_thread_tasks_info_list.append({
            'func_name': print_num,
    ...
    for num in range(3, 4):
        ...
        tasks.append(task)
        class_thread_tasks_info_list.append({
    ...
    need_to_be_monitored_thread_tasks_info_list = \
        print_ip_thread_tasks_info_list + class_thread_tasks_info_list
