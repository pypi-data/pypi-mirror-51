...
class AWSPkgGen(PkgGenerator):
    ...
    def create_layer(self, template_file_path):
        ...
        if deploy_new_layer and deploy_new_layer.lower() == "y":
            ...
            self.add_layer_arn(layer_file_name, layer_version, template_file_path)
    ...
    def generate_packaged_template(self, template_file_path, SAM_S3_BUCKET):
        ...
        self.run_command(["sam", "package", "--template-file", template_file_path, "--output-template-file", packaged_template_path,  "--s3-bucket", SAM_S3_BUCKET, "--s3-prefix", self.deploy_config["APPNAME_SINGLE"]])
