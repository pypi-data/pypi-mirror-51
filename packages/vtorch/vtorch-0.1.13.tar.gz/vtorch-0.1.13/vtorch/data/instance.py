...
class Instance(Mapping[str, Field]):
    ...
    def count_vocab_items(self, counter: Dict[str, Dict[str, int]], exclude_fields: List[str]):
        """
    ...
    def index_fields(self, vocab, fields_with_pretrained_tokenizer: List[str], serial_index: int = None) -> None:
        """
