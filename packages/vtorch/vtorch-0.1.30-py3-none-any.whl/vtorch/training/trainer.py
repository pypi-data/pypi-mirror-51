...
class Trainer(TrainerBase):
    def __init__(self,
                 ...
                 lr_scheduler_params: Optional[Dict] = None) -> None:
        """
        ...
        self._lr_scheduler_name: Optional[str] = lr_scheduler
    ...
    def _train_epoch(self, master_bar_logger: master_bar) -> Dict[str, float]:
        ...
        if self._lr_scheduler_name is not None and self._lr_scheduler is None:
    ...
    def _set_scheduler(self, len_train_loader: int):
        ...
        self._lr_scheduler = Scheduler.by_name(self._lr_scheduler_name)(t_total=t_total, **self._lr_scheduler_params)
