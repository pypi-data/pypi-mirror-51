...
class CalculateNPV:
    ...
    def calculate_npv_costs(self, plant_type, plant_size, forecasted_segment_prices):
        ...
        self._get_total_hours_to_run(forecasted_segment_prices=forecasted_segment_prices, power_plant=power_plant)
        ...
        # total_costs = [yearly_capital_cost - operational_costs] * int(power_plant.operating_period)
        total_costs = [capital_cost - operational_costs * int(power_plant.operating_period) for capital_cost in yearly_capital_cost]
        ...
        costs_npv_power_plant = npv(self.weighted_average_cost_capital, total_costs)

        # NPVp = divide(npv_power_plant, (power_plant.capacity_mw * total_running_hours))
        return costs_npv_power_plant
