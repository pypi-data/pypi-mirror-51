...
class Value:
    ...
    @property
    def null(self) -> 'Value':
        return Value.from_pod(self._pod['null']) if self._pod['null'] is not None else None

    @null.setter
    def null(self, value: 'Value'):
        self._pod['null'] = to_dprep_pod(value)
