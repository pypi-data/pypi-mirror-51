...
class Dataflow:
    ...
    def map_partition(self, fn: Callable[['pandas.DataFrame', int], 'pandas.DataFrame']) -> 'Dataflow':
        ...
        return self.add_step(step_type='Microsoft.DPrep.MapPartitionsAsDataFrameBlock', arguments={
            "codeBlockType": CodeBlockType.PICKLED,
            "MapPartitionsAsDataFrameBlock": base64.b64encode(cloudpickle.dumps(fn)).decode('utf-8')
        })
    ...
    def __getstate__(self):
        return {'dataflow_json': self.to_json()}

    def __setstate__(self, newstate):
        self.__dict__ = Dataflow.from_json(newstate['dataflow_json']).__dict__
