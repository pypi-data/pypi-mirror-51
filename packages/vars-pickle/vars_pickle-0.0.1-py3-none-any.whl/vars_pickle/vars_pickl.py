...
import numpy as np
import pandas as pd
type_list = ['str','function','pandas.core.frame.DataFrame','pandas.core.series.Series','list','dict','int','float','set','tuple']
drop_list = ['In','Out','var_dic_list','get_ipython','']

def dumps(name = '',path = 'data_pickle'):
    """
    ...
    try:
        ...
        print("pickle:"+path)
          ...
          print('pickle ERROR')
def loads(name = '',replace = False,path = 'data_pickle'):
    """
