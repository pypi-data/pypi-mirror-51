...
class Client(object):
    ...
    def __init__(self, config_dir=None, config_file=None, host=None, token=None):
        self.config_file = config_file or "config.json"
        self.config_dir = config_dir or os.environ.get('SOUPSTARS_HOME') or os.path.join(os.path.expanduser('~'), '.soupstars')
    ...
    def update_config(self):
        self._write_config(config=self.config())
