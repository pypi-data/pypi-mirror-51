...
def login(username=None, password=None, url=None, directory='Seeq', ignore_ssl_errors=False,
          proxy=AUTOMATIC_PROXY_DETECTION, credentials_file=None, quiet=False, auth_provider=None):
    """
    ...
    :type password: str
    :param url: Seeq Server url. You can copy this from your browser and cut off everything to the left of the third
    slash. E.g. https://myseeqserver:34216/
    :type url: str
