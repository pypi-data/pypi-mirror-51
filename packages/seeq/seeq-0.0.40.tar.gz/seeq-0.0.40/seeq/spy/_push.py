...
def push(data=None, metadata=None, item_type='Signal', workbook=_common.DEFAULT_WORKBOOK_PATH,
    ...
    :type item_type: str
    :param workbook: The path to a workbook (in the form of 'Folder >> Path >> Workbook Name') that all pushed items
    will be "scoped to," meaning that they will not be visible outside of the workbook. By default all items pushed are
    scoped to a 'Data Lab >> Data Lab Analysis' workbook. Specify None if you want the items to be visible in all
    workbooks.
    :type workbook: str
