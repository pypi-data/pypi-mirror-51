...
class ArtifactOperations(object):
    ...
    def get_writeable_sas_for_artifact(
                self, subscription_id, resource_group_name, workspace_name, origin, container, path, custom_headers=None, raw=False, **operation_config):
            """
            Gets a writeable SAS uri for the specified artifact
            :param subscription_id: The Azure Subscription ID.
            :type subscription_id: str
            :param resource_group_name: Name of the resource group in which the
            workspace is located.
            ...
            :type origin: str
            :param container: container of the artifact
            :type container: str
            :param path: path to the artifact in the container
            :type path: str
            :param dict custom_headers: headers that will be added to the request
            :param bool raw: returns the direct response alongside the
            deserialized response
            ...
            """
            # Construct URL
            url = self.get_writeable_sas_for_artifact.metadata['url']
            path_format_arguments = {
                'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
                'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
                'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
            ...
            return deserialized
    get_writeable_sas_for_artifact.metadata = {'url': '/artifact/v2.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/write/{origin}/{container}/{path}'}
