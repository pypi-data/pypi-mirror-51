...
class ServiceOperations(object):
    ...
    def list_query(
            self, subscription_id, resource_group_name, workspace, tag=None, tags=None, properties=None, name=None, image_id=None, image_name=None, model_id=None, model_name=None, count=None, compute_type=None, skip_token=None, orderby=None, custom_headers=None, raw=False, **operation_config):
