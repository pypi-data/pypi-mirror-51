...
class DatasetRequestDto(Model):
    ...
    def __init__(self, data_path=None, excel=None, json=None, general=None, source_properties=None, columns_to_remove=None, schema=None, notes=None, name=None, description=None, tags=None, is_visible=None, default_compute=None):
