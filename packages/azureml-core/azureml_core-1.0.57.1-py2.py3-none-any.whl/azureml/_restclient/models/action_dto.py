...
class ActionDto(Model):
    ...
    def __init__(self, action_id=None, action_type=None, definition_version=None, dataset_snapshot_name=None, workspace_id=None, dataset_id=None, compute_target=None, arguments=None, result_artifact_ids=None, created_time=None, status=None, error=None, warnings=None, start_time_utc=None, end_time_utc=None):
