...
from .contracts.utils import get_run_ids_and_metric_types_filter_expression
...
class MetricsClient(RunClient):
    ...
    def _get_metrics_for_run(self, metric_types=None, after_timestamp=None):
        """get metrics with the same run_id"""
        expression = get_run_ids_and_metric_types_filter_expression(run_ids=[self._run_id],
    ...
    def _get_metrics_for_runs(self, run_ids, use_batch=False, metric_types=None, after_timestamp=None):
    ...
    def get_all_metrics(self, run_ids=None, populate=False, artifact_client=None,
                        ...
                        data_container=None, after_timestamp=None):
        if run_ids is None:
