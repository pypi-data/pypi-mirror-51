...
class ExperimentClient(WorkspaceClient):
    ...
    def get_metrics_in_batches_by_run_ids(self, run_ids, metric_types=None, after_timestamp=None):
        ...
        for batch in _batches:
            result_as_generator = self.get_metrics_by_run_ids(
                ...
                order_by=('RunId', 'asc'), metric_types=metric_types, after_timestamp=after_timestamp)
