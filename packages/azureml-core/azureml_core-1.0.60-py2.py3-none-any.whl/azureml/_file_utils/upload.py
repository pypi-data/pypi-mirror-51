...
from azureml._restclient.clientbase import execute_func_custom
...
def upload_blob_from_stream(stream, url, content_type=None, session=None, timeout=None, backoff=None, retries=None):
    ...
    return execute_func_custom(backoff, retries, blob_service.create_blob_from_stream,
                               container_name=container_name,
                               blob_name=blob_name, stream=stream,
                               content_settings=content_settings, timeout=timeout)
