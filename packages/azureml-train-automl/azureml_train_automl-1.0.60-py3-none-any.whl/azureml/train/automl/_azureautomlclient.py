...
class AzureAutoMLClient:
    ...
    def _validate_remote_input(self, parent_run_dto: CreateParentRunDto) -> None:
        ...
        try:
            ...
            self.logger.info("Validation service meet exceptions, continue training now.")

        if validation_results is not None and len(validation_results.error.details[0]) == 1 \
                and validation_results.error.details[0].code != "UpstreamSystem":
            ...
            raise ValidationException(
                "Validation fails on the sample data. "
