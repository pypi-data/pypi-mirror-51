...
corpus <https://github.com/huji-nlp/tupa/releases/download/v1.3.9/ucca-bilstm-1.3.9.tar.gz>`__,
run:
...
To get `a
model <https://github.com/huji-nlp/tupa/releases/download/v1.3.9/ucca-bilstm-1.3.9-fr.tar.gz>`__
pre-trained on the `French *20K Leagues*
corpus <https://github.com/UniversalConceptualCognitiveAnnotation/UCCA_French-20K>`__
or `a
model <https://github.com/huji-nlp/tupa/releases/download/v1.3.9/ucca-bilstm-1.3.9-de.tar.gz>`__
