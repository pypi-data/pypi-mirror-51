...
def get_rest_api_client(version, headers=None):
    # (str, Optional[Dict[str, Any]]) -> RestApiClient
    server_url = get_root_url(get_config("comet.url_override"))

    low_level_api = LowLevelHTTPClient(server_url, headers)

    return RestApiClient(
        server_url=server_url, version=version, low_level_api_client=low_level_api
    )
...
class RestApiClient(object):
    ...
    def __init__(self, server_url, version, low_level_api_client):
    ...
    def get_experiment_os_packages(self, experiment_key):
        ...
        return self.low_level_api_client.get(url, params=params)
    ...
    def set_experiment_os_packages(self, experiment_key, os_packages):
        ...
        return self.low_level_api_client.post(url, payload=payload)
