...
to_cythonize = [Extension("solver_utils", ["cassiopeia/TreeSolver/lineage_solver/solver_utils.pyx"]),
               Extension("dataset_generation", ["cassiopeia/TreeSolver/simulation_tools/dataset_generation.pyx"]),
               Extension("lineageGroup_utils", ["cassiopeia/ProcessingPipeline/process/lineageGroup_utils.pyx"]), 
               Extension("collapse_cython", ["cassiopeia/ProcessingPipeline/process/collapse_cython.pyx"])] 
