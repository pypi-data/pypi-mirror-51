...
```bash
TAG=2.18.2.0b12 REGISTRY=us.gcr.io/onepanelio make publish-pip-package
```
...
```bash
TAG=2.18.2.0b12 REGISTRY=us.gcr.io/onepanelio make build-docker-image push-docker-image
```
