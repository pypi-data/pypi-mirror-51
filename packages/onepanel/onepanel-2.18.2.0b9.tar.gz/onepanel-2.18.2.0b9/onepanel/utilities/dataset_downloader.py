...
import onepanel.commands.datasets as datasets
...
class DatasetDownloadListener(Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            vc = datasets.DatasetViewController(Connection())
            vc.account_uid = download_identifier.account_uid
            vc.dataset_uid = download_identifier.dataset_uid
            vc.save(path)
