...
# Union match
if !(-e $rt) then
	set cmd = "SRPGWUnionMatch -v -i $strl -r 0.5 -o $rt -a PSFMAG ePSFMAG "
    echo $cmd
    eval $cmd
endif
#
...
if !(-e $rt:r_3.tab) then
    set cmd = "SRPGWQuery -v -i $rt:r_2.tab -D -x -o $rt:r_3.tab"
    echo $cmd
    eval $cmd
endif
#
...
if !(-e $rt:r_6.tab) then
    set cmd = "SRPGWMagNorm -v -i $rt:r_5.tab -o $rt:r_6.tab -G"
    echo $cmd
    eval $cmd
endif
#
...
if !(-e $rt:r_9.tab) then
    set cmd = "SRPGWAdaptSelect -v -i $rt:r_8.tab -o $rt:r_9.tab -M -m $magthreshold -C -G -S -s $scothreshold"
    echo $cmd
    eval $cmd
endif
#
# GAIA & Simbad selection
if !(-e $rt:r_10.tab) then
    set cmd = "SRPGWSelect -v -i $rt:r_9.tab -o $rt:r_10.tab -s "'"( GAIA == -99 ) | ( Simbad != '"'No'"' )"'""
    echo $cmd
    eval $cmd
endif
#
...
#
echo "./03.VST.Selezione.csh $rt:r_14.tab 0"
