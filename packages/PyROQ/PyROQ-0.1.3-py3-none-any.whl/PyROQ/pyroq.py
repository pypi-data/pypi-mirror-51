...
def initial_basis(approximant, mc_low, mc_high, q_low, q_high, s1sphere_low, s1sphere_high, s2sphere_low, s2sphere_high, ecc_low, ecc_high, lambda1_low, lambda1_high, iota_low, iota_high, phiref_low, phiref_high, deltaF, f_min, f_max, distance, waveFlags, approximant):
    if approximant==72: 
        nparams = 10
