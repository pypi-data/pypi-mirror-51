...
class ActionUI(object):
	def __init__(self, title, message, button_specs, include_continue_button=False, column_headers=None, rowset=None):
		...
		def enable_buttons(event):
			any_sel = self.tbl.selection() is not None
