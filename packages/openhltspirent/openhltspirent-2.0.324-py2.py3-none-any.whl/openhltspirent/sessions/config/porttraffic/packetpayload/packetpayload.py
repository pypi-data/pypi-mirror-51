...
class PacketPayload(Base):
	...
	def Payload(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.packetpayload.payload.payload.Payload)
		"""
		from openhltspirent.sessions.config.porttraffic.packetpayload.payload.payload import Payload
