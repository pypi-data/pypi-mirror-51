...
class Qqic(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.igmpv3query.qqic.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.igmpv3query.qqic.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.igmpv3query.qqic.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.igmpv3query.qqic.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.igmpv3query.qqic.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.igmpv3query.qqic.random.random import Random
