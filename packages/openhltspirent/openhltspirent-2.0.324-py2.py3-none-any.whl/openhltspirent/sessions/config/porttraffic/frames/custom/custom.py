...
class Custom(Base):
	...
	def Payload(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.custom.payload.payload.Payload)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.custom.payload.payload import Payload
