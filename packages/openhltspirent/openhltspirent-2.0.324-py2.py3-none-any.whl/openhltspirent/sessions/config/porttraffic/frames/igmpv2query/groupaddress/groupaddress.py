...
class GroupAddress(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.igmpv2query.groupaddress.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.igmpv2query.groupaddress.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.igmpv2query.groupaddress.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.igmpv2query.groupaddress.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.igmpv2query.groupaddress.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.igmpv2query.groupaddress.random.random import Random
