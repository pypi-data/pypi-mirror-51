...
class DestinationAddress(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ipv6.destinationaddress.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ipv6.destinationaddress.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ipv6.destinationaddress.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ipv6.destinationaddress.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ipv6.destinationaddress.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ipv6.destinationaddress.random.random import Random
