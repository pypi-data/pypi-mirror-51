...
class Ipv6GatewayAddress(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpv6packettoobig.ipv6gatewayaddress.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpv6packettoobig.ipv6gatewayaddress.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpv6packettoobig.ipv6gatewayaddress.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpv6packettoobig.ipv6gatewayaddress.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpv6packettoobig.ipv6gatewayaddress.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpv6packettoobig.ipv6gatewayaddress.random.random import Random
