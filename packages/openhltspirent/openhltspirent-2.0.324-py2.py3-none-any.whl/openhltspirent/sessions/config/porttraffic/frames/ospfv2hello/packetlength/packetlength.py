...
class PacketLength(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.packetlength.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.packetlength.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.packetlength.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.packetlength.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.packetlength.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.packetlength.random.random import Random
