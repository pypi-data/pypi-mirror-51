...
class Neighbors(Base):
	...
	def NeighborsId(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.neighbors.neighborsid.neighborsid.NeighborsId)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.neighbors.neighborsid.neighborsid import NeighborsId
