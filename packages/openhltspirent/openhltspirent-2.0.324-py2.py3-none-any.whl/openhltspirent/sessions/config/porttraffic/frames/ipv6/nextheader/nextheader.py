...
class NextHeader(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ipv6.nextheader.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ipv6.nextheader.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ipv6.nextheader.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ipv6.nextheader.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ipv6.nextheader.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ipv6.nextheader.random.random import Random
