...
class Identifier(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpinformationreply.identifier.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpinformationreply.identifier.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpinformationreply.identifier.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpinformationreply.identifier.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpinformationreply.identifier.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpinformationreply.identifier.random.random import Random
