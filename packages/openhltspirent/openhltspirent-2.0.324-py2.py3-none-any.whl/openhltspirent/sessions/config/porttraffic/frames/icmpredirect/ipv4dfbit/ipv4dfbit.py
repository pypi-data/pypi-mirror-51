...
class Ipv4DfBit(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpredirect.ipv4dfbit.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpredirect.ipv4dfbit.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpredirect.ipv4dfbit.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpredirect.ipv4dfbit.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpredirect.ipv4dfbit.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpredirect.ipv4dfbit.random.random import Random
