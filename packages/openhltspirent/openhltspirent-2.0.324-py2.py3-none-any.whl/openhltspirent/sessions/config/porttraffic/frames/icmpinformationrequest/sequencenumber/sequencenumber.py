...
class SequenceNumber(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpinformationrequest.sequencenumber.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpinformationrequest.sequencenumber.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpinformationrequest.sequencenumber.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpinformationrequest.sequencenumber.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpinformationrequest.sequencenumber.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpinformationrequest.sequencenumber.random.random import Random
