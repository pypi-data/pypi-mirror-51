...
class DesignatedRouterAddress(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.designatedrouteraddress.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.designatedrouteraddress.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.designatedrouteraddress.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.designatedrouteraddress.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.designatedrouteraddress.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.designatedrouteraddress.random.random import Random
