...
class PreferenceLevel(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmprouteradvertisement.icmprouteraddress.preferencelevel.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmprouteradvertisement.icmprouteraddress.preferencelevel.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmprouteradvertisement.icmprouteraddress.preferencelevel.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmprouteradvertisement.icmprouteraddress.preferencelevel.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmprouteradvertisement.icmprouteraddress.preferencelevel.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmprouteradvertisement.icmprouteraddress.preferencelevel.random.random import Random
