...
class KeepAliveBit(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.gre.keepalivebit.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.gre.keepalivebit.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.gre.keepalivebit.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.gre.keepalivebit.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.gre.keepalivebit.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.gre.keepalivebit.random.random import Random
