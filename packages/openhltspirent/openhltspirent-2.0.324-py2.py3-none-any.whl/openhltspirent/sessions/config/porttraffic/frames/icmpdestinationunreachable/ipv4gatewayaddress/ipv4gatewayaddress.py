...
class Ipv4GatewayAddress(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpdestinationunreachable.ipv4gatewayaddress.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpdestinationunreachable.ipv4gatewayaddress.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpdestinationunreachable.ipv4gatewayaddress.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpdestinationunreachable.ipv4gatewayaddress.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpdestinationunreachable.ipv4gatewayaddress.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpdestinationunreachable.ipv4gatewayaddress.random.random import Random
