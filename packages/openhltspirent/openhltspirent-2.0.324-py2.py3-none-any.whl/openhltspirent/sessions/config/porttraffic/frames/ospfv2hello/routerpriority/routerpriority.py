...
class RouterPriority(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.routerpriority.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.routerpriority.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.routerpriority.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.routerpriority.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.routerpriority.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.routerpriority.random.random import Random
