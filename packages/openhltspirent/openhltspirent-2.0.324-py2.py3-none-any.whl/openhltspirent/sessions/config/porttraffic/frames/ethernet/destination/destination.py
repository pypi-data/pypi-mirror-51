...
class Destination(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ethernet.destination.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ethernet.destination.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ethernet.destination.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ethernet.destination.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ethernet.destination.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ethernet.destination.random.random import Random
