...
class ReservedBit(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ipv4.reservedbit.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ipv4.reservedbit.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ipv4.reservedbit.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ipv4.reservedbit.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ipv4.reservedbit.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ipv4.reservedbit.random.random import Random
