...
class AreaId(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.areaid.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.areaid.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.areaid.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.areaid.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.areaid.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ospfv2hello.areaid.random.random import Random
