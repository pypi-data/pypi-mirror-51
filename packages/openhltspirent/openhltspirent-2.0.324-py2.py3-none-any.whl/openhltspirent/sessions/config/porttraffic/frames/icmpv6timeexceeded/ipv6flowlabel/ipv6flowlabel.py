...
class Ipv6FlowLabel(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpv6timeexceeded.ipv6flowlabel.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpv6timeexceeded.ipv6flowlabel.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpv6timeexceeded.ipv6flowlabel.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpv6timeexceeded.ipv6flowlabel.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpv6timeexceeded.ipv6flowlabel.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpv6timeexceeded.ipv6flowlabel.random.random import Random
