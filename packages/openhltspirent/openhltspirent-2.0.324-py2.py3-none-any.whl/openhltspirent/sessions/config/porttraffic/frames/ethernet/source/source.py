...
class Source(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ethernet.source.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ethernet.source.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ethernet.source.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ethernet.source.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ethernet.source.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ethernet.source.random.random import Random
