...
class HeaderLength(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ipv4.headerlength.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ipv4.headerlength.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ipv4.headerlength.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ipv4.headerlength.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.ipv4.headerlength.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.ipv4.headerlength.random.random import Random
