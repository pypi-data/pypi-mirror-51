...
class Ipv4ReservedBit(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpredirect.ipv4reservedbit.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpredirect.ipv4reservedbit.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpredirect.ipv4reservedbit.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpredirect.ipv4reservedbit.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmpredirect.ipv4reservedbit.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmpredirect.ipv4reservedbit.random.random import Random
