...
class Sequence_number(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmptimestampreply.sequence_number.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmptimestampreply.sequence_number.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmptimestampreply.sequence_number.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmptimestampreply.sequence_number.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.frames.icmptimestampreply.sequence_number.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.frames.icmptimestampreply.sequence_number.random.random import Random
