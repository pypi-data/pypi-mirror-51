...
class FrameLength(Base):
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.framelength.random.random.Random)
		"""
		from openhltspirent.sessions.config.porttraffic.framelength.random.random import Random
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.framelength.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.porttraffic.framelength.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.framelength.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.porttraffic.framelength.decrement.decrement import Decrement
	...
	def Imix(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.framelength.imix.imix.Imix)
		"""
		from openhltspirent.sessions.config.porttraffic.framelength.imix.imix import Imix
