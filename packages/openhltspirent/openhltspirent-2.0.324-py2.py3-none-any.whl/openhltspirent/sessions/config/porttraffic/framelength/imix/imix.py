...
class Imix(Base):
	...
	def CustomImix(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.framelength.imix.customimix.customimix.CustomImix)
		"""
		from openhltspirent.sessions.config.porttraffic.framelength.imix.customimix.customimix import CustomImix
