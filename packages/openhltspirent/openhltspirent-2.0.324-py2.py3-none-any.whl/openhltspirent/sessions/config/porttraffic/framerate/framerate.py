...
class FrameRate(Base):
	...
	def FixedRate(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.framerate.fixedrate.fixedrate.FixedRate)
		"""
		from openhltspirent.sessions.config.porttraffic.framerate.fixedrate.fixedrate import FixedRate
	...
	def DecrementRate(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.framerate.decrementrate.decrementrate.DecrementRate)
		"""
		from openhltspirent.sessions.config.porttraffic.framerate.decrementrate.decrementrate import DecrementRate
	...
	def IncrementRate(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.porttraffic.framerate.incrementrate.incrementrate.IncrementRate)
		"""
		from openhltspirent.sessions.config.porttraffic.framerate.incrementrate.incrementrate import IncrementRate
