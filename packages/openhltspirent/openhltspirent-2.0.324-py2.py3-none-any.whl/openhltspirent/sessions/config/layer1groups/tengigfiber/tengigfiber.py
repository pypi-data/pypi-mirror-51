...
class TenGigFiber(Base):
	...
	def PriorityBasedFlowControl(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.layer1groups.tengigfiber.prioritybasedflowcontrol.prioritybasedflowcontrol.PriorityBasedFlowControl)
		"""
		from openhltspirent.sessions.config.layer1groups.tengigfiber.prioritybasedflowcontrol.prioritybasedflowcontrol import PriorityBasedFlowControl
	...
	def DataCenterBridgingExchange(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.layer1groups.tengigfiber.datacenterbridgingexchange.datacenterbridgingexchange.DataCenterBridgingExchange)
		"""
		from openhltspirent.sessions.config.layer1groups.tengigfiber.datacenterbridgingexchange.datacenterbridgingexchange import DataCenterBridgingExchange
