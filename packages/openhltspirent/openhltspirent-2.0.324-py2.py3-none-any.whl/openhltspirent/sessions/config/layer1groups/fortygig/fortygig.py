...
class FortyGig(Base):
	...
	def __init__(self, parent):
		super(FortyGig, self).__init__(parent)
	...
	def PriorityBasedFlowControl(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.layer1groups.fortygig.prioritybasedflowcontrol.prioritybasedflowcontrol.PriorityBasedFlowControl)
		"""
		from openhltspirent.sessions.config.layer1groups.fortygig.prioritybasedflowcontrol.prioritybasedflowcontrol import PriorityBasedFlowControl
	...
	def DataCenterBridgingExchange(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.layer1groups.fortygig.datacenterbridgingexchange.datacenterbridgingexchange.DataCenterBridgingExchange)
		"""
		from openhltspirent.sessions.config.layer1groups.fortygig.datacenterbridgingexchange.datacenterbridgingexchange import DataCenterBridgingExchange
	...
	def update(self, AutoInstrumentation=None, AutoNegotiationEnabled=None, MasterSlaveType=None, CollisionExponent=None, CustomFecMode=None, DataPathMode=None, FlowControl=None, FlowControlDirectedAddress=None, Mtu=None, PortSetupMode=None, RxMode=None, TxGapControl=None, TxMode=None, CableTypeLength=None, CfpInterface=None, DeficitIdleCount=None, ForwardErrorCorrection=None, IgnoreLinkStatus=None, InternalPpmAdjust=None, OptimizedXon=None, TransmitClockSource=None):
		"""Update the current instance of the `forty-gig` resource
