...
class LongLivedGracefulRestart(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv4.gracefulrestart.longlivedgracefulrestart.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv4.gracefulrestart.longlivedgracefulrestart.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv4.gracefulrestart.longlivedgracefulrestart.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv4.gracefulrestart.longlivedgracefulrestart.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv4.gracefulrestart.longlivedgracefulrestart.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv4.gracefulrestart.longlivedgracefulrestart.random.random import Random
