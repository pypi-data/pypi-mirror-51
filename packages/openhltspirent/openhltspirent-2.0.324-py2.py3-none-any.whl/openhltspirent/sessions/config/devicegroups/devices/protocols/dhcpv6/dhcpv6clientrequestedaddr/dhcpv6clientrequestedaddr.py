...
class Dhcpv6ClientRequestedAddr(Base):
	"""DHCPv6 client requested starting address.
	"""
	YANG_NAME = 'dhcpv6-client-requested-addr'
	...
	def __init__(self, parent):
		super(Dhcpv6ClientRequestedAddr, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv6.dhcpv6clientrequestedaddr.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv6.dhcpv6clientrequestedaddr.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv6.dhcpv6clientrequestedaddr.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv6.dhcpv6clientrequestedaddr.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv6.dhcpv6clientrequestedaddr.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv6.dhcpv6clientrequestedaddr.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `dhcpv6-client-requested-addr` resource
