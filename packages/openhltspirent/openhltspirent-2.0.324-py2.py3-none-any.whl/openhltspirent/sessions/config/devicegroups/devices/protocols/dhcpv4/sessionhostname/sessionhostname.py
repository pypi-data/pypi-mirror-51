...
class SessionHostName(Base):
	"""Unique hostname of emulated client.
	"""
	YANG_NAME = 'session-host-name'
	...
	def __init__(self, parent):
		super(SessionHostName, self).__init__(parent)
	...
	def update(self, PatternFormat=None, PatternType=None, Single=None, String=None, ValueList=None):
		"""Update the current instance of the `session-host-name` resource
