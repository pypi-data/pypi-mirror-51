...
class MaxRelayAgentRemoteIdCount(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.relayagentaddresspools.maxrelayagentremoteidcount.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.relayagentaddresspools.maxrelayagentremoteidcount.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.relayagentaddresspools.maxrelayagentremoteidcount.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.relayagentaddresspools.maxrelayagentremoteidcount.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.relayagentaddresspools.maxrelayagentremoteidcount.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.relayagentaddresspools.maxrelayagentremoteidcount.random.random import Random
