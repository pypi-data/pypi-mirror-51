...
class GracefulRestart(Base):
	...
	def LongLivedGracefulRestart(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv6.gracefulrestart.longlivedgracefulrestart.longlivedgracefulrestart.LongLivedGracefulRestart)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv6.gracefulrestart.longlivedgracefulrestart.longlivedgracefulrestart import LongLivedGracefulRestart
	...
	def RestartTime(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv6.gracefulrestart.restarttime.restarttime.RestartTime)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv6.gracefulrestart.restarttime.restarttime import RestartTime
	...
	def RestartDelay(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv6.gracefulrestart.restartdelay.restartdelay.RestartDelay)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv6.gracefulrestart.restartdelay.restartdelay import RestartDelay
	...
	def AdvertiseEor(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv6.gracefulrestart.advertiseeor.advertiseeor.AdvertiseEor)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv6.gracefulrestart.advertiseeor.advertiseeor import AdvertiseEor
