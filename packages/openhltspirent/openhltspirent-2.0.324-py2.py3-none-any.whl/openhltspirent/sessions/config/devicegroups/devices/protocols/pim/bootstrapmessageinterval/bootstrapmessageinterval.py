...
class BootstrapMessageInterval(Base):
	"""Frequency in seconds with which bootstrap messages are transmitted.
	"""
	YANG_NAME = 'bootstrap-message-interval'
	...
	def __init__(self, parent):
		super(BootstrapMessageInterval, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.bootstrapmessageinterval.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.bootstrapmessageinterval.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.bootstrapmessageinterval.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.bootstrapmessageinterval.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.bootstrapmessageinterval.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.bootstrapmessageinterval.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `bootstrap-message-interval` resource
