...
class PruneSourcePrefix(Base):
	"""Prefix length of the pruned source IP address
	"""
	YANG_NAME = 'prune-source-prefix'
	...
	def __init__(self, parent):
		super(PruneSourcePrefix, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv6groups.prunesourceprefix.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv6groups.prunesourceprefix.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv6groups.prunesourceprefix.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv6groups.prunesourceprefix.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv6groups.prunesourceprefix.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv6groups.prunesourceprefix.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `prune-source-prefix` resource
