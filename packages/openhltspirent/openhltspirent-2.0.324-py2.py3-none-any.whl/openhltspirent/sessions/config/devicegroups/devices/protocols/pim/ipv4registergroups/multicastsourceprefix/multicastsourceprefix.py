...
class MulticastSourcePrefix(Base):
	"""Length of the prefix of the address of the multicast source
	"""
	YANG_NAME = 'multicast-source-prefix'
	...
	def __init__(self, parent):
		super(MulticastSourcePrefix, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv4registergroups.multicastsourceprefix.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv4registergroups.multicastsourceprefix.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv4registergroups.multicastsourceprefix.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv4registergroups.multicastsourceprefix.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv4registergroups.multicastsourceprefix.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv4registergroups.multicastsourceprefix.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `multicast-source-prefix` resource
