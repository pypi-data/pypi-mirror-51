...
class RouterList(Base):
	"""Router addresses (option 3).
	"""
	YANG_NAME = 'router-list'
	...
	def __init__(self, parent):
		super(RouterList, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.defaultserveraddresspool.routerlist.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.defaultserveraddresspool.routerlist.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.defaultserveraddresspool.routerlist.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.defaultserveraddresspool.routerlist.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.defaultserveraddresspool.routerlist.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.defaultserveraddresspool.routerlist.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `router-list` resource
