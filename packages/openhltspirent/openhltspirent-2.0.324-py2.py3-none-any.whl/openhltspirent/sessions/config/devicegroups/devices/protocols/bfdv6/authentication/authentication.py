...
class Authentication(Base):
	...
	def AuthenticationType(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bfdv6.authentication.authenticationtype.authenticationtype.AuthenticationType)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bfdv6.authentication.authenticationtype.authenticationtype import AuthenticationType
	...
	def Password(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bfdv6.authentication.password.password.Password)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bfdv6.authentication.password.password import Password
