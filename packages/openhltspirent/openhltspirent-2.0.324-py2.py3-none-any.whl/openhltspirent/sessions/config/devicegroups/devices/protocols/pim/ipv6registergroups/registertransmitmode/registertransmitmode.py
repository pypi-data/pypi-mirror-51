...
class RegisterTransmitMode(Base):
	...
	"""
	YANG_NAME = 'register-transmit-mode'
	...
	def __init__(self, parent):
		super(RegisterTransmitMode, self).__init__(parent)
	...
	def update(self, PatternFormat=None, PatternType=None, Single=None, ValueList=None):
		"""Update the current instance of the `register-transmit-mode` resource
