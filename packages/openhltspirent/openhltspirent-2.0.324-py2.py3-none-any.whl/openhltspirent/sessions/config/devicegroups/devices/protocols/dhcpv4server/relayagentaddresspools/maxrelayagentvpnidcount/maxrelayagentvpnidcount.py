...
class MaxRelayAgentVpnIdCount(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.relayagentaddresspools.maxrelayagentvpnidcount.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.relayagentaddresspools.maxrelayagentvpnidcount.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.relayagentaddresspools.maxrelayagentvpnidcount.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.relayagentaddresspools.maxrelayagentvpnidcount.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.relayagentaddresspools.maxrelayagentvpnidcount.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4server.relayagentaddresspools.maxrelayagentvpnidcount.random.random import Random
