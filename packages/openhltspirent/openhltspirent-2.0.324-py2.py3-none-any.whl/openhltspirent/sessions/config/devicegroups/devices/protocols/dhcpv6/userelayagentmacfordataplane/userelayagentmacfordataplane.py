...
class UseRelayAgentMacForDataplane(Base):
	...
	"""
	YANG_NAME = 'use-relay-agent-mac-for-dataplane'
	...
	def __init__(self, parent):
		super(UseRelayAgentMacForDataplane, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv6.userelayagentmacfordataplane.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv6.userelayagentmacfordataplane.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv6.userelayagentmacfordataplane.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv6.userelayagentmacfordataplane.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv6.userelayagentmacfordataplane.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv6.userelayagentmacfordataplane.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `use-relay-agent-mac-for-dataplane` resource
