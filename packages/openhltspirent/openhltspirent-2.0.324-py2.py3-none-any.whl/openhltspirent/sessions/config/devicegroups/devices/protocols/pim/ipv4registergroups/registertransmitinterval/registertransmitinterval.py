...
class RegisterTransmitInterval(Base):
	"""Number of seconds to wait between sending Register messages.
	"""
	YANG_NAME = 'register-transmit-interval'
	...
	def __init__(self, parent):
		super(RegisterTransmitInterval, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv4registergroups.registertransmitinterval.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv4registergroups.registertransmitinterval.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv4registergroups.registertransmitinterval.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv4registergroups.registertransmitinterval.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv4registergroups.registertransmitinterval.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.ipv4registergroups.registertransmitinterval.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `register-transmit-interval` resource
