...
class LastMemberQueryCount(Base):
	...
	"""
	YANG_NAME = 'last-member-query-count'
	...
	def __init__(self, parent):
		super(LastMemberQueryCount, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.igmpquerier.lastmemberquerycount.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.igmpquerier.lastmemberquerycount.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.igmpquerier.lastmemberquerycount.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.igmpquerier.lastmemberquerycount.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.igmpquerier.lastmemberquerycount.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.igmpquerier.lastmemberquerycount.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `last-member-query-count` resource
