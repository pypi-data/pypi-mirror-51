...
class Authentication(Base):
	...
	def AuthenticationType(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv4.authentication.authenticationtype.authenticationtype.AuthenticationType)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv4.authentication.authenticationtype.authenticationtype import AuthenticationType
	...
	def Md5Password(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv4.authentication.md5password.md5password.Md5Password)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bgpv4.authentication.md5password.md5password import Md5Password
