...
class RelayAgentIpv4Address(Base):
	"""Source IP address of the relay agent message.
	"""
	YANG_NAME = 'relay-agent-ipv4-address'
	...
	def __init__(self, parent):
		super(RelayAgentIpv4Address, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4.relayagent.relayagentipv4address.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4.relayagent.relayagentipv4address.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4.relayagent.relayagentipv4address.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4.relayagent.relayagentipv4address.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4.relayagent.relayagentipv4address.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4.relayagent.relayagentipv4address.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `relay-agent-ipv4-address` resource
