...
class Bfdv6(Base):
	...
	def TransmitInterval(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bfdv6.transmitinterval.transmitinterval.TransmitInterval)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bfdv6.transmitinterval.transmitinterval import TransmitInterval
	...
	def ReceiveInterval(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bfdv6.receiveinterval.receiveinterval.ReceiveInterval)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bfdv6.receiveinterval.receiveinterval import ReceiveInterval
	...
	def EchoReceiveInterval(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bfdv6.echoreceiveinterval.echoreceiveinterval.EchoReceiveInterval)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bfdv6.echoreceiveinterval.echoreceiveinterval import EchoReceiveInterval
	...
	def Authentication(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.bfdv6.authentication.authentication.Authentication)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.bfdv6.authentication.authentication import Authentication
