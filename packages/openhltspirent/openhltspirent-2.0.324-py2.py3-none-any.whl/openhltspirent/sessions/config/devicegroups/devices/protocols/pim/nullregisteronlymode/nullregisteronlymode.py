...
class NullRegisterOnlyMode(Base):
	...
	"""
	YANG_NAME = 'null-register-only-mode'
	...
	def __init__(self, parent):
		super(NullRegisterOnlyMode, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.nullregisteronlymode.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.nullregisteronlymode.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.nullregisteronlymode.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.nullregisteronlymode.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.pim.nullregisteronlymode.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.pim.nullregisteronlymode.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `null-register-only-mode` resource
