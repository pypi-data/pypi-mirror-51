...
class RelayAgentServerIpv4Address(Base):
	"""Destination IP address for the relay agent message.
	"""
	YANG_NAME = 'relay-agent-server-ipv4-address'
	...
	def __init__(self, parent):
		super(RelayAgentServerIpv4Address, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4.relayagent.relayagentserveripv4address.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4.relayagent.relayagentserveripv4address.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4.relayagent.relayagentserveripv4address.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4.relayagent.relayagentserveripv4address.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4.relayagent.relayagentserveripv4address.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.dhcpv4.relayagent.relayagentserveripv4address.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `relay-agent-server-ipv4-address` resource
