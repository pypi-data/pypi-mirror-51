...
class MulticastGroupToSourceDistribution(Base):
	...
	"""
	YANG_NAME = 'multicast-group-to-source-distribution'
	...
	def __init__(self, parent):
		super(MulticastGroupToSourceDistribution, self).__init__(parent)
	...
	def update(self, PatternFormat=None, PatternType=None, Single=None, ValueList=None):
		"""Update the current instance of the `multicast-group-to-source-distribution` resource
