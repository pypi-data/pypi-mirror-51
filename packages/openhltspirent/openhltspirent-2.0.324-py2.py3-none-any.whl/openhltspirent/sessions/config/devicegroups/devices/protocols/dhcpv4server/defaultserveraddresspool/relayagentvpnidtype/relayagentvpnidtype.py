...
class RelayAgentVpnIdType(Base):
	...
	def __init__(self, parent):
		super(RelayAgentVpnIdType, self).__init__(parent)
	...
	def update(self, PatternFormat=None, PatternType=None, Single=None, ValueList=None):
		"""Update the current instance of the `relay-agent-vpn-id-type` resource
