...
class RobustnessVariable(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.mldquerier.robustnessvariable.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.mldquerier.robustnessvariable.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.mldquerier.robustnessvariable.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.mldquerier.robustnessvariable.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.devices.protocols.mldquerier.robustnessvariable.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.devices.protocols.mldquerier.robustnessvariable.random.random import Random
