...
class AggregateAs(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.bgpv4routerange.atomicaggregate.aggregateas.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.bgpv4routerange.atomicaggregate.aggregateas.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.bgpv4routerange.atomicaggregate.aggregateas.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.bgpv4routerange.atomicaggregate.aggregateas.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.bgpv4routerange.atomicaggregate.aggregateas.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.bgpv4routerange.atomicaggregate.aggregateas.random.random import Random
