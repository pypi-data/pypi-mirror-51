...
class Address(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.ospfv2externalrange.address.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.ospfv2externalrange.address.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.ospfv2externalrange.address.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.ospfv2externalrange.address.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.ospfv2externalrange.address.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.ospfv2externalrange.address.random.random import Random
