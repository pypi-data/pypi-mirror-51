...
class PrefixSegmentId(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.ospfv2externalrange.segmentrouting.prefixsegmentid.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.ospfv2externalrange.segmentrouting.prefixsegmentid.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.ospfv2externalrange.segmentrouting.prefixsegmentid.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.ospfv2externalrange.segmentrouting.prefixsegmentid.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.ospfv2externalrange.segmentrouting.prefixsegmentid.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicegroups.simulatednetworks.networks.ospfv2externalrange.segmentrouting.prefixsegmentid.random.random import Random
