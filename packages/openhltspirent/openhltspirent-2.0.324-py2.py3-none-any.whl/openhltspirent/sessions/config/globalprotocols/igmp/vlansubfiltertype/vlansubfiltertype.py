...
class VlanSubFilterType(Base):
	...
	"""
	YANG_NAME = 'vlan-sub-filter-type'
	...
	def __init__(self, parent):
		super(VlanSubFilterType, self).__init__(parent)
	...
	def update(self, PatternFormat=None, PatternType=None, Single=None, ValueList=None):
		"""Update the current instance of the `vlan-sub-filter-type` resource
