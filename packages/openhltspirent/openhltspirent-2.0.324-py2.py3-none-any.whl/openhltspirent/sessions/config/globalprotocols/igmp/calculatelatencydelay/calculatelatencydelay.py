...
class CalculateLatencyDelay(Base):
	...
	def __init__(self, parent):
		super(CalculateLatencyDelay, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.igmp.calculatelatencydelay.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.igmp.calculatelatencydelay.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.igmp.calculatelatencydelay.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.igmp.calculatelatencydelay.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.igmp.calculatelatencydelay.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.igmp.calculatelatencydelay.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `calculate-latency-delay` resource
