...
class RatePps(Base):
	...
	def __init__(self, parent):
		super(RatePps, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.igmp.ratepps.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.igmp.ratepps.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.igmp.ratepps.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.igmp.ratepps.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.igmp.ratepps.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.igmp.ratepps.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `rate-pps` resource
