...
class CalculateLatencyDelay(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.mld.calculatelatencydelay.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.mld.calculatelatencydelay.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.mld.calculatelatencydelay.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.mld.calculatelatencydelay.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.mld.calculatelatencydelay.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.mld.calculatelatencydelay.random.random import Random
