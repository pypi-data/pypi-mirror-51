...
class MaxBurst(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.mld.maxburst.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.mld.maxburst.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.mld.maxburst.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.mld.maxburst.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.mld.maxburst.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.mld.maxburst.random.random import Random
