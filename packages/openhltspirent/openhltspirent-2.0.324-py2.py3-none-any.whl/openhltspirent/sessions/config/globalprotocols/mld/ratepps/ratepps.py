...
class RatePps(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.mld.ratepps.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.mld.ratepps.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.mld.ratepps.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.mld.ratepps.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.mld.ratepps.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.mld.ratepps.random.random import Random
