...
class DisableRetries(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.disableretries.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.disableretries.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.disableretries.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.disableretries.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.disableretries.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.disableretries.random.random import Random
