...
class EnableDeviceBlockRate(Base):
	...
	"""
	YANG_NAME = 'enable-device-block-rate'
	...
	def __init__(self, parent):
		super(EnableDeviceBlockRate, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.enabledeviceblockrate.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.enabledeviceblockrate.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.enabledeviceblockrate.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.enabledeviceblockrate.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.enabledeviceblockrate.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.enabledeviceblockrate.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `enable-device-block-rate` resource
