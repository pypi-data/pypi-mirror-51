...
class InitialTimeout(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.initialtimeout.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.initialtimeout.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.initialtimeout.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.initialtimeout.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.initialtimeout.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.initialtimeout.random.random import Random
