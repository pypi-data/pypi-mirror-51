...
class MaxRetryAttempt(Base):
	"""Maximum Session Level Auto Retry Count.
	"""
	YANG_NAME = 'max-retry-attempt'
	...
	def __init__(self, parent):
		super(MaxRetryAttempt, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.maxretryattempt.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.maxretryattempt.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.maxretryattempt.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.maxretryattempt.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.maxretryattempt.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.maxretryattempt.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `max-retry-attempt` resource
