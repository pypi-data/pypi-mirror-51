...
class DisableRetries(Base):
	...
	def __init__(self, parent):
		super(DisableRetries, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.disableretries.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.disableretries.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.disableretries.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.disableretries.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.disableretries.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.disableretries.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `disable-retries` resource
