...
class IndefiniteRetry(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.requestmessage.indefiniteretry.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.requestmessage.indefiniteretry.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.requestmessage.indefiniteretry.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.requestmessage.indefiniteretry.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.requestmessage.indefiniteretry.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.requestmessage.indefiniteretry.random.random import Random
