...
class IndefiniteRetry(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.rebindmessage.indefiniteretry.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.rebindmessage.indefiniteretry.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.rebindmessage.indefiniteretry.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.rebindmessage.indefiniteretry.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.rebindmessage.indefiniteretry.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.rebindmessage.indefiniteretry.random.random import Random
