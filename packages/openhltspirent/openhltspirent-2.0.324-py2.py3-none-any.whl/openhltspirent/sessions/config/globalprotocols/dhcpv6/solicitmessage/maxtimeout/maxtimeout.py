...
class MaxTimeout(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.maxtimeout.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.maxtimeout.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.maxtimeout.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.maxtimeout.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.maxtimeout.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.maxtimeout.random.random import Random
