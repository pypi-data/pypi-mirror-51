...
class IndefiniteRetry(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.releasemessage.indefiniteretry.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.releasemessage.indefiniteretry.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.releasemessage.indefiniteretry.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.releasemessage.indefiniteretry.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.releasemessage.indefiniteretry.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.releasemessage.indefiniteretry.random.random import Random
