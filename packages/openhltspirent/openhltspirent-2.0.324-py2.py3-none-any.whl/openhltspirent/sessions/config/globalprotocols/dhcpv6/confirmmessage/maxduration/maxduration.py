...
class MaxDuration(Base):
	...
	def __init__(self, parent):
		super(MaxDuration, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.confirmmessage.maxduration.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.confirmmessage.maxduration.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.confirmmessage.maxduration.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.confirmmessage.maxduration.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.confirmmessage.maxduration.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.confirmmessage.maxduration.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `max-duration` resource
