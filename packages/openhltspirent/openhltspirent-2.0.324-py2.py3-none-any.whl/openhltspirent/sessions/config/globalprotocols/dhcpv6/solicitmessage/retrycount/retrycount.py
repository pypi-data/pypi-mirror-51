...
class RetryCount(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.retrycount.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.retrycount.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.retrycount.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.retrycount.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.retrycount.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.solicitmessage.retrycount.random.random import Random
