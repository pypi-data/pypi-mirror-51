...
class IndefiniteRetry(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.declinemessage.indefiniteretry.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.declinemessage.indefiniteretry.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.declinemessage.indefiniteretry.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.declinemessage.indefiniteretry.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.declinemessage.indefiniteretry.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.declinemessage.indefiniteretry.random.random import Random
