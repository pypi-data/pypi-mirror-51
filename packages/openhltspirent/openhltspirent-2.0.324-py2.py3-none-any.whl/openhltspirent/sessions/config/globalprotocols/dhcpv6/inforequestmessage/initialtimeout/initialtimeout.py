...
class InitialTimeout(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.initialtimeout.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.initialtimeout.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.initialtimeout.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.initialtimeout.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.initialtimeout.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.initialtimeout.random.random import Random
