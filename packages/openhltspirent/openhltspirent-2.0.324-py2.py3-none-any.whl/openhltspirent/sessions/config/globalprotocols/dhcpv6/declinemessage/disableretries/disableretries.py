...
class DisableRetries(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.declinemessage.disableretries.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.declinemessage.disableretries.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.declinemessage.disableretries.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.declinemessage.disableretries.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.declinemessage.disableretries.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.declinemessage.disableretries.random.random import Random
