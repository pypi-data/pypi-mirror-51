...
class IndefiniteRetry(Base):
	...
	def __init__(self, parent):
		super(IndefiniteRetry, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.indefiniteretry.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.indefiniteretry.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.indefiniteretry.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.indefiniteretry.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.indefiniteretry.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv6.inforequestmessage.indefiniteretry.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `indefinite-retry` resource
