...
class EnableCustomOptionAssignForRelayAgents(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv4.enablecustomoptionassignforrelayagents.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv4.enablecustomoptionassignforrelayagents.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv4.enablecustomoptionassignforrelayagents.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv4.enablecustomoptionassignforrelayagents.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.dhcpv4.enablecustomoptionassignforrelayagents.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.dhcpv4.enablecustomoptionassignforrelayagents.random.random import Random
