...
class TBit(Base):
	...
	def __init__(self, parent):
		super(TBit, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.prunedelayoptions.tbit.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.prunedelayoptions.tbit.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.prunedelayoptions.tbit.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.prunedelayoptions.tbit.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.prunedelayoptions.tbit.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.prunedelayoptions.tbit.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `t-bit` resource
