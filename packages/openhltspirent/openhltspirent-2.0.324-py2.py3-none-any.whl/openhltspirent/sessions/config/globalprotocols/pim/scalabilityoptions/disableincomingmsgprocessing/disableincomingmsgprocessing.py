...
class DisableIncomingMsgProcessing(Base):
	...
	"""
	YANG_NAME = 'disable-incoming-msg-processing'
	...
	def __init__(self, parent):
		super(DisableIncomingMsgProcessing, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disableincomingmsgprocessing.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disableincomingmsgprocessing.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disableincomingmsgprocessing.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disableincomingmsgprocessing.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disableincomingmsgprocessing.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disableincomingmsgprocessing.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `disable-incoming-msg-processing` resource
