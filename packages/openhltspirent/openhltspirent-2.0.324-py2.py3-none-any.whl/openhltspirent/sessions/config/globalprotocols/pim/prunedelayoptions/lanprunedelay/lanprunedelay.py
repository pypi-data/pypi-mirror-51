...
class LanPruneDelay(Base):
	...
	def __init__(self, parent):
		super(LanPruneDelay, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.prunedelayoptions.lanprunedelay.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.prunedelayoptions.lanprunedelay.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.prunedelayoptions.lanprunedelay.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.prunedelayoptions.lanprunedelay.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.prunedelayoptions.lanprunedelay.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.prunedelayoptions.lanprunedelay.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `lan-prune-delay` resource
