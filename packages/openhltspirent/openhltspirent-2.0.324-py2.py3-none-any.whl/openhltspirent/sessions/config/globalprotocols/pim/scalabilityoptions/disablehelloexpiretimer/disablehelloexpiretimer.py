...
class DisableHelloExpireTimer(Base):
	...
	"""
	YANG_NAME = 'disable-hello-expire-timer'
	...
	def __init__(self, parent):
		super(DisableHelloExpireTimer, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disablehelloexpiretimer.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disablehelloexpiretimer.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disablehelloexpiretimer.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disablehelloexpiretimer.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disablehelloexpiretimer.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disablehelloexpiretimer.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `disable-hello-expire-timer` resource
