...
class EnablePackGroupRecord(Base):
	...
	"""
	YANG_NAME = 'enable-pack-group-record'
	...
	def __init__(self, parent):
		super(EnablePackGroupRecord, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.enablepackgrouprecord.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.enablepackgrouprecord.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.enablepackgrouprecord.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.enablepackgrouprecord.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.enablepackgrouprecord.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.enablepackgrouprecord.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `enable-pack-group-record` resource
