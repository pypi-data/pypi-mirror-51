...
class DisableHelloRxInNeighborState(Base):
	...
	"""
	YANG_NAME = 'disable-hello-rx-in-neighbor-state'
	...
	def __init__(self, parent):
		super(DisableHelloRxInNeighborState, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disablehellorxinneighborstate.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disablehellorxinneighborstate.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disablehellorxinneighborstate.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disablehellorxinneighborstate.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disablehellorxinneighborstate.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.scalabilityoptions.disablehellorxinneighborstate.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `disable-hello-rx-in-neighbor-state` resource
