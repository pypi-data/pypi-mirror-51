...
class TriggerHelloDelay(Base):
	...
	def __init__(self, parent):
		super(TriggerHelloDelay, self).__init__(parent)
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.triggerhellodelay.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.triggerhellodelay.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.triggerhellodelay.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.triggerhellodelay.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalprotocols.pim.triggerhellodelay.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalprotocols.pim.triggerhellodelay.random.random import Random
	...
	def update(self, PatternType=None, PatternFormat=None, Single=None, ValueList=None):
		"""Update the current instance of the `trigger-hello-delay` resource
