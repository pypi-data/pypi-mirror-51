...
class Address(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalmulticastgroups.multicastgroups.ipv4group.address.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalmulticastgroups.multicastgroups.ipv4group.address.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalmulticastgroups.multicastgroups.ipv4group.address.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalmulticastgroups.multicastgroups.ipv4group.address.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalmulticastgroups.multicastgroups.ipv4group.address.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalmulticastgroups.multicastgroups.ipv4group.address.random.random import Random
