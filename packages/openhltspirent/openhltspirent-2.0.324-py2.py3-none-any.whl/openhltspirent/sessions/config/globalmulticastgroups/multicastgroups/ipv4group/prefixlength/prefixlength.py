...
class PrefixLength(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalmulticastgroups.multicastgroups.ipv4group.prefixlength.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.globalmulticastgroups.multicastgroups.ipv4group.prefixlength.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalmulticastgroups.multicastgroups.ipv4group.prefixlength.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.globalmulticastgroups.multicastgroups.ipv4group.prefixlength.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.globalmulticastgroups.multicastgroups.ipv4group.prefixlength.random.random.Random)
		"""
		from openhltspirent.sessions.config.globalmulticastgroups.multicastgroups.ipv4group.prefixlength.random.random import Random
