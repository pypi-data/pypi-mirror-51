...
class EthernetType(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ethernet.ethernettype.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ethernet.ethernettype.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ethernet.ethernettype.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ethernet.ethernettype.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ethernet.ethernettype.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ethernet.ethernettype.random.random import Random
