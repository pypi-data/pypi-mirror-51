...
class AddressEntrySize(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmprouteradvertisement.addressentrysize.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmprouteradvertisement.addressentrysize.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmprouteradvertisement.addressentrysize.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmprouteradvertisement.addressentrysize.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmprouteradvertisement.addressentrysize.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmprouteradvertisement.addressentrysize.random.random import Random
