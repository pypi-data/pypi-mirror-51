...
class OptionsReservedBit7(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.optionsreservedbit7.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.optionsreservedbit7.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.optionsreservedbit7.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.optionsreservedbit7.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.optionsreservedbit7.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.optionsreservedbit7.random.random import Random
