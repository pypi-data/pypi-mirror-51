...
class AdvertiseCount(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmprouteradvertisement.advertisecount.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmprouteradvertisement.advertisecount.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmprouteradvertisement.advertisecount.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmprouteradvertisement.advertisecount.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmprouteradvertisement.advertisecount.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmprouteradvertisement.advertisecount.random.random import Random
