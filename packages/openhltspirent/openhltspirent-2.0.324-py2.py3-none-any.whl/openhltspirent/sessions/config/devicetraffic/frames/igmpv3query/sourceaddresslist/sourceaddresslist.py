...
class SourceAddressList(Base):
	...
	def Address(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.igmpv3query.sourceaddresslist.address.address.Address)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.igmpv3query.sourceaddresslist.address.address import Address
