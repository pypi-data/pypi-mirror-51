...
class NumberOfGroupRecords(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.igmpv3report.numberofgrouprecords.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.igmpv3report.numberofgrouprecords.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.igmpv3report.numberofgrouprecords.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.igmpv3report.numberofgrouprecords.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.igmpv3report.numberofgrouprecords.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.igmpv3report.numberofgrouprecords.random.random import Random
