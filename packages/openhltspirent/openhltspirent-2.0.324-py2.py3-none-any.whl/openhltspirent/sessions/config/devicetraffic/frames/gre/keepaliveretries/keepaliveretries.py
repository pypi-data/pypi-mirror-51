...
class KeepAliveRetries(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.gre.keepaliveretries.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.gre.keepaliveretries.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.gre.keepaliveretries.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.gre.keepaliveretries.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.gre.keepaliveretries.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.gre.keepaliveretries.random.random import Random
