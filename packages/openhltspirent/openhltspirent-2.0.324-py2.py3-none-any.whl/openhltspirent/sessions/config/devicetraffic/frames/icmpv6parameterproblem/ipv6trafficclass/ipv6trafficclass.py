...
class Ipv6TrafficClass(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmpv6parameterproblem.ipv6trafficclass.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmpv6parameterproblem.ipv6trafficclass.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmpv6parameterproblem.ipv6trafficclass.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmpv6parameterproblem.ipv6trafficclass.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmpv6parameterproblem.ipv6trafficclass.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmpv6parameterproblem.ipv6trafficclass.random.random import Random
