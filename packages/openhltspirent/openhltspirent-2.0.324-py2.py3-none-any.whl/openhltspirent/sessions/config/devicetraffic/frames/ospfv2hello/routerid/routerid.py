...
class RouterId(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.routerid.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.routerid.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.routerid.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.routerid.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.routerid.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.routerid.random.random import Random
