...
class OptionsEaBit(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.optionseabit.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.optionseabit.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.optionseabit.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.optionseabit.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.optionseabit.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.optionseabit.random.random import Random
