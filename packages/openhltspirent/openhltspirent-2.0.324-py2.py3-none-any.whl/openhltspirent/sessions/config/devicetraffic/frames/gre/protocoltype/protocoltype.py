...
class ProtocolType(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.gre.protocoltype.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.gre.protocoltype.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.gre.protocoltype.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.gre.protocoltype.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.gre.protocoltype.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.gre.protocoltype.random.random import Random
