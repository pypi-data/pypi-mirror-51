...
class Identifier(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmptimestampreply.identifier.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmptimestampreply.identifier.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmptimestampreply.identifier.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmptimestampreply.identifier.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmptimestampreply.identifier.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmptimestampreply.identifier.random.random import Random
