...
class MaxResponseTime(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.igmpv2report.maxresponsetime.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.igmpv2report.maxresponsetime.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.igmpv2report.maxresponsetime.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.igmpv2report.maxresponsetime.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.igmpv2report.maxresponsetime.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.igmpv2report.maxresponsetime.random.random import Random
