...
class DestinationPort(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.tcp.destinationport.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.tcp.destinationport.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.tcp.destinationport.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.tcp.destinationport.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.tcp.destinationport.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.tcp.destinationport.random.random import Random
