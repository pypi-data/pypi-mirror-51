...
class HopLimit(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ipv6.hoplimit.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ipv6.hoplimit.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ipv6.hoplimit.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ipv6.hoplimit.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ipv6.hoplimit.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ipv6.hoplimit.random.random import Random
