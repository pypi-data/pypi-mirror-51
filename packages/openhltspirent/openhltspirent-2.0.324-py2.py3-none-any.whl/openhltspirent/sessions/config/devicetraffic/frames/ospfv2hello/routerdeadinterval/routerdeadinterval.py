...
class RouterDeadInterval(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.routerdeadinterval.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.routerdeadinterval.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.routerdeadinterval.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.routerdeadinterval.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.routerdeadinterval.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.routerdeadinterval.random.random import Random
