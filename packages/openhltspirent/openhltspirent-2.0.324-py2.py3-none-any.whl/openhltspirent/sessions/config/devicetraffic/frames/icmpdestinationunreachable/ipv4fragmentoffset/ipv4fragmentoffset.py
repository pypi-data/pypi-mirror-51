...
class Ipv4FragmentOffset(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmpdestinationunreachable.ipv4fragmentoffset.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmpdestinationunreachable.ipv4fragmentoffset.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmpdestinationunreachable.ipv4fragmentoffset.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmpdestinationunreachable.ipv4fragmentoffset.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmpdestinationunreachable.ipv4fragmentoffset.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmpdestinationunreachable.ipv4fragmentoffset.random.random import Random
