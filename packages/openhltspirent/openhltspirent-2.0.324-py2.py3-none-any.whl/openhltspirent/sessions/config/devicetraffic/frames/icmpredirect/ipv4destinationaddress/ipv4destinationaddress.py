...
class Ipv4DestinationAddress(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmpredirect.ipv4destinationaddress.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmpredirect.ipv4destinationaddress.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmpredirect.ipv4destinationaddress.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmpredirect.ipv4destinationaddress.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.icmpredirect.ipv4destinationaddress.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.icmpredirect.ipv4destinationaddress.random.random import Random
