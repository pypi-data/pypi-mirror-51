...
class AuthValue1(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.authvalue1.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.authvalue1.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.authvalue1.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.authvalue1.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.authvalue1.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.ospfv2hello.authvalue1.random.random import Random
