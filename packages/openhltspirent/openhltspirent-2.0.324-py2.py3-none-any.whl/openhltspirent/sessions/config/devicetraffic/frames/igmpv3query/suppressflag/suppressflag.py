...
class SuppressFlag(Base):
	...
	def Increment(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.igmpv3query.suppressflag.increment.increment.Increment)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.igmpv3query.suppressflag.increment.increment import Increment
	...
	def Decrement(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.igmpv3query.suppressflag.decrement.decrement.Decrement)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.igmpv3query.suppressflag.decrement.decrement import Decrement
	...
	def Random(self):
		...
		Returns:
			obj(openhltspirent.sessions.config.devicetraffic.frames.igmpv3query.suppressflag.random.random.Random)
		"""
		from openhltspirent.sessions.config.devicetraffic.frames.igmpv3query.suppressflag.random.random import Random
