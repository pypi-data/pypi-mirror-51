...
print('\n  Create and configure BFDv4 protocol on port1')
protocol_bfd_1 = devices_1.Protocols.create(Name = 'BFD1', ParentLink='IPV41', ProtocolType='BFDV4')
bfdv4_handle1 = protocol_bfd_1.Name
bfd_1 = protocol_bfd_1.Bfdv4
...
print('\n  Create and configure BGPv4 protocol on port1')
...
print('\n  Create and configure BFDv4 protocol on port2')
protocol_bfd_2 = devices_2.Protocols.create(Name = 'BFD2', ParentLink='IPV42', ProtocolType='BFDV4')
bfdv4_handle2 = protocol_bfd_2.Name
bfd_2 = protocol_bfd_2.Bfdv4
...
print('\n  Create and configure BGPv4 protocol on port2')
...
dut_ipv4_address_2 = bgp_2.DutIpv4Address.update(PatternType='SINGLE', Single='192.85.1.3')
...
print('\n  Create BGPV4 Route Range under the simulated_networks_2')
...
print('\n  Save XML')
save_config_input = config.Save({'mode': 'VENDOR_BINARY', 'file-name': os.path.join(os.path.dirname(__file__), 'bfd_bgp4_sample_script.xml')})

print('\n  Start BFDv4 protocol\n')
bgpv4_control_input1 = config.Bfdv4Control({"targets": [bfdv4_handle1 , bfdv4_handle2], "mode": 'START'})
...
statistics = session.Statistics
bfdv4_statistics_1 = statistics.Bfdv4Statistics.read(DeviceName = 'Device1')
print('  BFDv4 statistics of Device1:')
#print(bfdv4_statistics_1)

bfdv4_statistics_2 = statistics.Bfdv4Statistics.read(DeviceName = 'Device2')
print('  BFD statistics of Device2:')
#print(bfdv4_statistics_2)

print('\n  Create BOUND streamblock - IPv4 endpoints\n')
device_traffic = config.DeviceTraffic.create(Name='IPV4Stream1', Encapsulation='IPV4', Sources=['simulated-networks_1'], Destinations=['simulated-networks_2'], BiDirectional='true')
