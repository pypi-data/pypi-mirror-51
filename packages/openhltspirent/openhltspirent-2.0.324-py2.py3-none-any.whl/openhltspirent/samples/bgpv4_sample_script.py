...
print('\n  Create a device under port1, protocol stack: eth/vlan/vlan/ipv4/BGP.\n')
print('\n  Create device groups: East Side - Device group 1 under the port Ethernet 1')
...
protocol_ipv4_1 = devices_1.Protocols.create(Name = 'IPv41', ProtocolType= 'IPV4', ParentLink = 'Vlan1_Inner')
...
vlan_id_1_incr_1 = vlan_id_1_1.Increment.update(Start = '99', Step = '1')
priority1_1 = protocol_vlan_1.Vlan.Priority.update(PatternType='SINGLE', Single='6')

vlan_id_1_2 = protocol_vlan_2.Vlan.Id.update(PatternType='INCREMENT')
vlan_id_1_incr_2 = vlan_id_1_2.Increment.update(Start = '999', Step = '1')
priority1_2 = protocol_vlan_2.Vlan.Priority.update(PatternType='SINGLE', Single='5')

print('\n  Create a device under port2, protocol stack: eth/vlan/vlan/ipv4/BGP.\n')
...
print('\n  Create protocols IPv4')
protocol_ipv4_2 = devices_2.Protocols.create(Name = 'IPv42', ProtocolType= 'IPV4', ParentLink = 'Vlan2_Inner')
...
vlan_id_2_incr_1 = vlan_id_2_1.Increment.update(Start = '99', Step = '1')
priority2_1 = protocol_vlan_3.Vlan.Priority.update(PatternType='SINGLE', Single='6')

vlan_id_2_2 = protocol_vlan_4.Vlan.Id.update(PatternType='INCREMENT')
vlan_id_2_incr_2 = vlan_id_2_2.Increment.update(Start = '999', Step = '1')
priority2_2 = protocol_vlan_4.Vlan.Priority.update(PatternType='SINGLE', Single='5')

print('\n  create and configure BGPv4 protocol on Device1\n')
protocol_bgp_1 = devices_1.Protocols.create(Name = 'BGP1', ParentLink='IPv41', ProtocolType='BGPV4')
bgpv4_handle1 = protocol_bgp_1.Name
bgp_1 = protocol_bgp_1.Bgpv4

dut_ipv4_address_1 = bgp_1.DutIpv4Address
dut_ipv4_address_1.update(PatternType='SINGLE', Single='192.85.1.13')
...
as_number_2byte = protocol_bgp_1.Bgpv4.AsNumber2Byte.create()
as_number_2byte.AsNumber.Increment.update(Start='20')
as_number_2byte.DutAsNumber.Increment.update(Start='10')

print('\n  Create and configure BGPv4 protocol on Device2\n')

protocol_bgp_2 = devices_2.Protocols.create(Name = 'BGP2', ParentLink='IPv42', ProtocolType='BGPV4')
bgpv4_handle2 = protocol_bgp_2.Name
bgp_2 = protocol_bgp_2.Bgpv4

dut_ipv4_address_2 = bgp_2.DutIpv4Address
dut_ipv4_address_2.update(PatternType='SINGLE', Single='192.85.1.3')

hold_time_interval_2 = bgp_2.HoldTimeInterval
hold_time_interval_2.update(PatternType='SINGLE', Single='100')

keep_alive_interval_2 = bgp_2.KeepAliveInterval
keep_alive_interval_2.update(PatternType='SINGLE', Single='50')

as_number_2byte = protocol_bgp_2.Bgpv4.AsNumber2Byte.create()
...
networks_1 = simulated_networks_1.Networks.create(Name='BGPV4Networks1', FlowLink='BGP1', NetworkType='BGPV4_ROUTE_RANGE')

# get an instance of the Bgpv4RouteRange class
bgpv4_route_range_1 = networks_1.Bgpv4RouteRange
bgpv4_route_range_1.update(Active='true')

address_1 = bgpv4_route_range_1.Address
address_1.update(PatternType='SINGLE', Single='192.0.1.0')

prefix_length_1 = bgpv4_route_range_1.PrefixLength
prefix_length_1.update(PatternType='SINGLE', Single='24')

as_path_1 = bgpv4_route_range_1.AsPath
as_path_1.update(PatternType='SINGLE', Single='20')

next_hop_address_1 = bgpv4_route_range_1.NextHopAddress 
next_hop_address_1.update(PatternType='SINGLE', Single='192.85.1.3')
...
networks_2 = simulated_networks_2.Networks.create(Name='BGPV4Networks2', FlowLink='BGP2', NetworkType='BGPV4_ROUTE_RANGE')

# get an instance of the Bgpv4RouteRange class
bgpv4_route_range_2 = networks_2.Bgpv4RouteRange
bgpv4_route_range_2.update(Active='true')

address_2 = bgpv4_route_range_2.Address
address_2.update(PatternType='SINGLE', Single='192.0.1.0')

prefix_length_2 = bgpv4_route_range_2.PrefixLength
prefix_length_2.update(PatternType='SINGLE', Single='24')

as_path_2 = bgpv4_route_range_2.AsPath
as_path_2.update(PatternType='SINGLE', Single='20')

next_hop_address_2 = bgpv4_route_range_2.NextHopAddress
next_hop_address_2.update(PatternType='SINGLE', Single='192.85.1.13')

print('\n  SaveasXML\n')
save_config_input = config.Save({'mode': 'VENDOR_BINARY', 'file-name': os.path.join(os.path.dirname(__file__), 'bgpv4_sample_script.xml')})

print('\n  Start BGP protocol\n')
bgpv4_control_input1 = config.Bgpv4Control({"targets": [bgpv4_handle1 , bgpv4_handle2], "mode": 'START'})

time.sleep(60)

print('\n  Get the BGP statistics\n')
statistics = session.Statistics
bgpv4_statistics_1 = statistics.Bgpv4Statistics.read(DeviceName = 'Device1')
print('  BGP statistics of Device1:')
#print(bgpv4_statistics_1)
bgpv4_statistics_2 = statistics.Bgpv4Statistics.read(DeviceName = 'Device2')
print('  BGP statistics of Device2:')
#print(bgpv4_statistics_2)

bgp1_state = bgpv4_statistics_1.RouterState
bgp2_state = bgpv4_statistics_2.RouterState
...
device_traffic = config.DeviceTraffic.create(Name='IPv4Stream1', Encapsulation='IPV4', Sources=['Device1'], Destinations=['Device2'], BiDirectional='false', MeshType='ONE_TO_ONE')
...
print('\n  Start the traffic\n')
traffic_control_input1 = config.TrafficControl( {"targets": ['IPv4Stream1'], "mode": 'START'})

time.sleep(5)

traffic_control_input1 = config.TrafficControl( {"targets": ['IPv4Stream1'], "mode": 'STOP'})
