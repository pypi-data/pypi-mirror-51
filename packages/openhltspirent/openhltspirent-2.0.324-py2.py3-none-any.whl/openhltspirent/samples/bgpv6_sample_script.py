...
print('\n  create and configure BGPv6 protocol on Device1\n')
...
print('\n  Create and configure BGPv6 protocol on Device2\n')
...
dut_ipv6_address_2 = bgp_2.DutIpv6Address
dut_ipv6_address_2.update(PatternType='SINGLE', Single='2000::1')
...
prefix_length_1.update(PatternType='SINGLE', Single='64')
...
prefix_length_2.update(PatternType='SINGLE', Single='64')
...
print('\n  SaveasXML\n')
save_config_input = config.Save({'mode': 'VENDOR_BINARY', 'file-name': os.path.join(os.path.dirname(__file__), 'bgpv6_sample_script.xml')})
...
device_traffic = config.DeviceTraffic.create(Name='IPV6Stream1', Encapsulation='IPV6', Sources=['Device1'], Destinations=['Device2'], BiDirectional='false', MeshType='ONE_TO_ONE')
