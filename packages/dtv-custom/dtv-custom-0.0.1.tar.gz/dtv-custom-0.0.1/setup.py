...
setup(name='dtv-custom',
      ...
      url='https://github.com/packerbacker3333/django-datatable-view',
      download_url='https://github.com/packerbacker3333/django-datatable-view/archive/jjr-0.0.1.tar.gz',
