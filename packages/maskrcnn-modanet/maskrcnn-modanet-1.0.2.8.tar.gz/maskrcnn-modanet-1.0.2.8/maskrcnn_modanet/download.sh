...
wget -O modanet2018_instances_train.json https://github.com/cad0p/maskrcnn-modanet/releases/download/v1.0.2/modanet2018_instances_train.json

wget -O modanet2018_instances_val.json https://github.com/cad0p/maskrcnn-modanet/releases/download/v1.0.2/modanet2018_instances_val.json
