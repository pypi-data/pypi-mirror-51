...
wget -N https://github.com/fizyr/maskrcnn-modanet/releases/download/v1.0.2/modanet2018_instances_train.json

wget -N https://github.com/fizyr/maskrcnn-modanet/releases/download/v1.0.2/modanet2018_instances_val.json
