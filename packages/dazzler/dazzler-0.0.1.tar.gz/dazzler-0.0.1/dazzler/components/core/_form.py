...
class Form(Component):
    ...
    def __init__(
        ...
        :param auto_complete: Specifies auto complete for the form. (Possible
            values: 'on', 'off')
        ...
        :param no_validate: Specify the form should be validated on submission.
        ...
        :param errors: Errors to show with the fields. Keys are name.
            (default={})
        :param include_submit: Include a submit button on the form. (default=True)
