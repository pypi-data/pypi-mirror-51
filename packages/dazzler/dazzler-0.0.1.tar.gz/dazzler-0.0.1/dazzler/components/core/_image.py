...
class Image(Component):
    ...
    def __init__(
        ...
        :param class_name: CSS class to give to root element, (Scoped: dazzler-
            core-image)
        :param style: Style object of the root element.
        :param bordered: Add bordered style class
        :param rounded: Add rounded style class
        :param centered: Add centered style class for the image to appear in
        ...
        :param caption_class_name: CSS class to give to the caption of the image.
        :param figure_class_name: CSS class to give to figure if caption is provided.
        :param figure_style: Style object to give to figure if caption is provided.
