...
class Notice(Component):
    ...
    def __init__(
        ...
        """
        :param permission: Permission granted by the user (READONLY) (Possible
            values: 'denied', 'granted', 'default', 'unsupported')
        :param title:
        ...
        :param badge: A USVString containing the URL of the image used to
            represent the notification when there is not enough
        ...
        :param require_interaction: Indicates that a notification should remain active
            until the user clicks or dismisses it, rather than
