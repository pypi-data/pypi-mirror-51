...
class Ui_Library(object):
    def setupUI(self, Library, connection):
        ...
        self.minRmsdValue.setLocale(QtCore.QLocale.Spanish)
        ...
        self.maxRmsdValue.setLocale(QtCore.QLocale.Spanish)
        ...
        self.rmsdValue.setLocale(QtCore.QLocale.Spanish)
        ...
        self.representationTemplateValue.addItems(["cartoon" , "backbone", "licorice"])
