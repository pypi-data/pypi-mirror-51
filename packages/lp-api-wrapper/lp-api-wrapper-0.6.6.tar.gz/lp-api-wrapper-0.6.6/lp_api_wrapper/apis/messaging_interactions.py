...
class MessagingInteractions(WrapperBase):
    ...
    def __init__(self, auth, version="1", company=None, source="LPApiWrapper", max_retry=3, wait_factor=15, env='prod'):
        ...
        domain = self.get_domain(
            account_id=auth.account_id, service_name='msgHist', env=env)
    ...
    def get_conversation_by_conversation_id(self, conversation_id, body={}):
        """
        Documentation:
