...
class WsfeInvoiceDetails(object):
    ...
    def _set_details(self):
        ...
        if self.invoice.concept not in [2, 3]:
            ...
            self.detail.FchVtoPago = '' if self.invoice.document_code != 201 else self.invoice.payment_due_date
        else:
            ...
            self.detail.FchVtoPago = self.invoice.payment_due_date if self.invoice.document_code not in [202, 203] \
                else None
