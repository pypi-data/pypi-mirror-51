...
def set_device (project_id_, device_model_id_):
    global api_endpoint, device_model_id, device_id, grpc_channel    
...
def from_audio (input_audio_file, lang = 'ko-KR', output_audio_file = None, once = True, display = True, verbose = False, *args, **kwargs):        
    global grpc_channel, device_model_id, device_id, lock    
