...
def optimal_transport( positions, target_masses, density, radial_func=RadialFuncUnit(), obj_max_dw=1e-8, initial_weights=None ):
    ot = OptimalTransport(positions, weights=initial_weights, domain=density, masses=target_masses, radial_func=radial_func, obj_max_dw=obj_max_dw, raise_exception_if_no_convergence=True)
    return ot.pd
