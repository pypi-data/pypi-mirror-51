...
class Playlist(object):
    ...
    async def populate_video_urls(self):
        ...
        link_list = await self.parse_links()
    ...
    async def download_all(
        ...
        await self.populate_video_urls()
        ...
        for link in self.video_urls:
            try:
                ...
                if prefix_number:
                    ...
                    await dl_stream.download(download_path, filename_prefix=prefix)
                else:
                    await dl_stream.download(download_path)
