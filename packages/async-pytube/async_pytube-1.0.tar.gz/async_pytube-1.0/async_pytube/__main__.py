# -*- coding: utf-8 -*-
"""
This module implements the core developer interface for async_pytube.
...
class YouTube(object):
    """Core developer interface for async_pytube."""
    ...
    def __init__(
        ...
        self.defer_prefetch_init = defer_prefetch_init
            ...
            #asyncio.ensure_future(self.prefetch_init())
    ...
    async def prepare(self):
        ...
        """
        if not self.defer_prefetch_init:
            await self.prefetch()
            await self.init()
