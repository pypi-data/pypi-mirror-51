...
class CategoryFormScheme(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'description': forms.Textarea(attrs={'type': 'text', 'rows': '14', 'class': 'form-control border-0 rounded-0', 'placeholder':'Article description'})
        }
...
class ArticleFormScheme(ModelForm):
    ...
    class Meta:
        ...
        widgets = { 'serial': forms.NumberInput(attrs={'class': 'form-control rounded-0', 'type': 'numbers'}),
                    ...
                    'shortlines': forms.Textarea(attrs={'type': 'text', 'class': 'form-control border-0 rounded-0', 'rows': '14', 'placeholder':'Article shortlines'}),
                    'content': forms.Textarea(attrs={'type': 'text', 'class': 'form-control border-0 rounded-0', 'rows': '14', 'placeholder':'Article content'}),
