...
class Encoder(object):
    def __init__(self, embedding: str, model: str, download: bool = False):
        ...
        if embedding not in supported_embeddings:
            print(f"Given embedding \"{embedding}\" is not supported, use from available embeddings:\n"
        ...
        if model not in model_names:
            print(f"Given embedding \"{embedding}\" does not have support for model \"{model}\", the supported "
                  f"models are: {model_names}")
            return
