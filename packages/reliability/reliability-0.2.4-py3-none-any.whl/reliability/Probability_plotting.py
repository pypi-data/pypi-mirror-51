...
def Weibull_probability_plot(failures=None,right_censored=None,left_censored=None,fit_gamma=False):
    ...
    if fit_gamma == False:
        fit = reliability.Fitters.Fit_Weibull_2P(failures=failures,right_censored=right_censored,left_censored=left_censored)
        ...
        fit = reliability.Fitters.Fit_Weibull_3P(failures=failures, right_censored=right_censored)
        wbf = Weibull_Distribution(alpha = fit.alpha,beta=fit.beta).CDF(show_plot=False,xvals=xvals)
...
def Normal_probability_plot(failures=None,right_censored=None,left_censored=None):
    ...
    fit = reliability.Fitters.Fit_Normal_2P(failures=failures,right_censored=right_censored,left_censored=left_censored)
...
def Lognormal_probability_plot(failures=None,right_censored=None,left_censored=None):
    ...
    fit = reliability.Fitters.Fit_Lognormal_2P(failures=failures,right_censored=right_censored,left_censored=left_censored)
...
def Beta_probability_plot(failures=None,right_censored=None,left_censored=None):
    ...
    fit = reliability.Fitters.Fit_Beta_2P(failures=failures,right_censored=right_censored,left_censored=left_censored)
...
def Gamma_probability_plot(failures=None,right_censored=None,left_censored=None,fit_gamma=False):
    ...
    xvals = np.logspace(-2, np.log10(max(failures))*10, 1000)
    if fit_gamma == False:
        fit = reliability.Fitters.Fit_Gamma_2P(failures=failures,right_censored=right_censored,left_censored=left_censored)
        ...
        fit = reliability.Fitters.Fit_Gamma_3P(failures=failures, right_censored=right_censored)
        gf = Gamma_Distribution(alpha = fit.alpha,beta=fit.beta).CDF(show_plot=False,xvals=xvals)
...
def Exponential_probability_plot(failures=None,right_censored=None,left_censored=None,fit_gamma=False):
    ...
    xvals = np.logspace(-2, np.log10(max(failures)) * 10, 1000)
    if fit_gamma == False:
        fit = reliability.Fitters.Fit_Expon_1P(failures=failures,right_censored=right_censored,left_censored=left_censored)
        ...
        fit = reliability.Fitters.Fit_Expon_2P(failures=failures, right_censored=right_censored)
        ef = Exponential_Distribution(Lambda = fit.Lambda).CDF(show_plot=False,xvals=xvals)
