...
def add_quyu_union(quyu,tag,loc='aliyun'):

    add_quyu(quyu,tag,loc=loc)
    add_quyu_greenplum(quyu,tag,loc=loc)

def restart_quyu_union(quyu,loc='aliyun'):

    restart_quyu(quyu,loc=loc)
    restart_quyu_greenplum(quyu,loc=loc)


def add_quyu_3(quyu,tag,loc='aliyun'):
    add_quyu(quyu,tag,loc=loc)
    add_quyu_greenplum(quyu,tag,loc=loc)
    add_quyu_app(quyu,loc)
########add_all###################

def add_quyu_union_all(tag,loc='aliyun'):
