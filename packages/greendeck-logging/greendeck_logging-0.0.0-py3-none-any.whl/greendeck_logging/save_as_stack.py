...
class GdLoggingStack:
	...
	def debug(self, message, info = None, value = int(1)):
		...
		try:
			...
			print("some error in debug function ", e)
			pass
	...
	def counter_status(self, status_code, info = None, value = int(1)):
		...
		try:
			...
			print("some error in counter_status ", e)
			pass
			# raise e
	...
	def counter_message(self, message, info = None, value = int(1)):
		...
		try:
			...
			print("some error in counter_message function ", e)
			pass
			# raise e
	...
	def error(self,error_message, info = None, value = int(1)):
		try:
			...
			print("some error in error function ", e)
			pass
			# raise e

		#return r
	def counter_website(self, website_id, message, info = None, value = int(1)):
		try:
			log_type = 'info'
			data =  self.base_log_info(log_type)
			message_counter = message_value(message, info, value)
			...
			print("some error in counter_website ", e)
			pass
			# raise e
