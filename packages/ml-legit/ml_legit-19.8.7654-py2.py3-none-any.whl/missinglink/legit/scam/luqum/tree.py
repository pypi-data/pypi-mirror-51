...
class Range(Item):
    ...
    _equality_attrs = ['low', 'high', 'include_low', 'include_high']
    ...
    def __eq__(self, other):
        ...
        return self.low == other.low and \
            ...
            self.include_low == other.include_low and \
            self.include_high == other.include_high
