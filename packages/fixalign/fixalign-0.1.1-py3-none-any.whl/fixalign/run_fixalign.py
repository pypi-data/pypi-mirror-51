...
"""
def main():
    parser = argparse.ArgumentParser(description="Find and fix small exon missed region in noisy long reads",
    ...
    find_fix_small_exon(args.inBam, args.genomeFasta, args.annotBed, args.outBam, args.outRegion,
                        small_exon_size=args.exonSizeThd, flank_len=args.flankLen, ignore_strand=args.ignoreStrand,
                        delta_ratio_thd=args.deltaRatioThd, simplify=(not args.detail), float_flank_len=args.floatFlankLen, 
                        only_region=args.onlyRegion)
