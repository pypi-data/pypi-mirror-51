...
# noinspection PyAbstractClass
class AlgoOrderStatus(EnumTypeWrapper):
    pass
...
class AlgoOrder(Message):
    ...
    algo_name = ... # type: Text
    # 算法策略参数
    algo_param = ... # type: Text
    # 算法策略状态,仅作为AlgoOrder Pause请求入参，取值参考 enum AlgoOrderStatus
    algo_status = ... # type: int
    # 算法单备注
    algo_comment = ... # type: Text
...
class AlgoOrders(Message):
    data = ... # type: RepeatedCompositeFieldContainer[AlgoOrder]
...
class Account(Message):
    ...
    # 支持的品种类型: A股, 期货, 期权等 定义见: SecurityType
    sec_types = ... # type: RepeatedScalarFieldContainer[int]

    info = ... # type: AccountInfo
