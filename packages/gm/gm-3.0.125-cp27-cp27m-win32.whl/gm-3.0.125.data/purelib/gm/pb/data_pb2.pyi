...
class InstrumentInfo(Message):
    ...
    def __init__(self, symbol:Text='', sec_type:int=0, exchange:Text='', sec_id:Text='', sec_name:Text='',
                 sec_abbr: Text='', price_tick: Text='', trade_n:int=0, listed_date:Timestamp=None, delisted_date:Timestamp=None): ...
...
class L2Transaction(Message):
    ...
    def __init__(self, symbol:Text='', side:int=0, price:float=0, volume:int=0, created_at:Timestamp=None):...

# noinspection PyAbstractClass
class L2Transactions(Message):
    data = ... # type: RepeatedCompositeFieldContainer[L2Transaction]

    def __init__(self, data:RepeatedCompositeFieldContainer[L2Transaction]=None): ...
