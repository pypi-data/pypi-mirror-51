...
class BadCentroidTagger:
    ...
    def eitherLatOrLngIsEmptyButNotBoth(latitude, longitude):
        ...
        print((ValidatorUtils.is_blank(latitude) and ValidatorUtils.is_not_blank(longitude)))
        print((ValidatorUtils.is_not_blank(latitude) and ValidatorUtils.is_blank(longitude)))
