...
The log module reads-in the pymbs_logging.json file and sets up logging for
PyMBS.

The PyMBS log file is located at ~/.local/log/pymbs.log
...
PYMBS_BASE_PATH = os.path.abspath(PurePath(__file__).parents[1])
...
if platform == 'darwin':
    ...
    pymbs_log_dir = Path('var', 'log', log_dir)
elif platform == 'win32':
