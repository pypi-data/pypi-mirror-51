...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v0.18.9-dev.1567076668+gc84884a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v0.18.9-dev.1567076668+gc84884a`
                """)
            else:
                raise
