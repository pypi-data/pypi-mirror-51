...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v0.18.10-dev.1567546749+g78cba63'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v0.18.10-dev.1567546749+g78cba63`
                """)
            else:
                raise
