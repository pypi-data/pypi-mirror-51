...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v0.18.11-dev.1567720299+g9b94070'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v0.18.11-dev.1567720299+g9b94070`
                """)
            else:
                raise
