...
class MyQFrame(QFrame):
    ...
    def __init__(self, analysis_arg, parent=None, with_description=True):
        """
...
class AnalysisParametersApp(QWidget):
    ...
    def __init__(self, thread_name, progress_bar, analysis_name, parent=None):
    ...
    def save_yaml_with_name(self):
        ...
        with open('cicada/config/config.yaml', 'r') as stream:
        ...
        try:
            ...
            with open('cicada/config/config.yaml', 'w') as outfile:
...
class AnalysisPackage(QWidget):
    ...
    def __init__(self, cicada_analysis, analysis_name, name, main_window, parent=None):
        ...
        height_window = min(750, screenGeometry.height())
