...
class CicadaDeepCinacPredictionAnalysis(CicadaAnalysis):
    ...
    def run_nwb_format_analysis(self, **kwargs):
        ...
        ci_movies_data_dict = self.analysis_formats_wrapper.get_ci_movies(only_2_photons=False)
        ...
        for session_index, session_data in enumerate(self._data_to_analyse):
            session_identifier = self.analysis_formats_wrapper.get_identifier(session_data)
            ...
            # setting the movie
            session_ci_movie_dict = ci_movies_data_dict[session_identifier]
            ...
            model_files_dict[(json_file_name, weights_file_name, network_name)] = np.arange(1)
