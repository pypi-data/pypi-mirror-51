...
def make_report(slo_config, error_budget_policy, timestamp, client=None):
    """Run SLO measurement for each step in the Error Budget config.
    ...
    """
    backend_config = slo_config['backend']
