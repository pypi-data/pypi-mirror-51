...
def distributeInfer(conf, date, ps, emrName, logpath=emr_home_path):
    _args_useSpark = True
    if __name__=='__main__':
...
if __name__=='__main__':
    ...
    if _args.mode == 'train':
        ...
        distributeInfer(_args.conf, _args.date, ps_num, EmrName, _args.logpath)
    elif _args.mode == 'tb':
