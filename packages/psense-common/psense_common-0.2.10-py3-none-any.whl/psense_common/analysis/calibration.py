...
class PSenseCalibration(object):
    ...
    def add_reference(self, ts, reference):
        ...
        log.debug('[add_reference] record={}'.format(
            record[1:]))
    ...
    def model_fit(self, model_type='linear'):
        ...
        for channel in self.channels:
            ...
            if model_type == 'linear':
                ...
                log.debug('[model_fit] {} fit: y={}x+{}'.format(model_type, slope, intercept))
                ...
                log.debug('[model_fit] {} fit: y= {}*exp(-{}*x) + {}'.format(model_type, popt[0], popt[1], popt[2]))
