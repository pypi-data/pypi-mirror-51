...
class PlacementSolver:
    ...
    def __init__(self, total_available_cus, num_sockets, solver_params=IPSolverParameters()):
    ...
    def optimize(
        ...
        try:
            extra_args = get_mip_solver_extra_args(solver, max_runtime_secs, tol_obj, mip_gap)
