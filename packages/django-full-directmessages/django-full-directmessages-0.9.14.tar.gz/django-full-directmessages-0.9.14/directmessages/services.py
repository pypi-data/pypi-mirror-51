...
class MessagingService(object):
    ...
    def send_message(self, sender, sender_user, recipient, message, quote_id):
        """
        Send a new message
        :param sender: company
        :param sender_user: user
        :param recipient: company
        ...
        message = Message(sender=sender, sender_user=sender_user, recipient=recipient, content=str(message),
                          title=quote_id)
        message.save()
    ...
    def get_conversation(self, company1, company2, quote_id, limit=None, reversed=False, mark_read=False):
        """
        List of messages between two users
        :param company1: User
        :param company2: User
        :param quote_id: Title
        :param limit: int
