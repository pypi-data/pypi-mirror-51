...
class Message(models.Model):
    ...
    profile = models.ForeignKey(AUTH_USER_MODEL, related_name='sent_user_dm', verbose_name=_("Sender_User"),
                                                                                    on_delete=models.CASCADE)
    ...
    title = models.CharField(max_length=10, default='', blank=True, null=True)  # this title contains the quote ID
