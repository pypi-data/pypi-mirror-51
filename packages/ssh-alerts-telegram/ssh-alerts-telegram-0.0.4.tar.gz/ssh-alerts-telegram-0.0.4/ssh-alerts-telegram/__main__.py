...
def send_alert(uid,server_id):
    ...
    r = requests.post('http://sshalerts.hackreports.com:8080/sendalert/', data = {'uid': uid ,'server_id': server_id , 'username': current_user , 'server_ip': server_ip  ,'ip_info': json.dumps(ip_info)})
