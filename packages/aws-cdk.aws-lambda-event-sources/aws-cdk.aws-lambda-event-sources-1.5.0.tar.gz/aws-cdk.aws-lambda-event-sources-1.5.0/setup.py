...
kwargs = json.loads("""
{
    ...
    "package_data": {
        "aws_cdk.aws_lambda_event_sources._jsii": [
            "aws-lambda-event-sources@1.5.0.jsii.tgz"
        ],
        "aws_cdk.aws_lambda_event_sources": [
            "py.typed"
        ]
    ...
    "install_requires": [
        "jsii~=0.15.1",
        "publication>=0.0.3",
        "aws-cdk.aws-apigateway~=1.5,>=1.5.0",
        "aws-cdk.aws-dynamodb~=1.5,>=1.5.0",
        "aws-cdk.aws-events~=1.5,>=1.5.0",
        "aws-cdk.aws-iam~=1.5,>=1.5.0",
        "aws-cdk.aws-kinesis~=1.5,>=1.5.0",
        "aws-cdk.aws-lambda~=1.5,>=1.5.0",
        "aws-cdk.aws-s3~=1.5,>=1.5.0",
        "aws-cdk.aws-s3-notifications~=1.5,>=1.5.0",
