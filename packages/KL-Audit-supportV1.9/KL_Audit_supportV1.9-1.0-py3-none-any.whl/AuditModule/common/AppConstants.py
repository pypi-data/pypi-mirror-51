...
class CassandraConstants:
    ...
    INSERT_STATEMENT = "INSERT INTO {} (user_name, timedate, client_id, module, operations, parameter_lable, status, user_role_name) values (?,?,?,?,?,?,?,?)"
...
class AuditMappingConstants:
    audit_logs_mapping_json = {"DbUpdate":config['AUDIT_MAPPING']['DbUpdate'],"UserAccess":config['AUDIT_MAPPING']['UserAccess']}