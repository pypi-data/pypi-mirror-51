    ...
    def export_to_matlab(self, file=None):
        ...
        def create_face_data(self):
            ...
            for face in self.Faces:
                ...
                if isinstance(holes_indexes, list):
                    ...
                    holes_indexes = holes_indexes + 1

                data = [[x + 1 for x in points_indx],                    # 'Points'
                        1,                              # 'Floor'
                        part + 1,                           # 'Mat'
                        [],                           # 'alpha_out'
                        [],                           # 'T_out'
        ...
        def create_wall_data(self):
            ...
            for wall in self.Walls:
                ...
                data = [[x + 1 for x in patches],            # 'Patches'
                        1,                  # 'Floor'
                        0                   # 'ref2D'
                        ]
                walls.append(data)
