...
class PostInstallCommand(install):
  def run(self):
    ...
    setupCompletionScript = 'setup.stackd-completion.bash'
    ...
    if path.isfile(systemScript):
      ...
      print("Unable to find setup.stackd-completion.bash at "+systemScript+" or "+userScript)
    install.run(self)
...
setup(
  ...
  scripts=[
    ...
    'bin/docker-stack-rm',
    'bin/stackd-completion.bash',
    'bin/setup.stackd-completion.bash',
  ],
  entry_points={
    'console_scripts': [
